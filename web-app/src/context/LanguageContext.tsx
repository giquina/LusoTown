...
const translations = {
  en: {
    ...
    'nav.contact': 'Contact',
    'nav.login': 'Login',
    'nav.join-community': 'Join Our Family',
    
    // Hero Section
    'hero.badge': "Unidos pela Língua • United by Language",
    'hero.title': 'Find Your Portuguese Family in London.',
    'hero.subtitle': 'Welcome home! Join 500+ Portuguese hearts who\'ve found their people at cozy bakeries in Stockwell, warm cultural centers in Vauxhall, and everywhere Portuguese families gather. Come as you are, leave feeling like you belong.',
    ...
    'quick-start.subtitle': 'From Nando\'s Stockwell to Portuguese churches in Vauxhall, from cultural centers in Elephant & Castle to Fado nights in authentic venues - connect where Portuguese hearts gather',
    ...
    'what-you-can-do.feed.description': 'Follow community news, event updates, and cultural highlights. Share photos from Portuguese festivals, recommend authentic restaurants, and stay connected with your Portuguese community.',
    ...
    'features.events.description': 'From intimate Fado nights where everyone sings along to joyful festivals where children play while parents share stories of home - every gathering feels like a family reunion. Come as you are, leave with friends who feel like cousins.',
    ...
    'testimonials.subtitle': 'Hear from Portuguese speakers who found their London community, preserved their heritage, and built lasting friendships at real venues across the city',
    
    // Footer
    'footer.description': 'Your Portuguese home away from home in London & UK. Where families reconnect with their roots, children learn their heritage songs, and everyone finds their place in our warm, welcoming community. From little ones to grandparents - todos são bem-vindos. Unidos pela Língua - United by Language.',
    ...
    'login.subtitle': 'Sign in to connect with your Portuguese community',
    'login.community-badge': 'Your Portuguese family in London',
    'login.community-missed-you': 'Your Portuguese community missed you.',
    'login.hearts-waiting': 'Over 500 Portuguese hearts are waiting for you.',
    'login.community-updates': 'Community Updates',
    'login.live': 'LIVE',
    ...
    'login.connecting': 'Connecting to your community...',
    ...
    'login.safe-community': 'Safe & Verified Community',
    ...
    // Groups
    'groups.title': 'Portuguese Community Groups',
    'groups.subtitle': 'Find your community and connect with Portuguese speakers',
    ...
    // Group Creation
    'group.create.title': 'Create Portuguese Community Group',
    ...
    // Community Page
    'community.hero.title': 'The Portuguese Community in London',
    'community.hero.subtitle': 'Discover the vibrant Portuguese-speaking community in London. From family bakeries in Stockwell to cultural centers in Vauxhall, from Brazilian festivals to Fado nights - this is where 500+ Portuguese hearts gather and feel at home.',
    'community.stats.members': 'Portuguese Community Members',
    ...
    'community.areas.title': 'Portuguese Community Areas',
    'community.areas.subtitle': 'Discover where the Portuguese community gathers in London. Each area has its own personality, from family bakeries to vibrant cultural centers.',
    ...
    'community.members.title': 'Meet Our Community Members',
    'community.members.subtitle': 'Real people making real connections across London - stories from the Portuguese community',
    'community.values.title': 'Our Community Values',
    'community.values.subtitle': 'What makes our community special? These shared values that every member embraces, reflecting the best of Portuguese culture.',
    'community.business.title': 'Portuguese Businesses in London',
    'community.business.subtitle': 'Support our business community. From family bakeries making pastéis like grandma used to, to restaurants serving authentic francesinha, to services provided by people who understand our culture.',
    ...
    'app.heading.community': 'Community',
    'app.heading.part2': 'Everywhere',
    'app.description': 'Never miss Portuguese meetups in London, group chats or new connections. Get the LusoTown mobile app and stay connected with the Portuguese community wherever you go.',
    'app.cta.title': 'Join 500+ verified Portuguese speakers',
    'app.cta.description': 'Your Luso-London community is already growing. Download the app and find your community today.',
    ...
    'app.features.real-time-chat.description': 'Stay connected with the Portuguese community anywhere',
    'app.features.mobile-experience.title': 'Mobile Experience',
    'app.features.mobile-experience.description': 'Optimized for seamless community engagement',
    ...
    'app.info.community': 'Luso-London Community',
    ...
    'cta.title': 'Your Community is Here',
    'cta.subtitle': 'No more lonely weekends. Join LusoTown London today and discover the Portuguese community you\'ve been looking for.',
    'cta.button': 'JOIN NOW',
    ...
    'cta.connect-time': 'Join now and connect with the Luso-London community within 48 hours',
    'cta.trust.verified-profiles': 'Verified Profiles',
    'cta.trust.community-support': 'Community Support',
    'cta.trust.satisfaction-guarantee': 'Satisfaction Guarantee',
    'cta.benefits.join-community': 'Join the Luso-London community',
