...
const mockRegionalData: Record<PortugueseCountry, LocalizedRegion> = {
  'uk': {
    ...
    culturalFeatures: ['Fado nights', 'Lusophone markets', 'Cultural associations'],
    majorCities: ['London', 'Manchester', 'Birmingham', 'Leicester'],
    portuguesePopulation: 400000,
    culturalCenters: ['Instituto Camões', 'Lusophone Cultural Centre'],
    consulateContacts: ['Lusophone Consulate London', 'Lusophone Consulate Manchester'],
  ...
  'australia': {
    ...
    dialect: 'diaspora-portuguese',
    culturalFeatures: ['Lusophone clubs', 'Cultural festivals', 'Heritage preservation'],
    majorCities: ['Sydney', 'Melbourne', 'Perth', 'Brisbane'],
    portuguesePopulation: 56000,
    culturalCenters: ['Lusophone Cultural Association Sydney', 'Portuguese-speaking community Centre Melbourne'],
    consulateContacts: ['Lusophone Consulate Sydney', 'Lusophone Consulate Melbourne'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
  ...
  'brazil': {
    ...
    consulateContacts: ['Lusophone Consulate São Paulo', 'Lusophone Consulate Rio de Janeiro'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
  ...
  'france': {
    ...
    dialect: 'european-portuguese',
    culturalFeatures: ['Lusophone communities', 'Cultural associations', 'Heritage sites'],
    ...
    consulateContacts: ['Lusophone Consulate Paris', 'Lusophone Consulate Lyon'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
  ...
  'germany': {
    ...
    dialect: 'european-portuguese',
    culturalFeatures: ['Lusophone worker heritage', 'Cultural clubs', 'Community centers'],
    ...
    consulateContacts: ['Lusophone Consulate Berlin', 'Lusophone Consulate Munich'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
  ...
  'switzerland': {
    ...
    dialect: 'european-portuguese',
    culturalFeatures: ['Lusophone communities', 'Cultural events', 'Heritage preservation'],
    ...
    consulateContacts: ['Lusophone Consulate Geneva', 'Lusophone Consulate Zurich'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
  ...
  'luxembourg': {
    ...
    consulateContacts: ['Lusophone Consulate Luxembourg'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
  ...
  'south-africa': {
    ...
    culturalCenters: ['Lusophone Cultural Association Johannesburg', 'Centro Cultural Português'],
    consulateContacts: ['Lusophone Consulate Johannesburg', 'Lusophone Consulate Cape Town'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
  ...
  'angola': {
    ...
    dialect: 'african-portuguese',
    culturalFeatures: ['Lusophone colonial heritage', 'Lusophone culture', 'Cultural preservation'],
    ...
    consulateContacts: ['Lusophone Embassy Luanda'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
  ...
  'mozambique': {
    ...
    dialect: 'african-portuguese',
    culturalFeatures: ['Lusophone colonial heritage', 'Lusophone identity', 'Cultural diversity'],
    ...
    consulateContacts: ['Lusophone Embassy Maputo'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
  ...
  'cape-verde': {
    ...
    consulateContacts: ['Lusophone Embassy Praia'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
  ...
  'macau': {
    ...
    culturalFeatures: ['Lusophone colonial heritage', 'East-West fusion', 'Macanese culture'],
    majorCities: ['Macau'],
    portuguesePopulation: 25000,
    culturalCenters: ['Instituto Cultural de Macau', 'Centro Cultural Português'],
    consulateContacts: ['Lusophone Consulate Macau'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
  ...
  'east-timor': {
    ...
    timezone: 'Asia/Dili',
    dialect: 'asian-portuguese',
    culturalFeatures: ['Lusophone colonial heritage', 'Independence struggle', 'Cultural preservation'],
    ...
    consulateContacts: ['Lusophone Embassy Dili'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
  ...
  'india-goa': {
    ...
    dialect: 'asian-portuguese',
    culturalFeatures: ['Lusophone colonial architecture', 'Catholic heritage', 'Goan culture'],
    ...
    consulateContacts: ['Lusophone Consulate Goa'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
  ...
  'venezuela': {
    ...
    dialect: 'diaspora-portuguese',
    culturalFeatures: ['Lusophone immigration heritage', 'Cultural communities', 'Business networks'],
    ...
    consulateContacts: ['Lusophone Consulate Caracas'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
  ...
  'argentina': {
    ...
    dialect: 'diaspora-portuguese',
    culturalFeatures: ['Lusophone immigration waves', 'Cultural heritage', 'Community organizations'],
    ...
    consulateContacts: ['Lusophone Consulate Buenos Aires'],
    traditionalFestivals: [],
    localCuisine: [],
    historicalSites: [],
    communityOrganizations: [],
