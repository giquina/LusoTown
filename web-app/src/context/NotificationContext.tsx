    ...
    const defaultNotifications: BaseNotification[] = [
      {
        ...
        message: 'Discover Portuguese events, connect with the community, and explore cultural heritage in London & UK',
        titlePT: 'Bem-vindo ao LusoTown Londres',
        messagePT: 'Descubra eventos portugueses, conecte-se com a comunidade e explore o património cultural em Londres e Reino Unido',
        userId: 'current-user',
        isRead: false,
        priority: 'medium',
