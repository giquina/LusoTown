...
const notificationTemplates: NotificationTemplate[] = [
  ...
  },
  {
    ...
    type: 'cultural_event',
    category: 'community',
    titleTemplate: 'Lusophone Cultural Event',
  ...
  },
  {
    ...
    category: 'business',
    titleTemplate: 'Lusophone Business Opportunity',
  ...
  },
  {
    ...
    type: 'student_event',
    category: 'students',
    titleTemplate: 'University Lusophone Society Event',
    messageTemplate: '{{universityName}} Lusophone Society presents: {{eventName}}',
...
export function NotificationProvider({ children }: { children: ReactNode }) {
    ...
    const defaultNotifications: BaseNotification[] = [
      {
        ...
        message: 'Discover Lusophone events, connect with the community, and explore Portuguese culture in London & United Kingdom',
      ...
      },
      {
        ...
        category: 'networking',
        title: 'Lusophone Business Networking Event',
        message: 'Join fellow Lusophone entrepreneurs and professionals this Friday at Lusophone Cultural Centre',
  ...
  const notifyStudentUpdate = (type: 'university_event' | 'career_opportunity', data: any) => {
    ...
    addNotification({
      ...
      category: 'students',
      title: titles[type][language as 'en' | 'pt'],
      message: data.message || (language === 'pt' ? 'Nova oportunidade para estudantes portugueses' : 'New opportunity for Lusophone students'),
      userId: 'current-user',
      priority: 'medium',
      data,
      actionUrl: '/students',
  ...
  const getPersonalizedRecommendations = (): BaseNotification[] => {
    ...
    if (personalization.interests.includes('fado')) {
      recommendations.push({
        ...
        message: 'Based on your interest in Fado, we recommend tonight\'s performance at Lusophone Cultural Centre',
    ...
    if (personalization.connectionGoals.includes('professional')) {
      recommendations.push({
        ...
        message: 'We found Lusophone professionals in your industry attending tomorrow\'s business mixer',
