    ...
    const suggestions: FollowableEntity[] = [
      {
        ...
        imageUrl: buildUnsplashUrl('photo-1494790108755-2616b612b1ac?w=150&h=150&fit=crop&crop=face&auto=format'),
        location: 'London, UK',
        followers: 245,
        isVerified: true,
      ...
      },
      {
        ...
        imageUrl: buildUnsplashUrl('photo-1493225457124-a3eb161ffa5f?w=150&h=150&fit=crop&auto=format'),
        location: 'London, UK',
        followers: 1240,
      ...
      },
      {
        ...
        imageUrl: buildUnsplashUrl('photo-1511895426328-dc8714191300?w=150&h=150&fit=crop&auto=format'),
      ...
      },
      {
        ...
        imageUrl: buildUnsplashUrl('photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face&auto=format'),
        location: 'London, UK',
        followers: 892,
        isVerified: true,
      ...
      },
      {
        ...
        imageUrl: buildUnsplashUrl('photo-1600880292203-757bb62b4baf?w=150&h=150&fit=crop&auto=format'),
        location: 'United Kingdom',
        followers: 756,
      ...
      },
      {
        ...
        imageUrl: buildUnsplashUrl('photo-1580489944761-15a19d654956?w=150&h=150&fit=crop&crop=face&auto=format'),
        location: 'London, UK',
        followers: 423,
