...
export const SUCCESS_STORIES: SuccessStory[] = [
  ...
  // BUSINESS SUCCESS STORIES
  {
    ...
    quote: "LusoTown helped me connect with 400+ Portuguese-speaking clients in London. My accounting firm now serves the entire Lusophone community!",
    ...
    culturalEvents: ['Lusophone Business Breakfast', 'Annual Tax Workshop (PT/EN)', 'Porto Night Sponsorship'],
    businessAchievements: ['400+ Portuguese-speaking clients', '£2.8M in community tax savings', '50+ business partnerships'],
    communityRoles: ['Business Advisory Committee', 'Lusophone Entrepreneurs Mentor', 'Cultural Event Sponsor']
  },
  
  {
    ...
    culturalEvents: ['Angolan Independence Day Catering', 'Lusophone Food Festival', 'African Heritage Month'],
  ...
  // ROMANCE SUCCESS STORIES
  {
    ...
    quote: "Met at Chocolate Kizomba through LusoTown events. Six months later, we had our Lusophone-Brazilian wedding celebration with 200 community members!",
    ...
    longStory: "Ana from Rio came to London for her PhD in Architecture. Miguel from Porto worked in finance but felt disconnected from Portuguese culture. Both joined LusoTown seeking authentic community. At Chocolate Kizomba (Tuesday night at One Regent Street), Ana was teaching Brazilian dance styles while Miguel was learning traditional Lusophone steps. The moment they danced together, the cultural fusion was magical - Brazilian warmth met Lusophone elegance. Six months of LusoTown cultural events (Fado nights, Portuguese business meetups, Brazilian film screenings) deepened their connection. Their wedding celebration brought together 200+ Portuguese-speaking community members from across London. Today, they host monthly Lusophone-Brazilian cultural fusion events, sharing how love transcends borders when cultures unite through authentic community connections.",
    ...
    culturalContribution: 'Lusophone-Brazilian Cultural Fusion Events',
    ...
    culturalEvents: ['Chocolate Kizomba Regular Attendees', 'Fado & Samba Fusion Nights', 'Lusophone-Brazilian Wedding'],
  ...
  
  {
    ...
    longStory: "Teresa from Cape Verde moved to London for nursing studies, missing the soulful morna music of the islands. Paulo from Angola worked in engineering but yearned for authentic African Portuguese culture. At a LusoTown Fado evening, Teresa was moved to tears hearing Lusophone melancholy that reminded her of morna's emotional depth. Paulo approached her, recognizing a kindred spirit who understood how music carries cultural soul. They bonded over Cape Verdean morna and Angolan semba, discovering how both cultures express love through deeply emotional music. Their courtship included island music nights, Lusophone poetry readings, and African cultural celebrations. Their wedding was a stunning celebration of lusophone African heritage - Cape Verdean cesária and Angolan kuduro, traditional foods from both islands, and guests from across Portuguese-speaking Africa. They now organize monthly African Lusophone cultural nights, proving that love flourishes when shared heritage creates deep understanding.",
    ...
    culturalContribution: 'African Lusophone Cultural Preservation',
    ...
    culturalEvents: ['African Lusophone Music Nights', 'Cape Verdean Cultural Celebrations', 'Angolan Independence Day'],
    communityRoles: ['African Lusophone Cultural Ambassadors', 'Traditional Music Preservationists', 'Island Heritage Advocates']
  },
  
  {
    ...
    quote: "Met at Portuguese business networking, fell in love over shared entrepreneurial dreams. Now we run London's most successful Lusophone-Brazilian joint venture!",
    ...
    longStory: "Sandra from Lisbon had a successful marketing consultancy but struggled to expand into Brazilian markets. Ricardo from Salvador ran a premium import business but lacked European connections. Both attended LusoTown's Monthly Lusophone Business Breakfast seeking strategic partnerships. Their conversation about cultural marketing sparked immediate professional chemistry. What started as business collaboration blossomed into romance as they discovered shared values: family-focused business ethics, cultural pride, and entrepreneurial passion. Six months later, they launched Atlântico Ventures - combining Sandra's European marketing expertise with Ricardo's Brazilian sourcing network. Their personal partnership strengthened their professional success. Today, they run London's largest Lusophone-Brazilian trade consultancy, helping 200+ businesses navigate both markets. Their love story proves that when Portuguese-speaking entrepreneurs unite, both hearts and businesses flourish beyond imagination.",
    ...
    businessType: 'Lusophone-Brazilian Trade Consultancy',
    ...
    culturalEvents: ['Lusophone Business Breakfasts', 'Brazilian Trade Missions', 'Entrepreneur Couple Mentorship'],
  ...
  // CULTURAL ACHIEVEMENT STORIES
  {
    ...
    quote: "Organized London's biggest Angolan Independence Day celebration! 2,many people celebrated our heritage with traditional music, food, and unity.",
  ...
  
  {
    ...
    quote: "Started UK's first Lusophone entrepreneur podcast! Now featuring 100+ successful lusophone business owners sharing wisdom with our community.",
    ...
    culturalContribution: 'First UK Lusophone entrepreneur podcast and business community building',
    ...
    culturalEvents: ['Lusophone Business Conferences', 'Entrepreneur Meetups', 'Podcast Live Recordings'],
    businessAchievements: ['100+ podcast episodes', '50k monthly downloads', '5 business expansions facilitated'],
    communityRoles: ['Lusophone Business Advocate', 'Entrepreneur Media Leader', 'Success Story Curator']
  },
  
  {
    ...
    longStory: "Moving from Belo Horizonte to London, I missed authentic Brazilian home cooking - not restaurant food, but real family recipes passed down through generations. LusoTown's community helped me realize other Lusophone-speakers shared this longing for authentic cultural connection through food. I started offering Brazilian cooking classes from my Clapham kitchen, teaching traditional dishes like feijoada, pão de açúcar, brigadeiros, and regional specialties from Minas Gerais. Word spread through LusoTown's network - soon I had waiting lists. Classes became cultural experiences: students learned cooking techniques while hearing stories about Brazilian family traditions, regional differences, and food's role in Brazilian celebrations. I expanded to corporate team-building, cultural festivals, and private dining experiences. Today, my classes are London's most sought-after Brazilian cooking experience, with events annually including British food enthusiasts wanting authentic cultural immersion. My success inspired other Portuguese-speaking women to share their cultural knowledge, creating a network of authentic cultural educators.",
    ...
    businessAchievements: ['events annually', 'Corporate partnerships', 'Cultural festival collaborations'],
