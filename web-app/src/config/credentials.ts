...
export const ADMIN_CONFIG = {
  get emailDomain(): string {
    ...
    // Avoid failing static generation builds; enforce at runtime in server actions/routes
...
export const isAdminEmail = (email: string): boolean => {
  if (!ADMIN_CONFIG.emailDomain) {
    console.warn(
      "Admin email domain not configured. Set ADMIN_EMAIL_DOMAIN environment variable."
    );
    return false;
  }
