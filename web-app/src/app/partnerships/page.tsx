        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            {language === 'pt' 
              ...
              : 'We work with official Lusophone organizations to provide authentic services and support for the Portuguese-speaking community in London.'}
          </p>
        ...
        <div className="bg-gradient-to-r from-primary-500 to-secondary-500 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-lg mb-6 opacity-90">
            {language === 'pt' 
              ...
              : 'Are you a Lusophone organization? Join us in better serving the Portuguese-speaking community in London.'}
          </p>
