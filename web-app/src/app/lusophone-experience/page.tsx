...
export const metadata: Metadata = {
  ...
  description: 'Discover the comprehensive Portuguese-speaking community experience across Portugal, Brazil, PALOP nations, and the United Kingdom. Connect with 750+ members through cultural events, heritage selection, and business opportunities.',
  keywords: [
