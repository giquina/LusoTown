...
export const metadata: Metadata = {
  title: 'Portuguese Events in the U.K. | LusoTown - Social Calendar',
  description: 'Join Portuguese speakers in the U.K. for cultural events, business workshops, AI seminars, and social gatherings. Book authentic Portuguese experiences today.',
  keywords: [
  ...
  images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Portuguese Events in the U.K. - LusoTown Community Calendar',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Portuguese Events in the U.K. | Join Your Community',
    description: 'Discover authentic Portuguese events, workshops, and cultural gatherings in the U.K.. Connect with your lusophone community today.',
