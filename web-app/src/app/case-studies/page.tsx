              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-secondary-600">Portuguese Speakers Connected</div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-secondary-600">Meaningful Friendships Formed</div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-secondary-600">Business Partnerships Created</div>
                  </div>
              ...
              <div className="max-w-2xl mx-auto text-center">
                ...
                <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                  <input
                    ...
                    className="flex-1 px-4 py-3 border border-secondary-300 rounded-lg focus:ring-2 focus:ring-secondary-400 focus:border-transparent"
                  />
                  <button
                    type="submit"
