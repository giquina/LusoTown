...
export async function GET(request: NextRequest) {
  try {
    ...
    const includeCulturalMetrics =
      searchParams.get("include_cultural_metrics") === "true";
    const includeUserSatisfaction =
      searchParams.get("include_user_satisfaction") === "true";
