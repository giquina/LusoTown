            ...
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <div className="space-y-6">
                  <div className="bg-primary-50 rounded-xl p-6">
                    ...
                    <ul className="text-gray-600 space-y-2">
                      ...
                      <li className="flex items-start">
                        <div className="w-2 h-2 bg-primary-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                        Complete our verification process, including selfie
                        verification
                      </li>
                    </ul>
                  </div>
                ...
                <div className="space-y-6">
                  <div className="bg-green-50 border border-green-200 rounded-xl p-6">
                    ...
                    <ul className="text-green-700 space-y-2">
                      ...
                      <li>
                        • Supportive interactions and mutual encouragement
                      </li>
                      <li>
                        • Celebrating each other's choices and achievements
                      </li>
                      ...
                      <li>
                        • Reporting concerning behavior to maintain safety
                      </li>
                    </ul>
                  </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <ul className="text-red-600 text-sm space-y-1">
                          ...
                          <li>
                            • Sharing others' personal information without
                            consent
                          </li>
                      ...
                      <div>
                        ...
                        <ul className="text-red-600 text-sm space-y-1">
                          ...
                          <li>
                            • Spam, promotional content, or commercial
                            activities
                          </li>
                          <li>• Inappropriate sexual content or advances</li>
                          <li>
                            • Disrespecting others' life choices or
                            circumstances
                          </li>
                        </ul>
                      </div>
                  ...
                  <div className="bg-primary-50 rounded-xl p-6">
                    ...
                    <p className="text-primary-700 mb-3">
                      All content you share on LusoTown must:
                    </p>
                    <ul className="text-primary-600 space-y-2">
                      ...
                      <li>
                        • Be relevant to our community's interests and values
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3 text-gray-600">
                      <div className="flex items-start">
                        <div className="w-2 h-2 bg-primary-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                        <p>
                          <strong>No commercial use:</strong> LusoTown is for
                          personal networking and friendship only
                        </p>
                      </div>
                      <div className="flex items-start">
                        <div className="w-2 h-2 bg-secondary-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                        <p>
                          <strong>Data scraping prohibited:</strong> Automated
                          data collection or scraping is not allowed
                        </p>
                      </div>
                      <div className="flex items-start">
                      ...
                      <div className="flex items-start">
                        ...
                        <p>
                          <strong>Respect boundaries:</strong> Honor other
                          members' privacy settings and communication
                          preferences
                        </p>
                      </div>
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-3 text-gray-600">
                      ...
                      <ul className="space-y-2 ml-4">
                        <li>
                          • Within 14 days of first subscription (Consumer
                          Rights Act 2015)
                        </li>
                        <li>
                          • Technical issues preventing platform use for more
                          than 7 days
                        </li>
                        <li>• Account suspension due to our error</li>
                        <li>
                          • Subscription cancellation due to verified safety
                          concerns
                        </li>
                      </ul>
                ...
                <div className="space-y-6">
                  <div className="bg-orange-50 border border-orange-200 rounded-xl p-6">
                    ...
                    <p className="text-orange-700 mb-3">
                      LusoTown is committed to maintaining a safe environment.
                      We employ:
                    </p>
                    <ul className="text-orange-600 space-y-2">
                      ...
                      <li>
                        • Collaboration with relevant authorities when necessary
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-white rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  <p className="text-gray-600">
                    ...
                    , which details how we collect, use, and protect your
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-3">
                      This license ends when you delete your content or close
                      your account.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                    ...
                    <p className="text-yellow-700">
                      ...
                      uninterrupted service. LusoTown is provided "as is" and we
                      are not liable for temporary service interruptions,
                      scheduled maintenance, or technical difficulties.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="text-gray-600 space-y-2 ml-4">
                      ...
                      <li>
                        • Actions or behavior of other members outside the
                        platform
                      </li>
                      <li>• Disputes between members</li>
                      <li>
                        • Outcomes of events organized through the platform
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-white rounded-2xl p-8">
                ...
                <div className="space-y-4 text-gray-600">
                  ...
                  <ul className="space-y-2 ml-4">
                    <li>
                      • We'll notify you via email and platform notification
                    </li>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-primary-50 rounded-lg p-4">
                      <h3 className="font-semibold text-primary-800 mb-2">
                        First Step: Direct Resolution
                      </h3>
                      <p className="text-primary-700 text-sm">
                        Contact our support team at hello@lusotown.com to
                    ...
                    <div className="bg-green-50 rounded-lg p-4">
                      ...
                      <p className="text-green-700 text-sm">
                        Unresolved disputes subject to exclusive jurisdiction of
                        English courts
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-r from-primary-500 to-secondary-500 text-white rounded-2xl p-8">
                ...
                <div className="mt-6 pt-6 border-t border-white/20">
                  ...
                  <p className="text-sm opacity-90 mt-2">
                    Thank you for being part of the LusoTown community.
