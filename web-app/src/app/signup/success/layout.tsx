...
export const metadata: Metadata = {
  ...
  description: 'Thank you for requesting an invitation to LusoTown. Learn what happens next in our verification process for the UK\'s premier community of women 30+.',
