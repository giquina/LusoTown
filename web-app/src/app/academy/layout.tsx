      ...
      items: [
        {
          ...
          href: '/academy',
          icon: GraduationCap,
          description: isPortuguese ? 'Página principal da academia' : 'Main academy page'
        },
        {
          id: 'learning-paths',
          ...
          href: '/academy/paths',
          icon: Target,
          description: isPortuguese ? 'Percursos personalizados' : 'Personalized learning tracks'
        },
        {
          id: 'progress',
          ...
          icon: BarChart3,
          description: isPortuguese ? 'Acompanhe seu progresso' : 'Track your progress'
        }
      ]
    },
    {
      ...
      items: [
        {
          id: 'dating-matching',
          label: isPortuguese ? 'Encontros & Compatibilidade' : 'Dating & Matching',
        ...
        },
        {
          ...
          label: isPortuguese ? 'Transporte & Motorista' : 'Transport & Chauffeur',
        ...
        },
        {
          ...
          label: isPortuguese ? 'Networking Empresarial' : 'Business Networking',
        ...
        },
        {
          ...
          label: isPortuguese ? 'Assistência Habitacional' : 'Housing Assistance',
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                title={isPortuguese ? 'Voltar ao site principal' : 'Back to main site'}
              >
              ...
              <div className="p-6">
                ...
                <div className="bg-gradient-to-r from-primary-50 to-secondary-50 rounded-2xl p-4 mb-6 border border-primary-100">
                  <div className="grid grid-cols-2 gap-4 text-center">
                    ...
                    <div>
                      <div className="text-lg font-bold text-secondary-600">32</div>
                      <div className="text-xs text-gray-600">
                          ...
                          <li key={item.id}>
                            ...
                            >
                              <item.icon className={`w-5 h-5 mt-0.5 flex-shrink-0 ${
                                isCurrentPath(item.href) ? 'text-primary-600' : 'text-gray-400 group-hover:text-primary-500'
                              }`} />
