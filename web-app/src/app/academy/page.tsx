...
export default function AcademyHomePage() {
  ...
  const saveProgress = (userType: string, completed: string[]) => {
    localStorage.setItem('lusotown-academy-progress', JSON.stringify({
      userType,
      completed,
      lastAccess: Date.now()
    }));
  ...
  const userTypes: UserType[] = [
    {
      ...
      description: 'Learn about housing, academic support, and connecting with other Portuguese students',
      descriptionPortuguese: 'Aprenda sobre alojamento, apoio académico e conectar-se com outros estudantes portugueses',
      icon: GraduationCap,
    ...
    },
    {
      ...
      description: 'Master business networking, premium transport, and professional services',
      descriptionPortuguese: 'Domine networking empresarial, transporte premium e serviços profissionais',
      icon: Briefcase,
    ...
    },
    {
      ...
      description: 'Learn streaming, community building, and monetization strategies',
      descriptionPortuguese: 'Aprenda streaming, construção de comunidade e estratégias de monetização',
      icon: Video,
    ...
    },
    {
      ...
      description: 'Discover dating, events, community connections, and cultural activities',
      descriptionPortuguese: 'Descubra encontros, eventos, conexões comunitárias e atividades culturais',
      icon: Heart,
    ...
    },
    {
      ...
      description: 'Optimize networking, premium services, and community partnerships',
      descriptionPortuguese: 'Otimize networking, serviços premium e parcerias comunitárias',
      icon: Target,
  ...
  const services: Service[] = [
    {
      ...
      description: 'Connect with Portuguese speakers for meaningful relationships',
      descriptionPortuguese: 'Conecte-se com falantes de português para relacionamentos significativos',
      icon: Heart,
      difficulty: 'Beginner',
    ...
    },
    {
      ...
      descriptionPortuguese: 'Transporte premium com motoristas que falam português',
      icon: MapPin,
      difficulty: 'Beginner',
    ...
    },
    {
      ...
      descriptionPortuguese: 'Conexões profissionais e oportunidades de negócio',
      icon: Users,
      difficulty: 'Intermediate',
      ...
      <section className="relative pt-20 pb-16">
        ...
        <div className="relative container-width">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              {isPortuguese ? 'Aprenda a Usar Todos os Nossos Serviços' : 'Learn to Use All Our Services'}
              <br />
            ...
            {completedServices.length > 0 && (
              ...
              >
                ...
                <p className="text-xs text-gray-600 mt-2">
                  {completedServices.length} {isPortuguese ? 'de' : 'of'} {services.length} {isPortuguese ? 'serviços concluídos' : 'services completed'}
                </p>
              </motion.div>
            )}
            ...
            >
              <div className="relative">
                <input
                  type="text"
                  placeholder={isPortuguese ? 'Procurar serviços...' : 'Search services...'}
                  value={searchQuery}
              ...
              {userTypes.map((userType, index) => (
                ...
                >
                  ...
                  <p className="text-gray-600 mb-4 leading-relaxed">
                    {isPortuguese ? userType.descriptionPortuguese : userType.description}
                  </p>
                  
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-primary-600 font-medium">
                      {userType.estimatedTime} {isPortuguese ? 'de aprendizado' : 'learning time'}
                    </span>
      ...
      <section className="py-16">
        <div className="container-width">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-5">
              {selectedUserType 
                ? (isPortuguese ? 'Seu Plano de Aprendizado' : 'Your Learning Plan')
                : (isPortuguese ? 'Todos os Serviços' : 'All Services')
              }
            </h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              {selectedUserType
                ? (isPortuguese ? 'Serviços recomendados para o seu perfil' : 'Recommended services for your profile')
                : (isPortuguese ? 'Explore todos os serviços disponíveis na plataforma' : 'Explore all available platform services')
              }
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {(selectedUserType ? getUserTypeServices(selectedUserType) : filteredServices).map((service, index) => (
              <motion.div
                key={service.id}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
        ...
        <div className="container-width">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="group">
              ...
              <div className="text-2xl font-bold text-gray-900 mb-1">2,150+</div>
              <div className="text-sm text-gray-600">
