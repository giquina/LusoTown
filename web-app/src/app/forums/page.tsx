        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-secondary-600 mt-1">Join the conversation and connect with like-minded women</p>
            </div>
            <button
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-secondary-300 rounded-lg focus:ring-2 focus:ring-[#FF6B6B] focus:border-transparent"
              />
            </div>
            <div className="flex gap-2">
              <select
                ...
                className="px-4 py-2 border border-secondary-300 rounded-lg focus:ring-2 focus:ring-[#FF6B6B] focus:border-transparent"
              >
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center space-x-2 mb-2">
                            {topic.isPinned && (
                              <Pin className="w-4 h-4 text-action-600" />
                            )}
                            {topic.isLocked && (
                          ...
                          {topic.tags.length > 0 && (
                            <div className="flex flex-wrap gap-1 mb-3">
                              {topic.tags.slice(0, 4).map(tag => (
                                <span
                                  key={tag}
                                  className="px-2 py-1 bg-secondary-100 text-secondary-600 text-xs rounded-full hover:bg-secondary-200 cursor-pointer flex items-center space-x-1"
                                >
                            ...
                            <div className="bg-gray-50 rounded-lg p-3">
                              <div className="flex items-center justify-between text-sm">
                                <div className="flex items-center space-x-2">
                                  ...
                                  <span className="text-secondary-600">Last reply by</span>
                              ...
                              <p className="text-secondary-600 text-sm mt-1 line-clamp-1">
                        ...
                        <div className="flex flex-col items-center space-y-4 ml-6 text-sm">
                          ...
                          <div className="flex items-center space-x-2">
                            <button className="flex items-center space-x-1 px-2 py-1 rounded hover:bg-green-50 text-action-600">
                              <ArrowUp className="w-4 h-4" />
                              <span className="text-sm">{topic.upvotes}</span>
                            </button>
                            <button className="flex items-center space-x-1 px-2 py-1 rounded hover:bg-red-50 text-coral-600">
