...
const sampleListings: HousingListing[] = [
  {
    ...
    description: 'Cozy room in traditional Portuguese household in Stockwell. Perfect for Portuguese speakers looking for a family environment.',
    ...
    features: ['Portuguese-speaking household', 'Near Portuguese shops', 'Shared kitchen', 'Bills included'],
    available: true
  },
  {
    id: '2',
    ...
    description: 'Looking for Portuguese-speaking flatmate to share modern 2-bedroom flat near Vauxhall Portuguese community.',
    ...
    features: ['Portuguese-speaking flatmate preferred', 'Near transport links', 'Modern facilities', 'Portuguese TV channels'],
    available: true
  },
  {
    id: '3',
    ...
    description: 'Spacious 3-bedroom flat perfect for Portuguese families. Close to Portuguese school and community center.',
...
export default function HousingAssistancePage() {
  ...
  const [searchType, setSearchType] = useState<'all' | 'room' | 'flat' | 'house' | 'flatmate'>('all')
        ...
        <div className="container-width">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              {isPortuguese ? (
                <>
                  Assistência de <span className="bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent">Habitação</span><br />
                  para a Comunidade Portuguesa
                </>
              ) : (
                <>
                  <span className="bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent">Housing Assistance</span><br />
            ...
            >
              <div className="grid grid-cols-2 gap-6 text-center">
                ...
                <div>
                  <div className="text-2xl font-bold text-secondary-600">9,009</div>
                  <div className="text-sm text-gray-600">
                    {isPortuguese ? 'Em Lambeth (Maior Concentração)' : 'In Lambeth (Largest Hub)'}
                  </div>
                </div>
              </div>
            </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder={isPortuguese ? 'Ex: Stockwell, Vauxhall...' : 'e.g. Stockwell, Vauxhall...'}
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="flatmate">{getTypeLabel('flatmate')}</option>
                    </select>
                  </div>
              ...
              {filteredListings.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">
                    {isPortuguese ? 'Nenhuma habitação encontrada' : 'No housing found'}
                  </h3>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder={isPortuguese ? 'Ex: Quarto em casa portuguesa em Stockwell' : 'e.g. Room in Portuguese household in Stockwell'}
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      rows={4}
                      placeholder={isPortuguese ? 'Descreva a habitação, características especiais, proximidade à comunidade portuguesa...' : 'Describe the housing, special features, proximity to Portuguese community...'}
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        type="text"
                        placeholder={isPortuguese ? 'Ex: Stockwell, SW9' : 'e.g. Stockwell, SW9'}
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder={isPortuguese ? 'Telefone, email ou WhatsApp' : 'Phone, email or WhatsApp'}
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                    />
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                {isPortuguese ? 'Conecte-se com famílias portuguesas' : 'Connect with Portuguese families'}
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                {isPortuguese ? 'Conselhos e orientação' : 'Advice and guidance'}
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                {isPortuguese ? 'Perto da comunidade portuguesa' : 'Near Portuguese community'}
              </p>
            </div>
          </div>
        </div>
