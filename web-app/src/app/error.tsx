            ...
            <div className="flex items-center justify-center space-x-2 text-primary-700 mb-2">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M3 5h12M9 3v2m6.586 10l4.414-4.414A2 2 0 0111.172 9l-7 7a2 2 0 01-2.829 0l-7-7a2 2 0 011.415-1.415L9 13l7-7z"
                />
              </svg>
              <span className="text-sm font-medium">
                {t("error.platform", "LusoTown Platform")}
              </span>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="mt-6 pt-4 border-t border-gray-200">
              <p className="text-xs text-gray-500 mb-2">
                {t("error.persistent", "Problema persistente?")}
              </p>
              <a
