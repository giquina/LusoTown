...
import PortugueseErrorBoundary from '@/components/monitoring/PortugueseErrorBoundary'
  ...
  return (
    <PortugueseErrorBoundary
      ...
      onError={(error, errorInfo) => {
        console.error('Root error page fallback triggered:', error, errorInfo)
      }}
    >
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            Multiple error boundaries have failed. This is a critical system error.
          </p>
          <button
            onClick={handleRetry}
