...
export default function TVPage() {
  ...
  const navigationTabs = [
    ...
    },
    {
      ...
      icon: Tv,
      description: isPortuguese ? "Programação portuguesa" : "Portuguese programming"
    },
    {
      id: "replays",
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              <span className="inline-flex items-center px-6 py-3 rounded-full text-sm font-medium bg-gradient-to-r from-primary-100 via-secondary-50 to-accent-100 border border-primary-200 shadow-lg">
                ...
                <span className="bg-gradient-to-r from-primary-600 via-secondary-600 to-accent-600 bg-clip-text text-transparent font-bold">
                  {isPortuguese ? "LusoTown TV - Televisão Portuguesa" : "LusoTown TV - Portuguese Television"}
                </span>
              </span>
            </motion.div>
            ...
            >
              <span className="hidden sm:block">
                {isPortuguese ? "Televisão Portuguesa em Londres" : "Portuguese Television in London"}
              </span>
        ...
        <div className="container-width">
          ...
          {activeTab === "programs" && (
            <div className="space-y-8">
              <div className="text-center mb-8">
                <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
                  {isPortuguese ? "Programação Portuguesa" : "Portuguese Programming"}
                </h2>
                <p className="text-gray-600">
                  {isPortuguese 
