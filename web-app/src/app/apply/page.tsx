...
export default function ApplyPage() {
  ...
  const routeFromData = (data: any) => {
    ...
    if (role === "professional" || role === "organizer")
      return `${ROUTES.signup}?focus=business`;
    if (role === "social" || interests.includes("social_connections"))
      return `${ROUTES.signup}?focus=community`;
    if (interests.includes("business-networking"))
      return `${ROUTES.signup}?focus=business`;
    if (interests.includes("cultural-events"))
      return `${ROUTES.signup}?focus=community`;
