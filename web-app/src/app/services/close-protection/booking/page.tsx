...
const protectionPackages = [
  {
    ...
    descriptionPortuguese:
      "Proteção pessoal profissional com consciência cultural",
  },
  {
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              >
                <option value="1">
                  1 {isPortuguese ? "pessoa" : "person"}
                </option>
                <option value="2">
                  2 {isPortuguese ? "pessoas" : "people"}
                </option>
                <option value="3">
                  3 {isPortuguese ? "pessoas" : "people"}
                </option>
                <option value="4">
                  4 {isPortuguese ? "pessoas" : "people"}
                </option>
                <option value="5+">
                  5+ {isPortuguese ? "pessoas" : "people"}
                </option>
              </select>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex justify-between">
              <button
                ...
                onClick={() =>
                  setCurrentStep(
                    Math.max(1, (currentStep - 1) as 1 | 2 | 3) as 1 | 2 | 3
                  )
                }
              ...
              {currentStep < 3 ? (
                <button
                  ...
                  onClick={() =>
                    setCurrentStep(
                      Math.min(3, (currentStep + 1) as 1 | 2 | 3) as 1 | 2 | 3
                    )
                  }
