...
const StudentEventsSection = dynamic(
  () => import("@/components/students/StudentEventsSection"),
  {
    loading: () => (
...
const AcademicNetworkingSection = dynamic(
  () => import("@/components/students/AcademicNetworkingSection"),
  {
    loading: () => (
...
const CareerHubSection = dynamic(
  () => import("@/components/students/CareerHubSection"),
  {
    loading: () => (
...
const StudentDiscountsSection = dynamic(
  () => import("@/components/students/StudentDiscountsSection"),
  {
    loading: () => (
...
const AccommodationSupportSection = dynamic(
  () => import("@/components/students/AccommodationSupportSection"),
  {
    loading: () => (
...
const UNIVERSITIES: University[] = [
  {
    ...
    programs: {
      undergraduate: [
        "Lusophone & Brazilian Studies",
        "Modern Languages with Lusophone",
        "International Business with Lusophone",
      ],
      postgraduate: [
        "Lusophone Literature MA",
        "Lusophone Studies MA",
        "Brazilian Cultural Studies MA",
      ],
      research: [
        "Lusophone Language PhD",
        "Lusophone Literature PhD",
        "Lusophone History PhD",
      ],
      languageCourses: [
        "Lusophone A1-C2",
        "Business Lusophone",
        "Lusophone for Heritage Speakers",
      ],
    },
    benefits: [
  ...
  },
  {
    ...
    programs: {
      undergraduate: [
        "Lusophone Studies",
        "Comparative Literature with Lusophone",
        "European Studies with Lusophone",
      ],
      postgraduate: [
        "Lusophone & Brazilian Studies MA",
        "Digital Humanities with Lusophone Sources MA",
      ],
      research: [
        "Lusophone Cultural Studies PhD",
        "Lusophone Digital Humanities PhD",
      ],
      languageCourses: [
        "Lusophone Language & Culture",
        "Advanced Lusophone Communication",
        "Lusophone Translation Studies",
      ],
    },
    benefits: [
  ...
  },
  {
    ...
    programs: {
      undergraduate: [
        "Modern & Medieval Languages (Lusophone)",
        "Lusophone Studies",
      ],
      postgraduate: ["Lusophone Literature MPhil", "Romance Linguistics MPhil"],
      research: [
        "Lusophone Language & Literature PhD",
        "Comparative Romance Studies PhD",
      ],
      languageCourses: [
        "Lusophone Language (Beginner to Advanced)",
  ...
  },
  {
    ...
    programs: {
      ...
      languageCourses: [
        "Lusophone for Business",
        "Lusophone for Social Scientists",
      ],
    },
    benefits: [
      "50% discount on LusoTown membership",
  ...
  },
  {
    ...
    programs: {
      ...
      languageCourses: [
        "Lusophone for Engineers",
        "Technical Lusophone Communication",
      ],
    },
    benefits: [
      "50% discount on LusoTown membership",
  ...
  },
  {
    ...
    programs: {
      undergraduate: [
        "Spanish & Lusophone Studies",
        "Modern Languages with Lusophone",
      ],
      postgraduate: [
        "Hispanic & Lusophone Studies MA",
        "Translation & Interpretation Studies",
      ],
      research: ["Lusophone Literature PhD", "Comparative Literature PhD"],
      languageCourses: [
        "Lusophone Language & Culture",
        "Business Lusophone for International Trade",
      ],
    },
    benefits: [
      "50% discount on LusoTown membership",
  ...
  },
  {
    ...
    programs: {
      undergraduate: [
        "Lusophone Studies",
        "Hispanic Studies with Lusophone",
        "Comparative Literature",
      ],
      postgraduate: [
        "Lusophone Studies MSc",
        "Celtic & Scottish Studies with Lusophone connections",
      ],
      research: [
        "Lusophone Cultural Studies PhD",
        "Comparative Celtic-Lusophone Studies PhD",
      ],
      languageCourses: [
        "Lusophone Language (All Levels)",
        "Lusophone Cultural Immersion",
      ],
    },
    benefits: [
      "50% discount on LusoTown membership",
...
const STUDENT_BENEFITS: StudentBenefit[] = [
  {
    ...
    description: `Exclusive 50% discount on LusoTown Community membership for verified students. Pay only ${formatPrice(
      STUDENT_PRICING.community.monthly
    )}/month instead of ${formatPrice(
      SUBSCRIPTION_PLANS.community.monthly
    )} for full community access.`,
    descriptionPortuguese: `Desconto exclusivo de 50% na adesão Comunidade LusoTown para estudantes verificados. Pague apenas ${formatPrice(
      STUDENT_PRICING.community.monthly
    )}/mês em vez de ${formatPrice(
      SUBSCRIPTION_PLANS.community.monthly
    )} por acesso completo à comunidade.`,
    category: "financial",
    discountAmount: "50%",
    eligibility: [
  ...
  },
  {
    ...
    description:
      "Weekly language exchange sessions with native speakers from all Portuguese-speaking countries - from Lisbon to São Paulo, Luanda to Praia. Experience diverse accents, cultural expressions, and regional variations.",
    descriptionPortuguese:
      "Sessões semanais de intercâmbio linguístico com falantes nativos de todos os países lusófonos - de Lisboa a São Paulo, Luanda à Praia. Experiencie sotaques diversos, expressões culturais e variações regionais.",
    category: "academic",
    eligibility: [
      "University students",
      "All Lusophone levels welcome",
      "All Lusophone backgrounds",
    ],
    verificationRequired: true,
  ...
  },
  {
    ...
    description:
      "One-on-one mentorship with established Portuguese-speaking professionals from your cultural background - whether São Paulo business leaders, Luanda entrepreneurs, or Lusophone tech innovators. Find your mentor from any Portuguese-speaking nation.",
    descriptionPortuguese:
      "Mentoria individual com profissionais lusófonos estabelecidos da sua origem cultural - sejam líderes empresariais de São Paulo, empresários de Luanda, ou inovadores tecnológicos portugueses. Encontre o seu mentor de qualquer nação lusófona.",
  ...
  },
  {
    ...
    description:
      "Subject-specific study groups connecting Portuguese-speaking students across United Kingdom universities. From Brazilian study groups to Lusophone academic workshops - collaborate with students who share your cultural background and language.",
    descriptionPortuguese:
      "Grupos de estudo específicos por disciplina conectando estudantes lusófonos em universidades do Reino Unido. De grupos de estudo brasileiros a workshops acadêmicos portugueses - colabore com estudantes que partilham a sua origem cultural e linguística.",
    category: "academic",
    eligibility: [
      "University students",
  ...
  },
  {
    ...
    description:
      "Monthly multicultural events celebrating all Portuguese-speaking nations: Lusophone Music nights (Fado, Samba, Kizomba), Brazilian carnival celebrations, Angolan traditional dance, Cape Verdean morna evenings, and pan-Lusophone festivals.",
    descriptionPortuguese:
      "Eventos multiculturais mensais celebrando todas as nações lusófonas: noites de Música Lusófona (Fado, Samba, Kizomba), celebrações de carnaval brasileiro, dança tradicional angolana, noites de morna cabo-verdiana e festivais pan-lusófonos.",
    category: "cultural",
    eligibility: [
      "University students",
      "Student verification required",
      "All Lusophone backgrounds welcome",
    ],
    verificationRequired: true,
  ...
  },
  {
    ...
    description:
      "Exclusive access to internship opportunities with Portuguese-speaking businesses in London, United Kingdom, Portugal, Brazil, Angola, and other Lusophone markets. Gain professional experience in culturally familiar environments.",
    descriptionPortuguese:
      "Acesso exclusivo a oportunidades de estágio com empresas lusófonas em Londres, Reino Unido, Portugal, Brasil, Angola e outros mercados lusófonos. Ganhe experiência profissional em ambientes culturalmente familiares.",
    category: "professional",
    eligibility: [
      "University students",
      "Recent graduates",
  ...
  },
  {
    ...
    description:
      "Academic writing support, research guidance, and dissertation help for any Lusophone-related studies. Connect with academic mentors specializing in Lusophone, Brazilian, Angolan, Cape Verdean, and other Lusophone academic fields.",
    descriptionPortuguese:
      "Apoio à escrita acadêmica, orientação de pesquisa e ajuda com dissertações para estudos relacionados com qualquer área lusófona. Conecte-se com mentores acadêmicos especializados em áreas acadêmicas portuguesas, brasileiras, angolanas, cabo-verdianas e outras lusófonas.",
    category: "academic",
    eligibility: [
      "Students in Lusophone studies",
      "Portuguese-speaking research students",
      "Any Lusophone-related academic work",
    ],
    verificationRequired: true,
  ...
  },
  {
    ...
    description:
      "Quarterly networking events connecting students with Portuguese-speaking professionals, entrepreneurs, and recent graduates from all 10 Lusophone countries. Build meaningful connections with professionals who understand your cultural background.",
    descriptionPortuguese:
      "Eventos trimestrais de networking conectando estudantes com profissionais lusófonos, empresários e recém-graduados dos 10 países lusófonos. Construa conexões significativas com profissionais que compreendem a sua origem cultural.",
    category: "professional",
    eligibility: [
      "University students",
      "All years and disciplines",
      "All Lusophone backgrounds",
    ],
    verificationRequired: true,
  ...
  },
  {
    ...
    titlePortuguese:
      "Conteúdo de Transmissão ao Vivo Exclusivo para Estudantes",
    description:
      "Weekly live streams covering study tips, career advice, Portuguese culture, and academic life in the United Kingdom. Interactive Q&A sessions with experts.",
    descriptionPortuguese:
      "Transmissões ao vivo semanais cobrindo dicas de estudo, conselhos de carreira, cultura portuguesa e vida acadêmica no Reino Unido. Sessões interativas de perguntas e respostas com especialistas.",
    category: "academic",
    eligibility: [
      "University students",
      "Portuguese-speaking community interest",
    ],
    verificationRequired: true,
  ...
  },
  {
    ...
    description:
      "Comprehensive support for students planning to study in Portugal: university connections, accommodation help, cultural preparation, and ongoing support.",
    descriptionPortuguese:
      "Apoio abrangente para estudantes que planeiam estudar em Portugal: conexões universitárias, ajuda com alojamento, preparação cultural e apoio contínuo.",
    category: "academic",
    eligibility: [
      "Students planning Portugal exchange",
...
const STUDENT_EVENTS: StudentEvent[] = [
  {
    ...
    capacity: 40,
    description:
      "Explore career opportunities in Portugal's booming tech sector. Learn about Lusophone startups, multinational tech companies, and remote work opportunities.",
    speakers: [
      "Ana Silva - CTO at Lusophone Startup",
      "Miguel Costa - Google Portugal",
      "Joana Fernandes - Startup Founder",
    ],
  ...
  },
  {
    ...
    capacity: 80,
    description:
      "Monthly Lusophone film screening followed by discussion with Lusophone studies students and film experts. This month: contemporary Lusophone cinema.",
    speakers: [
      "Dr. Maria Fernandes - Lusophone Studies",
      "Carlos Mendes - Film Critic",
    ],
    isStudentExclusive: true,
  },
  {
    ...
    capacity: 60,
    description:
      "Connect with Lusophone professionals across industries. Practice networking skills, learn about career paths, and discover internship opportunities.",
  ...
  },
  {
    ...
    capacity: 50,
    description:
      "Learn about study abroad opportunities in Portugal, Erasmus+ programs, Lusophone universities, and cultural preparation for your exchange.",
    speakers: [
      "Lusophone Embassy Education Attaché",
      "Erasmus+ Coordinator",
      "Student Exchange Alumni",
    ],
    isStudentExclusive: true,
  },
  {
    ...
    capacity: 100,
    description:
      "Student entrepreneurs pitch their business ideas to Lusophone investors and successful entrepreneurs. Win mentorship and potential funding.",
    speakers: [
      "Lusophone Angel Investors",
      "Successful Lusophone Entrepreneurs",
      "Business Mentors",
    ],
    isStudentExclusive: true,
  },
  {
    ...
    capacity: 50,
    description:
      "Explore the rich musical heritage of Portuguese-speaking countries! Learn Fado from Portugal 🇵🇹, Samba from Brazil 🇧🇷, and Kizomba from Angola 🇦🇴. Workshop includes instruments, dance basics, and cultural history.",
    speakers: [
      "Maria João - Professional Fadista (Portugal)",
      "Carlos Silva - Samba Musician (Brazil)",
      "Ana Santos - Kizomba Dance Teacher (Angola)",
    ],
    isStudentExclusive: true,
  },
];
...
export default function StudentsPage() {
  ...
  const filteredUniversities =
    selectedUniversityType === "all"
      ? UNIVERSITIES
      : UNIVERSITIES.filter((uni) => uni.type === selectedUniversityType);

  const filteredBenefits =
    selectedBenefitCategory === "all"
      ? STUDENT_BENEFITS
      : STUDENT_BENEFITS.filter(
          (benefit) => benefit.category === selectedBenefitCategory
        );

  const universityTypes = [
    {
      value: "all",
      label: { en: "All Universities", pt: "Todas as Universidades" },
    },
    {
      value: "russell_group",
      label: { en: "Russell Group", pt: "Grupo Russell" },
    },
    {
      value: "london_university",
      label: { en: "London Universities", pt: "Universidades de Londres" },
    },
  ...
  const benefitCategories = [
    ...
    {
      value: "professional",
      label: { en: "Professional", pt: "Profissionais" },
    },
      ...
      <div className="pt-16">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-primary-50 via-white to-secondary-50 pt-20">
          <div
            ...
            style={{
              backgroundImage: `url('${IMAGES.backgrounds.universityStudents}')`,
            }}
          ></div>
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                <div className="inline-flex items-center gap-3 bg-gradient-to-r from-orange-500 via-red-500 to-yellow-500 text-white px-6 py-3 rounded-full font-bold text-sm shadow-xl">
                  ...
                  <span>
                    {t(
                      "palop.students.support",
                      "PALOP Student Support Network"
                    )}
                  </span>
              ...
              >
                ...
                >
                  <span className="flex items-center justify-center">
                    ...
                    {language === "pt"
                      ? "Junte-se à sua Comunidade Cultural"
                      : "Join Your Cultural Academic Community"}
                  </span>
                ...
                <button
                  onClick={() =>
                    document
                      .getElementById("partner-universities")
                ...
                >
                  ...
                  {language === "pt"
                    ? "Explorar 8 Universidades Parceiras"
                    : "Explore 8 Partner Universities"}
                </button>
              </motion.div>
              ...
              >
                <div className="flex items-center justify-center mb-2">
                  ...
                  <span className="font-bold text-orange-800">
                    {language === "pt"
                      ? "Oferta Limitada para Estudantes"
              ...
              >
                <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-primary-100 hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="text-xs text-primary-600 mt-1">
                    {language === "pt" ? "De 10 países" : "From 10 countries"}
                  </div>
                </div>
                <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-secondary-100 hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="text-xs text-secondary-600 mt-1">
                    {language === "pt" ? "Graduação" : "Graduation"}
                  </div>
                </div>
                ...
                <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-premium-100 hover:shadow-xl transition-all duration-300 relative">
                  ...
                  <div className="text-xs text-red-600 mt-1 font-semibold">
                    {language === "pt" ? "50% desconto!" : "50% off!"}
                  </div>
          ...
          <div className="container-width">
                ...
                >
                  <div className="p-6">
                      ...
                      <div
                        className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                          benefit.category === "financial"
                            ...
                            : benefit.category === "academic"
                            ? "bg-primary-100 text-primary-600"
                            : benefit.category === "professional"
                            ? "bg-premium-100 text-premium-600"
                            : benefit.category === "cultural"
                    ...
                    <h3 className="font-bold text-lg text-gray-900 mb-3">
                      {language === "pt"
                        ? benefit.titlePortuguese
                        : benefit.title}
                    </h3>

                    <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                      {language === "pt"
                        ? benefit.descriptionPortuguese
                        : benefit.description}
                    </p>
            ...
            <div className="bg-gradient-to-br from-secondary-50 via-primary-50 to-accent-50 rounded-2xl p-8 text-center border border-secondary-200 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                {language === "pt"
                  ? "🎯 Valor Excepcional para Sua Educação Cultural"
                  : "🎯 Exceptional Value for Your Cultural Education"}
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="text-sm text-gray-600 mb-2">
                    {language === "pt"
                      ? "Valor anual em benefícios"
                      : "Annual value in benefits"}
                  </div>
                  <div className="text-xs text-secondary-600">
                    {language === "pt"
                      ? "Mentoria + Eventos + Networking"
                      : "Mentorship + Events + Networking"}
                  </div>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300 border-2 border-primary-200">
                  ...
                  <div className="text-sm text-gray-600 mb-2">
                    {language === "pt"
                      ? "Custo mensal estudante"
                      : "Monthly student cost"}
                  </div>
                  <div className="text-xs text-primary-600 font-semibold">
                    {language === "pt"
                      ? "50% desconto garantido"
                      : "50% discount guaranteed"}
                  </div>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="text-xs text-accent-600">
                    {language === "pt" ? "ROI comprovado" : "Proven ROI"}
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  ...
                  {language === "pt"
                    ? "Começar Agora - Verificação Gratuita"
                    : "Start Now - Free Verification"}
                </button>
                <button
                  onClick={() =>
                    window.open("https://calendly.com/lusotown-demo", "_blank")
                  }
              ...
              items={[
                {
                  ...
                  title: {
                    ...
                    pt: "University College London (UCL)",
                  },
                  subtitle: {
                    en: "Strategic Partner • Russell Group",
                    pt: "Parceiro Estratégico • Grupo Russell",
                  },
                  description: {
                  ...
                  metadata: {
                    programs: {
                      en: "Portuguese Studies, Brazilian Literature, Linguistics",
                      pt: "Estudos Portugueses, Literatura Brasileira, Linguística",
                    },
                    students: {
                      en: "180+ Portuguese speakers",
                      pt: "Mais de 180 falantes de português",
                    },
                    partnership: {
                      en: "Strategic Academic Partnership",
                      pt: "Parceria Académica Estratégica",
                    },
                    support: {
                      en: "Portuguese Society, Academic Mentoring, Career Support",
                      pt: "Sociedade Portuguesa, Mentoria Académica, Apoio de Carreira",
                    },
                  },
                },
                {
                  ...
                  title: {
                    ...
                    pt: "King's College London",
                  },
                  subtitle: {
                    en: "Strategic Partner • Literature & Arts Focus",
                    pt: "Parceiro Estratégico • Foco em Literatura e Artes",
                  },
                  description: {
                  ...
                  metadata: {
                    programs: {
                      en: "Comparative Literature, Modern Languages, Cultural Studies",
                      pt: "Literatura Comparada, Línguas Modernas, Estudos Culturais",
                    },
                    students: {
                      en: "145+ Portuguese speakers",
                      pt: "Mais de 145 falantes de português",
                    },
                    specialization: {
                      en: "Brazilian and African Literature",
                      pt: "Literatura Brasileira e Africana",
                    },
                    events: {
                      en: "Monthly Lusophone Literary Evenings",
                      pt: "Noites Literárias Lusófonas Mensais",
                    },
                  },
                },
                {
                  ...
                  title: {
                    ...
                    pt: "Imperial College London",
                  },
                  subtitle: {
                    en: "Official Partner • STEM Excellence",
                    pt: "Parceiro Oficial • Excelência STEM",
                  },
                  description: {
                  ...
                  metadata: {
                    programs: {
                      en: "Engineering, Computing, Business Tech",
                      pt: "Engenharia, Computação, Tecnologia Empresarial",
                    },
                    students: {
                      en: "120+ Portuguese speakers",
                      pt: "Mais de 120 falantes de português",
                    },
                    focus: {
                      en: "Tech Innovation & Entrepreneurship",
                      pt: "Inovação Tecnológica e Empreendedorismo",
                    },
                    networking: {
                      en: "Lusophone Tech Society, Startup Incubator",
                      pt: "Sociedade Tecnológica Lusófona, Incubadora de Startups",
                    },
                  },
                },
                {
                  id: "lse-programs",
                  title: {
                    en: "London School of Economics (LSE)",
                    pt: "London School of Economics (LSE)",
                  },
                  subtitle: {
                    en: "Strategic Partner • Social Sciences Leader",
                    pt: "Parceiro Estratégico • Líder em Ciências Sociais",
                  },
                  description: {
                  ...
                  metadata: {
                    programs: {
                      en: "Economics, International Relations, Development Studies",
                      pt: "Economia, Relações Internacionais, Estudos de Desenvolvimento",
                    },
                    students: {
                      en: "95+ Portuguese speakers",
                      pt: "Mais de 95 falantes de português",
                    },
                    research: {
                      en: "Lusophone Economies Research Center",
                      pt: "Centro de Pesquisa de Economias Lusófonas",
                    },
                    opportunities: {
                      en: "PALOP Development Internships",
                      pt: "Estágios de Desenvolvimento PALOP",
                    },
                  },
                },
              ]}
              title={{
                en: "University Partnership Programs",
                pt: "Programas de Parcerias Universitárias",
              }}
              subtitle={{
                en: "Discover Portuguese-focused programs at leading UK universities",
                pt: "Descubra programas focados no português nas principais universidades do Reino Unido",
              }}
                    ...
                    {university.metadata?.programs && (
                      <div className="bg-primary-50/80 rounded-lg p-3">
                        ...
                        <span className="text-gray-700 text-xs">
                          {university.metadata.programs.en}
                        </span>
                      </div>
                    )}
                    {university.metadata?.students && (
                      <div className="bg-secondary-50/80 rounded-lg p-3">
                        <span className="font-semibold text-secondary-700 text-xs">
                          {t("university.students", "Students")}:{" "}
                        </span>
                        <span className="text-gray-700 text-xs">
                          {university.metadata.students.en}
                        </span>
                      </div>
                    )}
                    {university.metadata?.support && (
                      <div className="bg-accent-50/80 rounded-lg p-3">
                        <span className="font-semibold text-accent-700 text-xs">
                          {t("university.support", "Support")}:{" "}
                        </span>
                        <span className="text-gray-700 text-xs">
                          {university.metadata.support.en}
                        </span>
                      </div>
                    )}
                  </div>
              ...
              items={[
                {
                  id: "tech-workshop",
                  title: {
                    en: "Lusophone Tech Career Workshop",
                    pt: "Workshop de Carreira Tecnológica Lusófona",
                  },
                  subtitle: {
                    en: "Professional Development • Imperial College",
                    pt: "Desenvolvimento Profissional • Imperial College",
                  },
                  description: {
                ...
                },
                {
                  id: "academic-network",
                  title: {
                    en: "Academic Excellence Network",
                    pt: "Rede de Excelência Académica",
                  },
                  subtitle: {
                    en: "Study Groups • Multiple Universities",
                    pt: "Grupos de Estudo • Várias Universidades",
                  },
                  description: {
                  ...
                  metadata: {
                    date: {
                      en: "Every Wednesday",
                      pt: "Todas as Quartas-feiras",
                    },
                    time: { en: "5:00 PM - 7:00 PM", pt: "17:00 - 19:00" },
                    location: {
                      en: "Rotating university libraries",
                      pt: "Bibliotecas universitárias rotativas",
                    },
                    price: { en: "FREE", pt: "GRATUITO" },
                    groups: {
                      en: "8 active study groups",
                      pt: "8 grupos de estudo ativos",
                    },
                  },
                },
                {
                  ...
                  title: {
                    en: "Portuguese Heritage Month Celebration",
                    pt: "Celebração do Mês da Herança Portuguesa",
                  },
                  subtitle: {
                    en: "Cultural Festival • King's College",
                    pt: "Festival Cultural • King's College",
                  },
                  description: {
                  ...
                  metadata: {
                    date: {
                      en: "November 15, 2024",
                      pt: "15 de Novembro de 2024",
                    },
                    time: { en: "2:00 PM - 8:00 PM", pt: "14:00 - 20:00" },
                    location: {
                      en: "King's College Strand Campus",
                      pt: "King's College Campus Strand",
                    },
                    price: {
                      en: "£8 students / £12 general",
                      pt: "£8 estudantes / £12 geral",
                    },
                    features: {
                      en: "Live music, food, cultural exhibits",
                      pt: "Música ao vivo, comida, exposições culturais",
                    },
                  },
                },
                {
                  id: "career-mentorship",
                  title: {
                    en: "Lusophone Professional Mentorship",
                    pt: "Mentoria Profissional Lusófona",
                  },
                  subtitle: {
                    en: "Career Guidance • Cross-University",
                    pt: "Orientação de Carreira • Inter-Universitário",
                  },
                  description: {
                  ...
                  metadata: {
                    date: {
                      en: "First Saturday monthly",
                      pt: "Primeiro sábado do mês",
                    },
                    time: { en: "10:00 AM - 2:00 PM", pt: "10:00 - 14:00" },
                    location: {
                      en: "Central London venues",
                      pt: "Locais no centro de Londres",
                    },
                    price: { en: "£5 for students", pt: "£5 para estudantes" },
                    mentors: {
                      en: "25+ professional mentors",
                      pt: "Mais de 25 mentores profissionais",
                    },
                  },
                },
              ]}
              title={{
                en: "Student Cultural Events",
                pt: "Eventos Culturais Estudantis",
              }}
              subtitle={{
                en: "Academic, professional, and cultural activities for Portuguese-speaking students",
                pt: "Atividades académicas, profissionais e culturais para estudantes lusófonos",
              }}
        ...
        <section id="partner-universities" className="py-20 bg-gray-50">
          <div className="container-width">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                {language === "pt"
                  ? "Universidades Parceiras no Reino Unido"
                    ...
                    <div className="grid grid-cols-3 gap-3 mb-4 text-center">
                      <div className="bg-gray-50 rounded-lg p-2">
                        <div className="text-lg font-bold text-primary-600">
                          {university.portugueseStudents}
                        </div>
                        <div className="text-xs text-gray-600">
                          {language === "pt" ? "Estudantes PT" : "PT Students"}
                        </div>
                      </div>
                      <div className="bg-gray-50 rounded-lg p-2">
                        <div className="text-lg font-bold text-secondary-600">
                          {(university.internationalStudents / 1000).toFixed(0)}
                          k
                        </div>
                        <div className="text-xs text-gray-600">
                          {language === "pt"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">
                {language === "pt"
                  ? "Impacto das Parcerias Universitárias"
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
                <div>
                  ...
                  <div className="text-sm text-gray-600">
                    {language === "pt"
                      ? "Estudantes Lusófonos Apoiados"
                      : "Portuguese-speaking Students Supported"}
                  </div>
                </div>
                <div>
                  ...
                  <div className="text-sm text-gray-600">
                    {language === "pt"
                      ? "Programas de Estudos Portugueses"
                      : "Lusophone Studies Programs"}
                  </div>
                </div>
                <div>
                  ...
                  <div className="text-sm text-gray-600">
                    {language === "pt"
                      ? "Valor em Benefícios Estudantis"
                      : "Value in Student Benefits"}
                  </div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-premium-600 mb-2">
                    92%
                  </div>
                  <div className="text-sm text-gray-600">
                    {language === "pt"
          ...
          <div className="container-width">
            <div className="text-center mb-16">
              <div className="inline-flex items-center bg-gradient-to-r from-accent-100 to-primary-100 px-6 py-3 rounded-full mb-6">
                ...
                <span className="font-bold text-accent-700">
                  {language === "pt"
                    ? "🤝 50+ Sociedades • Unidos pela Língua"
                    : "🤝 50+ Societies • United by Language"}
                </span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                {language === "pt"
                  ? "Rede de Sociedades Universitárias"
                  : "University Societies Network"}
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
                {language === "pt"
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-bold text-gray-900 mb-3">
                    {language === "pt"
                      ? "🤝 Conecte com Outras Sociedades"
                      : "🤝 Connect with Other Societies"}
                  </h4>
                  <p className="text-gray-600 mb-4">
                    {language === "pt"
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                    <span className="text-blue-700 font-medium text-sm">
                      {language === "pt"
                        ? "🌍 50+ Sociedades no Reino Unido"
                        : "🌍 50+ Societies Across UK"}
                    </span>
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <div className="bg-purple-50 border border-purple-200 rounded-lg p-3">
                    <span className="text-purple-700 font-medium text-sm">
                      {language === "pt"
                        ? "🏆 Eventos de 300+ Pessoas"
                        : "🏆 Events with 300+ Attendance"}
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
                  <div className="bg-white rounded-lg p-4 border border-yellow-100">
                    <div className="text-sm font-medium text-gray-900 mb-1">
                      {language === "pt"
                        ? "1. UCL Sociedade Portuguesa"
                        : "1. UCL Lusophone Society"}
                    </div>
                    <div className="text-xs text-gray-600">
                      {language === "pt"
                        ? "Propõe festival cultural"
                        : "Proposes cultural festival"}
                    </div>
                  </div>
                  <div className="bg-white rounded-lg p-4 border border-yellow-100">
                    <div className="text-sm font-medium text-gray-900 mb-1">
                      {language === "pt"
                        ? "2. + 7 Sociedades de Londres"
                        : "2. + 7 London Societies"}
                    </div>
                    <div className="text-xs text-gray-600">
                      {language === "pt"
                        ? "Juntam-se no planeamento"
                        : "Join planning platform"}
                    </div>
                  </div>
                  <div className="bg-white rounded-lg p-4 border border-yellow-100">
                    <div className="text-sm font-medium text-gray-900 mb-1">
                      {language === "pt"
                        ? "3. Planeamento Conjunto"
                        : "3. Joint Planning"}
                    </div>
                    <div className="text-xs text-gray-600">
                      {language === "pt"
                        ? "Orçamento, locais, performers"
                        : "Budget, venues, performers"}
                    </div>
                  </div>
                  <div className="bg-white rounded-lg p-4 border border-yellow-100">
                    <div className="text-sm font-medium text-gray-900 mb-1">
                      {language === "pt"
                        ? "4. Festival de Herança"
                        : "4. Heritage Festival"}
                    </div>
                    <div className="text-xs text-gray-600">
                      {language === "pt"
                        ? "1.200+ estudantes, £15k caridade"
                        : "students, charity raised"}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 bg-gradient-to-r from-blue-50 to-green-50 rounded-xl p-6 border border-blue-200">
                <h4 className="text-lg font-bold text-gray-900 mb-4 text-center">
                  {language === "pt"
                    ? "O Que Isto Significa Para Estudantes?"
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-gray-600 space-y-1">
                      <li>
                        •{" "}
                        {language === "pt"
                          ? "Festivais com 300+ estudantes lusófonos"
                          : "Festivals with 300+ Portuguese-speaking students"}
                      </li>
                      <li>
                        •{" "}
                        {language === "pt"
                          ? "Mais patrocinadores e melhores locais"
                          : "More sponsors and better venues"}
                      </li>
                      <li>
                        •{" "}
                        {language === "pt"
                          ? "Performers de qualidade profissional"
                          : "Professional-quality performers"}
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="text-sm text-gray-600 space-y-1">
                      <li>
                        •{" "}
                        {language === "pt"
                          ? "Conhecer estudantes de outras universidades"
                          : "Meet students from other universities"}
                      </li>
                      <li>
                        •{" "}
                        {language === "pt"
                          ? "Celebrar TODAS as culturas lusófonas"
                          : "Celebrate ALL Portuguese-speaking cultures"}
                      </li>
                      <li>
                        •{" "}
                        {language === "pt"
                          ? "Network profissional mais forte"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              ...
              >
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">
                  {language === "pt"
                    ? "Diretório de Sociedades"
                    : "Society Directory & Networking"}
                </h3>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mb-16">
              <div className="flex items-center justify-between mb-8">
                <h3 className="text-2xl font-bold text-gray-900">
                  {language === "pt"
                    ? "Sociedades Lusófonas em Destaque"
                    : "Featured Lusophone-Speaking University Societies"}
                </h3>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    {
                      name: "UCL Lusophone-Speaking Society",
                      members: 420,
                      university: "University College London",
                    },
                    {
                      name: "King's College Lusophone Society",
                      members: 380,
                      university: "King's College London",
                    },
                    {
                      name: "Imperial Lusophone Language Society",
                      members: 290,
                      university: "Imperial College London",
                    },
                    {
                      name: "LSE Lusophone-Speaking Students",
                      members: 350,
                      university: "London School of Economics",
                    },
                    {
                      name: "Queen Mary Lusophone Cultural Society",
                      members: 180,
              ...
              <div className="mb-8">
                <h4 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                  ...
                  {language === "pt"
                    ? "🎓 Principais Universidades do Reino Unido"
                    : "🎓 Major UK Universities"}
                </h4>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {[
                    {
                      name: "Oxford Lusophone-Speaking Society",
                      members: 95,
                      city: "Oxford",
                    },
                    {
                      name: "Cambridge Lusophone Cultural Society",
                      members: 110,
                      city: "Cambridge",
                    },
                    {
                      name: "Manchester Lusophone Language Society",
                      members: 290,
                      city: "Manchester",
                    },
                    {
                      name: "Edinburgh Lusophone-Speaking Society",
                      members: 180,
                      city: "Edinburgh",
                    },
                  ].map((society, index) => (
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                  {[
                    {
                      name: "Birmingham Lusophone-Speaking Students",
                      members: 200,
                    },
                    ...
                    {
                      name: "Cardiff Lusophone-Speaking Society",
                      members: 110,
                    },
                  ].map((society, index) => (
                    <div
                      key={index}
                      className="bg-gradient-to-br from-green-50 to-blue-50 rounded-lg p-3 border border-green-100"
                    >
                      <h5 className="font-medium text-gray-900 mb-1 text-xs">
                        {society.name}
                      </h5>
            ...
            <div className="bg-gradient-to-r from-accent-500 to-primary-500 rounded-2xl p-8 text-white mb-16">
              <div className="text-center mb-8">
                <h3 className="text-2xl md:text-3xl font-bold mb-4">
                  {language === "pt"
                    ? "Planos Anuais para Sociedades Universitárias"
                    : "University Society Annual Plans"}
                </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <ul className="space-y-3 mb-6">
                    <li className="flex items-center">
                      ...
                      <span className="text-sm">
                        {language === "pt"
                          ...
                          : "Basic society profile in directory"}
                      </span>
                    </li>
                    <li className="flex items-center">
                      <CheckIconSolid className="w-5 h-5 text-green-300 mr-3" />
                      <span className="text-sm">
                        {language === "pt"
                          ? "Contactos de outras sociedades"
                          : "Browse other society contacts"}
                      </span>
                    </li>
                    <li className="flex items-center">
                      <CheckIconSolid className="w-5 h-5 text-green-300 mr-3" />
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-sm">
                        {language === "pt"
                          ? "Mensagens básicas"
                          : "Basic messaging between societies"}
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white rounded-xl p-6 text-gray-900 relative border-2 border-yellow-300">
                  ...
                  <div className="text-center mb-6">
                    ...
                    <div className="text-3xl font-bold mb-1 text-accent-600">
                      £75
                    </div>
                  ...
                  <ul className="space-y-3 mb-6">
                    <li className="flex items-center">
                      ...
                      <span className="text-sm">
                        {language === "pt"
                          ? "Dashboard avançado de planeamento"
                          : "Advanced joint event planning dashboard"}
                      </span>
                    </li>
                    <li className="flex items-center">
                      <CheckIconSolid className="w-5 h-5 text-green-500 mr-3" />
                      <span className="text-sm">
                        {language === "pt"
                          ? "Divisão automática de orçamentos"
                          : "Shared budget tracking and expense splitting"}
                      </span>
                    </li>
                    <li className="flex items-center">
                      <CheckIconSolid className="w-5 h-5 text-green-500 mr-3" />
                      <span className="text-sm">
                        {language === "pt"
                          ...
                          : "Corporate sponsor matching database"}
                      </span>
                    </li>
                    <li className="flex items-center">
                      <CheckIconSolid className="w-5 h-5 text-green-500 mr-3" />
                      <span className="text-sm">
                        {language === "pt"
                          ? "Gestão de projetos multi-sociedade"
                          : "Multi-society project management tools"}
                      </span>
                    </li>
                    <li className="flex items-center">
                      <CheckIconSolid className="w-5 h-5 text-green-500 mr-3" />
                      <span className="text-sm">
                        {language === "pt"
                          ? "Partilha de receitas (2% comissão)"
                          : "Revenue sharing for ticket sales (2% commission)"}
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                  ...
                  <ul className="space-y-3 mb-6">
                    <li className="flex items-center">
                      ...
                      <span className="text-sm">
                        {language === "pt"
                          ? "Múltiplas sociedades numa conta"
                          : "Manage multiple societies under one account"}
                      </span>
                    </li>
                    <li className="flex items-center">
                      <CheckIconSolid className="w-5 h-5 text-green-300 mr-3" />
                      <span className="text-sm">
                        {language === "pt"
                          ? "Coordenação entre sociedades"
                          : "Cross-society coordination tools"}
                      </span>
                    </li>
                    <li className="flex items-center">
                      <CheckIconSolid className="w-5 h-5 text-green-300 mr-3" />
                      <span className="text-sm">
                        {language === "pt"
                          ? "Planeamento universitário completo"
                          : "University-wide event planning"}
                      </span>
                    </li>
                    <li className="flex items-center">
                      <CheckIconSolid className="w-5 h-5 text-green-300 mr-3" />
                      <span className="text-sm">
                        {language === "pt"
                          ? "Parcerias corporativas avançadas"
                          : "Enhanced corporate partnership opportunities"}
                      </span>
                    </li>
                    <li className="flex items-center">
                      <CheckIconSolid className="w-5 h-5 text-green-300 mr-3" />
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mb-16">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
                  {language === "pt"
                    ? "Histórias de Sucesso em Colaboração"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-6 border border-yellow-100">
                  <div className="text-center mb-4">
                    ...
                    <h4 className="font-bold text-gray-900">
                      {language === "pt"
                        ? "Festival de Herança Portuguesa de Londres 2024"
                        : "London Lusophone Heritage Festival 2024"}
                    </h4>
                  </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-green-50 rounded-xl p-6 border border-blue-100">
                  <div className="text-center mb-4">
                    ...
                    <h4 className="font-bold text-gray-900">
                      {language === "pt"
                        ? "Mês Cultural de Estudantes Lusófonos do Reino Unido"
                        : "UK Lusophone-Speaking Students Cultural Month"}
                    </h4>
                  </div>
                  <div className="grid grid-cols-3 gap-2 text-center mb-4">
                    <div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-purple-50 rounded-xl p-6 border border-green-100">
                  <div className="text-center mb-4">
                    ...
                    <h4 className="font-bold text-gray-900">
                      {language === "pt"
                        ? "Circuito de Celebrações Culturais"
                        : "Cultural Celebration Circuit"}
                    </h4>
                  </div>
                  <div className="grid grid-cols-3 gap-2 text-center mb-4">
                    <div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 mb-16">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
                  {language === "pt"
                    ? "Tipos de Eventos em Colaboração"
                    : "Joint Event Categories"}
                </h3>
                <p className="text-gray-600 max-w-2xl mx-auto">
                  {language === "pt"
                ...
                {[
                  {
                    ...
                    title:
                      language === "pt"
                        ? "Eventos de Herança Cultural"
                        : "Cultural Heritage Events",
                    description:
                      language === "pt"
                        ? "Festivais de língua portuguesa, celebrações de herança cultural"
                        : "Portuguese language festivals, cultural heritage celebrations",
                  },
                  {
                    icon: "🎵",
                    title:
                      language === "pt" ? "Música e Artes" : "Music & Arts",
                    description:
                      language === "pt"
                        ? "Música tradicional e contemporânea lusófona, workshops de dança"
                        : "Traditional and contemporary Portuguese-speaking music events, dance workshops",
                  },
                  {
                    icon: "🏢",
                    title:
                    ...
                    description:
                      language === "pt"
                        ? "Networking de carreira, conexões empresariais lusófonas"
                        : "Career networking, Portuguese-speaking business connections",
                  },
                  {
                    icon: "🎓",
                    title:
                    ...
                    description:
                      language === "pt"
                        ? "Conferências de língua portuguesa, apresentações de pesquisa cultural"
                        : "Portuguese language conferences, cultural research presentations",
                  },
                  {
                    icon: "🚌",
                    title:
                    ...
                    description:
                      language === "pt"
                        ? "Tours de herança, experiências de imersão cultural"
                        : "Heritage tours, cultural immersion experiences",
                  },
                  {
                    icon: "🍽️",
                    title:
                    ...
                    description:
                      language === "pt"
                        ? "Festivais de culinária lusófona, celebrações tradicionais"
                        : "Portuguese-speaking cuisine festivals, traditional celebrations",
                  },
                ].map((category, index) => (
                  <div
                    key={index}
            ...
            <div className="text-center">
              <div className="bg-gradient-to-r from-primary-500 to-accent-500 rounded-2xl p-8 text-white">
                <h3 className="text-2xl md:text-3xl font-bold mb-4">
                  {language === "pt"
                    ? "Conecte Sua Sociedade Lusófona"
                    : "Connect Your Lusophone-Speaking Society"}
                </h3>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button className="bg-white text-primary-600 hover:bg-gray-50 font-bold py-3 px-8 rounded-lg transition-colors">
                    {language === "pt"
                      ? "Conectar Sociedade - A partir de £75/ano"
                      : "Connect Your Society - Starting £75/year"}
                  </button>
          ...
          <div className="container-width">
            <div className="text-center mb-16">
              <div className="inline-flex items-center bg-gradient-to-r from-green-100 to-blue-100 px-6 py-3 rounded-full mb-6">
                ...
                <span className="font-bold text-green-700">
                  {language === "pt"
                    ? "🌍 Eventos Exclusivos • 10 Culturas Lusófonas"
                    : "🌍 Exclusive Events • 10 Lusophone Cultures"}
                </span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                {language === "pt"
                  ? "Programação Cultural Exclusiva para Estudantes"
                  : "Exclusive Cultural Programming for Students"}
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
                {language === "pt"
              ...
              {[
                {
                  title:
                    language === "pt"
                      ? "Feira de Carreiras Lusófona"
                      : "Lusophone Career Fair",
                  subtitle:
                    language === "pt"
                      ? "10 Países • 50+ Empresas"
                      : "10 Countries • 50+ Companies",
                  icon: "🌍",
                  date: "25 Oct",
                  price: "FREE",
                  description:
                  ...
                  highlights: [
                    ...
                    language === "pt"
                      ? "CV em português/inglês"
                      : "Lusophone/English CV reviews",
                    language === "pt"
                ...
                },
                {
                  title:
                    language === "pt"
                      ? "Intercâmbio Linguístico Intensivo"
                  ...
                  highlights: [
                    language === "pt"
                      ? "Falantes de 8 países"
                      : "Speakers from 8 countries",
                    language === "pt"
                      ? "Grupos por nível"
                      : "Level-based groups",
                    language === "pt"
                ...
                },
                {
                  title:
                    language === "pt"
                      ? "Noite Cultural Lusófona"
                      : "Lusophone Cultural Night",
                  subtitle:
                    language === "pt"
            ...
            <div className="text-center">
              ...
              >
                ...
                {language === "pt"
                  ? "Ver Todos os Eventos Exclusivos"
                  : "See All Exclusive Events"}
          ...
          <div className="container-width">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                  {language === "pt"
                    ? "Como Verificar o Seu Status de Estudante"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="space-y-2">
                      {[
                        language === "pt"
                          ? "Cartão de estudante universitário válido"
                          : "Valid university student ID card",
                        language === "pt"
                          ? "Carta oficial de confirmação de matrícula"
                          : "Official enrollment confirmation letter",
                        language === "pt"
                          ? "Comprovante de pagamento de propinas"
                          : "Tuition payment receipt",
                        language === "pt"
                          ? "Declaração da universidade (em papel timbrado)"
                          : "University statement (on letterhead)",
                      ].map((doc, index) => (
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {[
                        language === "pt"
                          ? "Email universitário ativo (.ac.uk)"
                          : "Active university email (.ac.uk)",
                        language === "pt"
                          ? "Formato de arquivo: PDF, JPG ou PNG"
              ...
              {[
                {
                  ...
                  year: "3º ano",
                  quote:
                    "A LusoTown mudou completamente a minha experiência universitária. Encontrei amigos de todos os países lusófonos, oportunidades de estágio e até um mentor brasileiro na minha área.",
                  quoteEn:
                    "LusoTown completely changed my university experience. I found friends from all Portuguese-speaking countries, internship opportunities, and even a Brazilian mentor in my field.",
                  benefits: [
                    "Estágio em empresa brasileira",
                    "Rede lusófona profissional",
                    "Eventos multiculturais gratuitos",
                  ],
                },
                {
                  ...
                  year: "2º ano",
                  quote:
                    "Como brasileiro estudando engenharia, encontrei uma comunidade incrível que celebra nossa diversidade. Os eventos de Samba e networking tech abriram muitas portas.",
                  quoteEn:
                    "As a Brazilian engineering student, I found an incredible community that celebrates our diversity. The Samba events and tech networking opened many doors.",
                  benefits: [
                    "Networking tech lusófono",
                    "Eventos de Samba/Fado",
                    "Mentoria multicultural",
                  ],
                },
                {
                  name: "Ana Fernandes",
                  ...
                  year: "Mestrado",
                  quote:
                    "Como estudante angolana, encontrei aqui não só apoio acadêmico mas também eventos de Kizomba e conexão com a minha cultura. Sinto-me verdadeiramente incluída.",
                  quoteEn:
                    "As an Angolan student, I found not only academic support but also Kizomba events and connection with my culture. I feel truly included.",
                  benefits: [
                    "Eventos de Kizomba",
                    "Apoio acadêmico",
                    "Comunidade angolana ativa",
                  ],
                },
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                ...
                >
                  <span className="flex items-center justify-center">
                    ...
                    {language === "pt"
                      ? "Juntar à Comunidade Agora - £9.99/mês"
                      : "Join Community Now - £9.99/month"}
                ...
                <button
                  onClick={() =>
                    window.open(
                      "https://calendly.com/lusotown-student-demo",
                      "_blank"
                    )
                  }
              ...
              items={[
                ...
                },
                {
                  ...
                  achievements: [
                    ...
                    "NHS Foundation Trust Placement",
                    "Brazilian Society VP",
                  ],
                  testimonial: {
                ...
                },
                {
                  ...
                  year: "Graduate",
                  achievements: [
                    "Africa Business Society Founder",
                ...
                <div className="flex items-center mb-6">
                  ...
                  <div
                    className={`flex-1 h-1 mx-2 ${
                      verificationStep >= 2 ? "bg-primary-500" : "bg-gray-200"
                    }`}
                  ></div>
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
                  ...
                  <div
                    className={`flex-1 h-1 mx-2 ${
                      verificationStep >= 3 ? "bg-primary-500" : "bg-gray-200"
                    }`}
                  ></div>
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                      ...
                      <ul className="text-sm text-green-700 space-y-1">
                        ...
                        <li>
                          •{" "}
                          {language === "pt"
                            ? "Complete o seu perfil LusoTown"
                            : "Complete your LusoTown profile"}
                        </li>
                        <li>
                          •{" "}
                          {language === "pt"
                            ? "Explore eventos exclusivos para estudantes"
                            : "Explore student-exclusive events"}
                        </li>
                        <li>
                          •{" "}
                          {language === "pt"
                            ? "Conecte-se com outros estudantes portugueses"
                            : "Connect with other Lusophone students"}
                        </li>
                      </ul>
                    </div>
                    <button
