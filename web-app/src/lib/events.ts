...
export class EventService {
  ...
  private loadDummyData() {
    ...
    const businessEvents = businessEventsLondon.map(businessEvent => ({
      ...
      maxWaitingList: businessEvent.maxWaitingList || 50,
    ...
    const regularEvents = [
      {
        id: 'event-pt-1',
        title: 'Noite de Fado & Vinho Verde - Authentic Lusophone Night',
        ...
        hostBio: 'Lusophone cultural event organizer and Fado enthusiast, organizing authentic Lusophone experiences in London for 8+ years',
      ...
      {
        id: 'event-pt-2',
        title: 'Lusophone Football Viewing: Portugal vs Spain - Euro Qualifiers',
        description: 'Watch the big match with fellow Lusophone supporters at our favorite sports bar in Vauxhall. Bifanas and Super Bock included!',
        longDescription: 'Força Portugal! Join your fellow Portuguese-speaking community in London for what promises to be an epic match between Portugal and Spain in the Euro 2024 qualifiers. We\'ve booked the upstairs area at The Fentiman Arms, a fantastic pub just minutes from Vauxhall station.\n\nWe\'ll have Lusophone commentators on the main screen, traditional bifanas (Lusophone pork sandwiches) available throughout the match, and plenty of Super Bock and Sagres to keep spirits high. Expect lots of singing, cheering, and probably some tears depending on the result!\n\nThis is a great chance to meet other Lusophone supporters living in London. Whether you\'re originally from Portugal, Brazil, or anywhere else where Lusophone football passion runs deep, come join us. Wear your Portugal jersey with pride!\n\nEntry includes your first drink and access to our Lusophone buffet during half-time.',
        date: '2025-08-19',
        time: '19:45',
        endTime: '22:30',
        ...
        hostBio: 'Die-hard Portugal fan and football enthusiast organizing match viewing events for the Portuguese-speaking community',
        membershipRequired: 'free',
      ...
      },
      {
        ...
        hostBio: 'Lusophone psychologist and women\'s empowerment advocate, organizing supportive events for Portuguese-speaking women in London',
      ...
      {
        id: 'event-pt-4',
        title: 'Lusophone Language Exchange & Cocktails - All Ages Welcome',
        description: 'Practice your Lusophone while enjoying creative cocktails inspired by Portuguese-speaking countries at trendy Nine Elms bar',
        longDescription: 'Venha praticar português! Join us for a relaxed evening of language exchange where Portuguese speakers and learners come together in a fun, social environment. Whether you\'re a native speaker looking to help others learn, or someone wanting to improve your Lusophone, this event welcomes all levels.\n\nWe\'ve partnered with Battersea Power Station\'s Bar Elixir to create a special menu of cocktails inspired by Portuguese-speaking countries: the Caipirinha Tropical (Brazil), Porto Tónico (Portugal), Tamarindo Sunset (Angola), and Mozambique Spice. Each drink comes with a story about its cultural inspiration.\n\nThe evening is structured with conversation rounds where you\'ll rotate between Lusophone and English, mixed with free socializing time. We provide conversation starter cards covering topics from travel and food to career and culture. Perfect for making new friends while improving language skills!\n\nThis is one of our most popular monthly events, attracting both Portuguese speakers and Anglophone Londoners interested in Portuguese culture.',
        date: '2025-08-20',
        time: '18:00',
        endTime: '21:00',
        ...
        tags: ['language exchange', 'cocktails', 'Nine Elms', 'Lusophone learning', 'multicultural', 'networking'],
        hostId: 'host-joana',
        ...
        waitlist: [],
        reviews: [
          { id: 'rev-pt-3', eventId: 'event-pt-4', userId: 'user-pt-8', reviewerName: 'David K.', rating: 4, comment: 'Great way to practice Lusophone! The locals were so patient and welcoming. Definitely coming back.', createdAt: '2025-08-06T22:15:00Z', helpful: 4, membershipTier: 'free' }
        ],
        averageRating: 4.6,
        totalReviews: 23,
        whatToBring: ['Patience and enthusiasm for language learning', 'Stories to share in Lusophone or English'],
        dresscode: 'Casual',
        ageRestriction: 'All ages welcome',
        skillLevel: 'all',
      ...
      {
        id: 'event-pt-5',
        title: 'Festa de São João Londrina - Lusophone Mid-Summer Festival 35+',
        description: 'Celebrate São João with traditional Lusophone festivities, grilled sardines, folk dancing, and live music in a mature, sophisticated setting',
        longDescription: 'Celebremos São João como deve ser! Join us for an authentic Lusophone São João celebration designed specifically for our 35+ community. This traditional mid-summer festival brings all the joy of Lusophone village festivities to London, with a sophisticated twist perfect for mature attendees.\n\nOur celebration takes place at the Lusophone Club of London\'s beautiful banquet hall, decorated with colorful bunting and traditional São João elements. The evening features a traditional Lusophone barbecue with grilled sardines, chorizo, and vegetarian options, accompanied by Lusophone corn bread and plenty of wine.\n\nWe\'ll have live traditional Lusophone folk music with opportunities for folk dancing (lessons provided for beginners!), traditional São João games, and the famous plastic hammer tradition for good luck. The night culminates with the lighting of a traditional bonfire in the club\'s courtyard.\n\nThis is a wonderful opportunity for Portuguese speakers 35+ to celebrate our traditions in an elegant, mature environment while making lasting friendships with fellow immigrants who share our cultural heritage.',
        date: '2025-08-23',
        time: '18:00',
        endTime: '23:00',
        location: 'Lusophone Club of London',
        ...
        hostBio: 'Lusophone cultural preservationist and event organizer with 15+ years experience bringing authentic Portuguese traditions to London',
        membershipRequired: 'core',
        price: 55,
        currency: 'GBP',
        maxAttendees: 80,
      ...
      },
      {
        ...
        longDescription: 'Networking para profissionais de língua portuguesa! Start your day right with fellow Portuguese-speaking professionals at our monthly business networking breakfast in the heart of Little Portugal. This event is designed for entrepreneurs, freelancers, and corporate professionals who want to build meaningful business connections within London\'s vibrant Portuguese-speaking community.\n\nWe meet at O Cantinho de Portugal, one of Stockwell\'s most beloved Portuguese restaurants, for an authentic Lusophone breakfast featuring fresh pastéis de nata, galão coffee, and traditional breakfast options. The intimate setting encourages genuine conversations and relationship building.\n\nEach month features a different networking focus: this month we\'re highlighting "Digital Innovation in Lusophone Markets" with guest speaker Dr. Sofia Carvalho, a Lusophone tech entrepreneur who successfully expanded her fintech startup from Lisbon to London.\n\nAttendees include Lusophone, Brazilian, Angolan, and other Portuguese-speaking professionals across various industries - from finance and tech to creative industries and consulting. Come ready to share your expertise, learn from others, and potentially find your next business partner or client.\n\nAll conversations welcome in Lusophone, English, or both!',
        date: '2025-08-21',
        time: '08:00',
        endTime: '10:00',
        ...
        tags: ['business networking', 'Lusophone professionals', 'Stockwell', 'entrepreneurship', 'breakfast', 'Portuguese-speaking'],
        hostId: 'host-patricia',
        hostName: 'Patrícia Gomes',
        hostImage: getImageWithFallback('patricia-gomes'),
        hostBio: 'Business consultant and Lusophone Chamber of Commerce member, connecting Portuguese-speaking professionals across London',
        membershipRequired: 'core',
        price: 25,
        currency: 'GBP',
        maxAttendees: 25,
      ...
      {
        id: 'event-pt-7',
        title: 'Lusophone Entrepreneurs Workshop: Digital Marketing & Website Creation',
        description: 'Learn essential business skills for Lusophone entrepreneurs in London - from digital marketing to creating professional websites',
        longDescription: 'Empreendedores portugueses em Londres! Join our comprehensive business workshop designed specifically for Portuguese-speaking entrepreneurs who want to grow their businesses in the United Kingdom market.\n\nThis intensive 4-hour workshop covers three essential areas:\n\n**Digital Marketing Mastery**: Learn how to reach Lusophone customers in London through social media, Google Ads, and local SEO. Understand the United Kingdom market and how to position your Portuguese business for success.\n\n**Website Creation**: Build a professional bilingual website that appeals to both Lusophone and English-speaking customers. Learn about hosting, domain names, and basic web design principles.\n\n**Business Setup in the United Kingdom**: Navigate the legal requirements for Lusophone entrepreneurs, understand tax obligations, and learn about business banking and insurance.\n\nOur expert speaker, Sofia Carvalho, is a successful Lusophone tech entrepreneur who built her fintech startup from Lisbon to London. She\'ll share practical insights and real-world examples.\n\nWorkshop includes: Welcome Lusophone coffee & pastéis de nata, comprehensive workbook in Lusophone and English, 1-month follow-up support, and networking lunch with fellow Lusophone entrepreneurs.\n\nPerfect for restaurant owners, consultants, beauty professionals, retail businesses, and any Portuguese speaker looking to start or grow their business in London.',
        date: '2025-08-25',
        time: '09:00',
        endTime: '14:00',
        location: 'Lusophone Chamber of Commerce London',
        address: '40 Holborn Circus, London EC1N 2HB',
        coordinates: { lat: 51.5174, lng: -0.1097 },
        category: 'Business & Entrepreneurship',
        subcategory: 'Professional Development',
        tags: ['business', 'entrepreneurship', 'digital marketing', 'websites', 'Lusophone professionals', 'startup'],
        hostId: 'host-carlos',
        hostName: 'Carlos Eduardo Silva',
        hostImage: getImageWithFallback('carlos-silva'),
        hostBio: 'Business consultant and mentor for Lusophone entrepreneurs, helping Portuguese-speaking businesses succeed in the United Kingdom market for 10+ years',
        membershipRequired: 'free',
        price: 45,
        currency: 'GBP',
        maxAttendees: 30,
      ...
      // WOMEN 30+ LONDON EXPERIENCES - Curated for Portuguese-speaking women
      {
        ...
        title: 'Tower of London & Crown Jewels: Lusophone Women 30+ Private Tour',
        ...
        hostBio: 'Lusophone historian and cultural guide specializing in royal history and women\'s empowerment, organizing enriching experiences for Lusophone women in London',
        membershipRequired: 'core',
        price: 58,
        currency: 'GBP',
        maxAttendees: 15,
        ...
        reviews: [
          { id: 'rev-w30-1', eventId: 'london-women30-tower-1', userId: 'user-w30-3', reviewerName: 'Sofia P.', rating: 5, comment: 'Que experiência maravilhosa! Isabel made the history come alive and connecting with other Lusophone women was the best part. Felt like exploring with sisters who understand our culture.', createdAt: '2025-08-10T16:00:00Z', helpful: 7, membershipTier: 'core', culturalValue: 5, organizationQuality: 5, venueRating: 5, wouldRecommend: true }
        ],
        averageRating: 4.9,
        totalReviews: 8,
      ...
      },
      {
        ...
        title: 'Thames Afternoon Tea Cruise: Lusophone Women 30+ Social Experience',
        ...
        tags: ['women 30+', 'Thames cruise', 'afternoon tea', 'Lusophone networking', 'elegant', 'London landmarks', 'social'],
        hostId: 'host-ana-cruise',
        hostName: 'Ana Filipa Correia',
        hostImage: getImageWithFallback('ana-correia'),
        hostBio: 'Luxury event coordinator and Portuguese-speaking community connector, specializing in elegant experiences that bring Portuguese-speaking women together in London',
        membershipRequired: 'core',
        price: 65,
        currency: 'GBP',
        maxAttendees: 20,
        ...
        reviews: [
          { id: 'rev-cruise-1', eventId: 'london-women30-thames-cruise-1', userId: 'user-cruise-3', reviewerName: 'Patrícia M.', rating: 5, comment: 'Absolutely magical! The tea was beautiful but the connections with other Lusophone women were priceless. Ana created such a welcoming atmosphere.', createdAt: '2025-08-12T18:30:00Z', helpful: 9, membershipTier: 'core', culturalValue: 4, organizationQuality: 5, venueRating: 5, wouldRecommend: true }
        ],
        averageRating: 4.8,
        totalReviews: 6,
      ...
      },
      {
        ...
        title: 'London Eye Sunset Experience: Lusophone Women 30+ Celebration',
        ...
        hostBio: 'Lusophone lifestyle coach and photography enthusiast, creating empowering experiences for Lusophone women to celebrate their successes in London',
        membershipRequired: 'core',
        price: 45,
        currency: 'GBP',
        maxAttendees: 12,
      ...
      },
      {
        ...
        title: 'Borough Market Gourmet Food Tour: Lusophone Women 30+ Culinary Journey',
        ...
        hostBio: 'Professional Lusophone chef and culinary guide, helping Portuguese speakers discover London\'s incredible food scene while maintaining connection to Lusophone flavors',
        membershipRequired: 'core',
        price: 52,
        currency: 'GBP',
        maxAttendees: 14,
        ...
        reviews: [
          { id: 'rev-market-1', eventId: 'london-women30-borough-market-1', userId: 'user-market-3', reviewerName: 'Inês T.', rating: 5, comment: 'Sofia knows everything about food! Found so many ingredients I\'d been looking for and made amazing connections with other Lusophone women who love cooking. Perfect morning!', createdAt: '2025-08-17T14:30:00Z', helpful: 5, membershipTier: 'core', culturalValue: 5, organizationQuality: 5, venueRating: 4, wouldRecommend: true }
        ],
        averageRating: 4.8,
        totalReviews: 7,
      ...
      // SANTOS POPULARES FESTIVALS 2025 - AUTHENTIC PORTUGUESE CULTURAL CELEBRATIONS
      {
        ...
        description: 'Celebrate Santo António (June 13th) with traditional Lusophone street festivities, grilled sardines, arraiais, and the famous Marchas Populares in London\'s Little Portugal.',
        longDescription: 'Viva Santo António! Join us for the most authentic Lusophone street festival in London, bringing the spirit of Lisbon\'s Santos Populares to Stockwell\'s Little Portugal. This is the highlight of the Lusophone cultural calendar, celebrating our patron saint of lovers, marriages, and lost things.\n\nOur festival recreates the authentic Lisbon experience with traditional arraiais (street parties) throughout Little Portugal. We\'ll have multiple street locations with live Pimba music that will make your feet move automatically, grilled sardines sizzling on every corner (the festival is sometimes called \'Festival of Sardines\'), bifanas (Lusophone pork sandwiches), and plenty of Super Bock and Sagres.\n\nThe evening culminates with our own Marchas Populares parade down South Lambeth Road at 21:00, where each Lusophone neighborhood group performs traditional choreographed marches with colorful costumes and banners representing different regions of the Portuguese-speaking world.\n\nTraditional elements include:\n- Manjerico basil plants with love poems for gifting\n- Lusophone folk dancing lessons (from 19:00)\n- Traditional bonfire jumping for good luck\n- Live Fado performances between Pimba sets\n- Lusophone handicrafts and traditional sweets market\n- Kids\' area with traditional Lusophone games\n\nThis is THE event that brings together Lusophone families from Portugal, Brazil, Angola, Mozambique, Cape Verde, and all Portuguese-speaking communities for one night of pure saudade and celebration. Bring your Lusophone spirit and prepare to dance until dawn!',
        date: '2025-06-13',
        time: '18:00',
        endTime: '02:00',
        ...
        hostName: 'Portuguese-speaking community Centre London',
        hostImage: getImageWithFallback('pcc-london'),
        hostBio: 'Official Portuguese-speaking community Centre organizing authentic Lusophone cultural celebrations in London for over 30 years',
        membershipRequired: 'free',
        price: 0,
        currency: 'GBP',
        maxAttendees: 2000,
        ...
        reviews: [
          ...
          { id: 'rev-sa-2', eventId: 'santo-antonio-festival-2025', userId: 'user-sa-11', reviewerName: 'Manuel C.', rating: 5, comment: 'Que saudades! This brought back so many memories of my childhood in Portugal. The sardines were perfect, the music was authentic Pimba, and seeing so many Lusophone families celebrating together was emotional.', createdAt: '2024-06-14T15:30:00Z', helpful: 18, membershipTier: 'free', culturalValue: 5, organizationQuality: 4, venueRating: 4, wouldRecommend: true }
        ],
        averageRating: 4.9,
        totalReviews: 89,
        whatToBring: ['Lusophone spirit and pride', 'Appetite for sardines and bifanas', 'Comfortable dancing shoes', 'Manjerico basil plant if you have one'],
        dresscode: 'Traditional Lusophone colors (optional) or casual festival wear',
      ...
      },
      {
        ...
        description: 'Experience the magic of São João (June 23rd) with traditional Porto festivities: plastic hammers, grilled sardines, folk dancing, and bonfire jumping at the Portuguese-speaking community Centre.',
        longDescription: 'São João como deve ser! Transport yourself to the streets of Porto for one magical night celebrating São João, the festival of Saint John the Baptist. This is Portugal\'s most joyful and playful street festival, and we\'re bringing all the authentic traditions to London.\n\nOur celebration recreates the enchanting atmosphere of Porto\'s Ribeira and Fontainhas neighborhoods during São João night. The Portuguese-speaking community Centre will be transformed with colorful decorations, traditional Portuguese music, and the irresistible aroma of grilled sardines filling the air.\n\nAuthentic São João traditions include:\n- Plastic hammer tradition (martelos de plástico) - we\'ll provide them for friendly bonking!\n- Grilled sardines with Lusophone corn bread and wine\n- Traditional folk dancing with live accordion music\n- Bonfire lighting ceremony at midnight with collective jumping for luck\n- Manjerico basil plants exchange (symbol of love and friendship)\n- Traditional Lusophone games: malha, peão, and others\n- Live Lusophone folk music and traditional singing\n- São João altar with offerings and prayers\n\nThe evening features authentic Lusophone folk groups performing traditional dances from the Minho region, followed by open dancing where everyone is welcome to join. We\'ll teach you the steps to corridinho, vira, and other folk dances that are essential to São João celebrations.\n\nSpecial São João menu includes:\n- Grilled sardines with roasted peppers\n- Caldo verde (Lusophone green soup)\n- Broa de milho (corn bread)\n- Bifanas and chouriço assado\n- Vinho verde and Lusophone beer\n- Traditional sweets: sonhos and filhoses\n\nCome prepared to laugh, dance, and experience the pure joy that defines São João. This celebration brings together Lusophone families and friends for one of the most beloved nights in our cultural calendar.',
        date: '2025-06-23',
        time: '19:00',
        endTime: '01:00',
        location: 'Portuguese-speaking community Centre London',
        ...
        averageRating: 4.8,
        totalReviews: 34,
        whatToBring: ['Plastic hammer (provided if needed)', 'Lusophone party spirit', 'Comfortable shoes for dancing', 'Appetite for sardines'],
      ...
      },
      {
        ...
        description: 'Celebrate Portugal National Day (June 10th) with the Portuguese-speaking community in London\'s traditional celebration venue. Cultural performances, Portuguese food, and family activities.',
        longDescription: 'Dia de Portugal, de Camões e das Comunidades Portuguesas! Join hundreds of Lusophone families for London\'s official Portugal National Day celebration, historically held in Kennington Park in the heart of what\'s known as Little Portugal.\n\nThis is the most important day in the Lusophone calendar, commemorating our national poet Luís de Camões and celebrating Portuguese culture worldwide. Our London celebration brings together Lusophone people from Portugal, Brazil, Angola, Mozambique, Cape Verde, Guinea-Bissau, São Tomé and Príncipe, East Timor, and Macau.\n\nOfficial program includes:\n- Opening ceremony with Lusophone and British officials\n- Raising of Portuguese flags from all Portuguese-speaking countries\n- Traditional Lusophone folk performances by community groups\n- Children\'s Portuguese language activities and games\n- Lusophone handicrafts and cultural exhibitions\n- Traditional Portuguese music throughout the day\n- Football tournament representing different Lusophone regions\n\nAuthentic Portuguese food village featuring:\n- Regional specialties from all Portuguese-speaking countries\n- Traditional Lusophone barbecue (grilled sardines, linguiça, etc.)\n- Pastéis de nata competition between London\'s Lusophone bakeries\n- Brazilian feijoada and caipirinha stand\n- Angolan and Mozambican traditional dishes\n- Cape Verdean cachupa and grogue tasting\n- Portuguese wine and beer garden\n\nSpecial cultural exhibitions:\n- Lusophone immigration history in London display\n- Traditional Lusophone crafts demonstrations\n- Portuguese language school performances\n- Photo exhibition: "Lusophone London Through the Decades"\n- Traditional Lusophone costume display\n\nFamily activities include Portuguese traditional games for children, Portuguese language storytelling corner, face painting with Lusophone symbols, and bouncy castles with Lusophone themes.\n\nThis celebration is free for all and represents the largest gathering of Portuguese-speaking people in London. Come with your Lusophone pride, bring your family, and celebrate our language, culture, and the bonds that unite Lusophone communities worldwide.',
        date: '2025-06-10',
        time: '11:00',
        endTime: '18:00',
        ...
        hostName: 'Lusophone Embassy London & Community Partners',
        hostImage: getImageWithFallback('embassy-portugal'),
        hostBio: 'Official Lusophone Embassy in London organizing the annual Portugal National Day celebration with Portuguese-speaking community organizations',
        membershipRequired: 'free',
        price: 0,
        currency: 'GBP',
        maxAttendees: 5000,
        ...
        waitlist: [],
        reviews: [
          { id: 'rev-pd-1', eventId: 'portugal-day-2025', userId: 'user-pd-10', reviewerName: 'Eduardo M.', rating: 5, comment: 'The most important day for Lusophone people in London! Beautiful celebration with authentic Portuguese culture, great food, and seeing so many Lusophone families together. My children loved learning about their heritage.', createdAt: '2024-06-10T19:00:00Z', helpful: 31, membershipTier: 'free', culturalValue: 5, organizationQuality: 5, venueRating: 5, wouldRecommend: true },
          { id: 'rev-pd-2', eventId: 'portugal-day-2025', userId: 'user-pd-11', reviewerName: 'Isabel C.', rating: 5, comment: 'Perfect organization by the Embassy and community groups. The folk performances were incredible and the food represented all Portuguese-speaking countries beautifully. Proud to be Lusophone!', createdAt: '2024-06-10T20:30:00Z', helpful: 27, membershipTier: 'core', culturalValue: 5, organizationQuality: 5, venueRating: 4, wouldRecommend: true }
        ],
        averageRating: 4.9,
        totalReviews: 156,
        whatToBring: ['Portuguese flags or colors', 'Picnic blanket for park', 'Appetite for Portuguese food', 'Camera for family photos'],
        dresscode: 'Lusophone colors encouraged (green and red), casual park wear',
        ageRestriction: 'Family-friendly, all ages welcome',
        skillLevel: 'all',
      ...
      // AUTHENTIC FADO NIGHTS AT REAL LITTLE PORTUGAL VENUES
      {
        ...
        title: 'Noite de Fado at The Three Lions - Authentic Lusophone Experience',
        description: 'Experience authentic Fado in the heart of Little Portugal at The Three Lions, where even the Lusophone Ambassador dines. Traditional Lusophone dinner, Vinho Verde, and live Fado performances.',
        longDescription: 'Uma noite de Fado autêntica em Little Portugal! Join us at The Three Lions, one of Little Portugal\'s most authentic venues where even the Lusophone Ambassador has dined, for an evening celebrating the soul of Portuguese music and culture.\n\nThe Three Lions has been a cornerstone of the Portuguese-speaking community for decades, known for serving all the Lusophone classics from codfish to Francesinha with world-class quality. Tonight, this beloved community hub transforms into an intimate Fado house, bringing the melancholic beauty and emotional depth of Portugal\'s national music to London.\n\nOur evening features:\n- Welcome reception with authentic Vinho Verde from the Minho region\n- Traditional Lusophone dinner menu including bacalhau à brás, caldo verde, and pastéis de nata\n- Live Fado performance by renowned fadista Helena Vieira, accompanied by Lusophone and classical guitars\n- Interactive segment where guests can learn about Fado history and traditions\n- Portuguese wine pairing with regional selections\n- Cultural storytelling about Fado\'s roots in Lisbon\'s Alfama district\n\nHelena Vieira is a celebrated fadista who has performed in Lisbon\'s most prestigious Fado houses and now brings her artistry to London\'s Portuguese-speaking community. She\'ll perform classic Fados including "Lágrima," "Estranha Forma de Vida," and contemporary pieces that speak to the Lusophone immigrant experience.\n\nThe intimate setting of The Three Lions, with its traditional Lusophone décor and warm atmosphere, creates the perfect backdrop for this authentic cultural experience. This isn\'t just dinner and music - it\'s a journey into the heart of Lusophone identity, perfect for sharing with fellow Portuguese speakers who understand the profound emotion of Fado.\n\nLimited seating ensures an intimate, authentic Fado house experience where every guest can feel the full emotional impact of this UNESCO-recognized musical tradition.',
        date: '2025-09-14',
        time: '19:00',
        endTime: '23:00',
        ...
        hostBio: 'Iconic Portuguese restaurant in Little Portugal, community hub for over 20 years, partnering with authentic Lusophone artists',
        membershipRequired: 'free',
        price: 45,
        currency: 'GBP',
        maxAttendees: 40,
        ...
        photos: [
          ...
          { id: 'photo-fado-2', eventId: 'fado-night-three-lions-2025', url: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=400&h=400&fit=crop&auto=format', caption: 'Traditional Lusophone dinner setting', uploadedBy: 'Guest Photos', uploadedAt: '2025-08-15T19:45:00Z', featured: false }
        ],
        attendees: [
        ...
        reviews: [
          ...
          { id: 'rev-fado-2', eventId: 'fado-night-three-lions-2025', userId: 'user-fado-11', reviewerName: 'João P.', rating: 5, comment: 'Authentic Fado experience in London! Helena is a true fadista and The Three Lions provided the perfect setting. The Portuguese-speaking community came together beautifully. Will definitely return.', createdAt: '2025-08-16T10:15:00Z', helpful: 9, membershipTier: 'premium', culturalValue: 5, organizationQuality: 4, venueRating: 5, wouldRecommend: true }
        ],
        averageRating: 4.9,
        totalReviews: 18,
        ...
        dresscode: 'Smart casual, respectful of Lusophone cultural traditions',
      ...
      },
      {
        ...
        title: 'Noite Cultural at Casa Madeira - Traditional Lusophone Celebration',
        description: 'Under the historic railway arches, Casa Madeira hosts an authentic Lusophone cultural evening with traditional food, live music, and community dancing for all generations.',
        longDescription: 'Uma noite especial na Casa Madeira! Join us under the iconic railway arches at Casa Madeira, one of Little Portugal\'s most beloved community venues, for an evening that brings together all generations of the Portuguese-speaking community in London.\n\nCasa Madeira has been the heart of Lusophone social life in London for decades, hosting celebrations where grandparents, parents, and children come together to eat, dance, and enjoy each other\'s company. This traditional Lusophone cultural evening continues that beautiful tradition.\n\nOur evening program includes:\n- Welcome reception with Lusophone appetizers and wine\n- Traditional Portuguese-speaking community dinner featuring regional specialties\n- Live Portuguese music with accordion, guitar, and traditional singing\n- Open dancing floor for all ages with traditional Lusophone folk dances\n- Cultural presentations about Lusophone regional traditions\n- Children\'s area with Lusophone games and activities\n- Portuguese language storytelling and poetry corner\n- Community photo exhibition: "Lusophone Families in London"\n\nThe menu celebrates Lusophone regional cuisine:\n- Starters: Selection of Lusophone cheeses, olives, and chouriço\n- Main courses: Bacalhau à Gomes de Sá, rojões à minhota, and vegetarian options\n- Traditional sides: Lusophone rice, roasted vegetables, and salads\n- Desserts: Pastéis de nata, pudim flan, and regional sweets\n- Drinks: Portuguese wines, Super Bock, Sagres, and traditional Lusophone coffee\n\nLive entertainment features the Grupo Folclórico Português de Londres, performing traditional dances from different Lusophone regions including Minho, Douro, and Alentejo. Everyone is welcome to join the dancing - we\'ll teach you the steps!\n\nCasa Madeira\'s unique setting under the railway arches creates an atmospheric venue that perfectly captures the community spirit of Lusophone gatherings. This is where Lusophone families come to maintain their cultural connections while building new friendships in London.\n\nAll ages are welcome - this is a true Lusophone family celebration where children play while adults connect, exactly like the community gatherings that happen throughout Portugal.',
        date: '2025-09-28',
        time: '18:00',
        endTime: '23:30',
        ...
        tags: ['Casa Madeira', 'Portuguese-speaking community', 'folk dancing', 'all generations', 'railway arches', 'traditional', 'family'],
        hostId: 'host-casa-madeira',
        hostName: 'Casa Madeira Community Centre',
        hostImage: getImageWithFallback('casa-madeira'),
        hostBio: 'Historic Portuguese-speaking community venue under the railway arches, hosting authentic Lusophone cultural celebrations for all generations',
        membershipRequired: 'free',
        price: 25,
        currency: 'GBP',
        maxAttendees: 150,
        ...
        reviews: [
          { id: 'rev-casa-1', eventId: 'casa-madeira-cultural-evening-2025', userId: 'user-casa-20', reviewerName: 'Teresa M.', rating: 5, comment: 'Exactly what I hoped for! All generations dancing together, authentic Lusophone atmosphere, and my children learned so much about their heritage. Casa Madeira is truly special.', createdAt: '2025-08-31T12:00:00Z', helpful: 8, membershipTier: 'free', culturalValue: 5, organizationQuality: 4, venueRating: 5, wouldRecommend: true }
        ],
        averageRating: 4.7,
        totalReviews: 12,
        whatToBring: ['Lusophone family spirit', 'Comfortable dancing shoes', 'Camera for family photos', 'Children welcome and encouraged'],
        dresscode: 'Casual family-friendly, traditional Lusophone colors welcome',
      ...
      // AUTHENTIC LITTLE PORTUGAL VENUES & REGIONAL CELEBRATIONS
      {
        ...
        description: 'Experience the best Lusophone atmosphere in Little Portugal at Velho Portugal restaurant. Traditional Lusophone dinner with live music, wine tasting, and authentic cultural ambiance.',
        longDescription: 'Bem-vindos ao Velho Portugal! Step into the most authentic Lusophone atmosphere in Little Portugal at Velho Portugal restaurant, where traditional white linen tablecloths, chairs fashioned from port barrels, and a bar with a red tile roof create the perfect setting for an unforgettable Lusophone cultural evening.\n\nVelho Portugal has been serving the Portuguese-speaking community with authentic flavors and genuine hospitality, stocked with Lusophone products and beer on tap. Tonight, we transform this beloved neighborhood restaurant into a celebration of Portuguese culture, food, and community.\n\nAuthentic evening program:\n- Welcome reception with Lusophone appetizers and Vinho Verde\n- Traditional Lusophone dinner featuring regional specialties\n- Live Portuguese music including traditional folk songs and contemporary favorites\n- Portuguese wine tasting with selections from Douro, Alentejo, and Vinho Verde regions\n- Cultural storytelling about Portuguese traditions and Little Portugal history\n- Interactive Portuguese language conversation corner\n- Traditional Lusophone card and board games (sueca, dominó)\n- Lusophone poetry and literature sharing\n\nTraditional Lusophone menu:\n- Appetizers: Azeitona, queijo, chouriço, and Lusophone olives\n- Soups: Caldo verde and sopa de pedra\n- Main courses: Bacalhau à Brás, bitoque, and rojões à portuguesa\n- Sides: Lusophone rice, batatas a murro, and seasonal vegetables\n- Desserts: Pastéis de nata, arroz doce, and pudim flan\n- Drinks: Portuguese wines, Super Bock, Sagres, and authentic Lusophone coffee\n\nThe evening celebrates the authentic Portuguese restaurant experience that has made Velho Portugal a cornerstone of Little Portugal\'s dining scene. With its traditional décor and warm Lusophone hospitality, this venue captures the essence of neighborhood restaurants throughout Portugal.\n\nThis is perfect for Portuguese speakers who want to experience genuine Portuguese culture in London, meet fellow Lusophone immigrants and descendants, and enjoy the comfort of authentic Lusophone flavors in a traditional setting.',
        date: '2025-10-12',
        time: '19:00',
        endTime: '23:30',
        ...
        hostBio: 'Traditional Portuguese restaurant in Little Portugal offering authentic Lusophone atmosphere with traditional décor and genuine Lusophone hospitality',
        membershipRequired: 'free',
        price: 35,
        currency: 'GBP',
        maxAttendees: 35,
        ...
        averageRating: 0,
        totalReviews: 0,
        whatToBring: ['Appetite for authentic Portuguese food', 'Portuguese language skills welcome', 'Traditional Lusophone spirit'],
        dresscode: 'Smart casual, traditional Lusophone colors welcome',
      ...
      },
      {
        ...
        tags: ['Cape Verde', 'morna', 'coladeira', 'cachupa', 'grogue', 'African-Lusophone', 'Cesária Évora', 'traditional music'],
        ...
        hostBio: 'Cape Verdean cultural organization promoting Cape Verdean culture, music, and traditions within London\'s Portuguese-speaking community',
        membershipRequired: 'free',
        price: 30,
        currency: 'GBP',
        maxAttendees: 80,
        ...
        isRecurring: true,
        recurringPattern: { frequency: 'monthly', interval: 3, daysOfWeek: [6] },
        views: 387,
        favorites: 29,
        shares: 18,
        communityGuidelines: true,
      ...
      {
        id: 'event-wine-fado-21plus',
        title: 'Lusophone Wine & Fado Night (21+) - Authentic Experience',
        description: 'Sophisticated evening of Portuguese wine tasting paired with traditional Fado performances. For Portuguese speakers 21+ who appreciate fine wine and authentic culture.',
        longDescription: 'Uma noite sofisticada de vinho e Fado! Join us for an elegant evening celebrating two of Portugal\'s greatest cultural treasures - fine wine and the haunting beauty of Fado music. This exclusive 21+ event brings together Portuguese speakers who appreciate the sophisticated pleasures of life.\n\nOur evening begins with a curated tasting of premium Portuguese wines from the Douro, Alentejo, and Vinho Verde regions, guided by sommelier Pedro Carvalho from Lisbon. You\'ll learn about Lusophone terroir while sampling 6 carefully selected wines paired with traditional Lusophone cheese and charcuterie.\n\nThe highlight of the evening is a live Fado performance by renowned fadista Ana Moura tribute artist, accompanied by Lusophone guitar. The intimate setting allows you to experience the soul-stirring emotion of Fado in a setting reminiscent of Alfama\'s traditional Fado houses.\n\nThis mature, sophisticated event is perfect for Portuguese speakers 21+ who want to connect over shared cultural heritage in an elegant atmosphere. Limited to 30 guests to ensure intimate conversation and an authentic Fado experience.',
        date: '2025-08-22',
        time: '19:30',
        endTime: '22:30',
        location: 'Little Portugal Wine Bar',
        address: '156 South Lambeth Road, Stockwell, London SW8 1UQ',
        coordinates: { lat: 51.4831, lng: -0.1192 },
        category: 'Cultural',
        subcategory: 'Wine & Music',
        tags: ['Fado', 'Portuguese wine', 'cultural', '21+', 'authentic', 'sophisticated'],
        hostId: 'host-ana-moura',
        hostName: 'Ana Moura Events',
        hostImage: getImageWithFallback('ana-moura'),
        hostBio: 'Lusophone cultural event organizer specializing in authentic Fado experiences and wine education',
        membershipRequired: 'free',
        price: 0,
        currency: 'GBP',
        maxAttendees: 30,
        ...
        averageRating: 0,
        totalReviews: 0,
        whatToBring: ['Appreciation for Portuguese culture', 'Valid ID (21+ required)'],
        dresscode: 'Smart casual, sophisticated',
        ageRestriction: '21+ only - ID required',
        skillLevel: 'all',
        accessibility: ['Ground floor access', 'Accessible facilities'],
        allowWaitlist: true,
        maxWaitingList: 50,
        requiresApproval: true,
        refundPolicy: 'Full refund 24h+ in advance',
      ...
      {
        id: 'event-samba-club-21plus',
        title: 'Brazilian Samba Club Night (21+) - Central London',
        description: 'High-energy Brazilian samba club night with live percussion, professional dancers, and caipirinhas. For Portuguese speakers 21+ ready to dance until dawn.',
        longDescription: 'Vamos sambar! Experience the infectious energy of Brazilian samba culture at London\'s hottest Portuguese-speaking club night. This 21+ event brings the carnival spirit of Rio to Central London with authentic Brazilian music, professional samba dancers, and the best caipirinhas in the city.\n\nOur night features live Brazilian percussion ensemble "Bateria Londres" with professional samba dancers who will teach you authentic samba moves throughout the evening. The club has been transformed with Brazilian decorations, carnival colors, and a dedicated samba dance floor.\n\nDrink specials include traditional caipirinhas, caju cocktails, and Brazilian beer. Our Brazilian chef will serve midnight snacks including pão de açúcar, coxinhas, and brigadeiros to fuel your dancing.\n\nThis high-energy event attracts Brazilian expats, Portuguese speakers, and anyone who loves Brazilian culture. Come ready to dance, make friends, and experience the joy and passion of Brazilian nightlife in London. The party goes until 3am with DJs playing the best of Brazilian funk, samba, and Portuguese music.\n\nDress to impress - this is a sophisticated club environment with a Brazilian carnival flair.',
        date: '2025-08-23',
        time: '21:00',
        endTime: '03:00',
        location: 'Club Brasil',
        address: '47 Tottenham Court Road, Fitzrovia, London W1T 1BJ',
        coordinates: { lat: 51.5162, lng: -0.1340 },
        category: 'Nightlife',
        subcategory: 'Club Night',
        tags: ['samba', 'Brazilian', 'club', '21+', 'dancing', 'caipirinha'],
        hostId: 'host-brasil-london',
        hostName: 'Brasil London Events',
        hostImage: getImageWithFallback('brasil-events'),
        hostBio: 'Brazilian event organizers bringing authentic Brazilian nightlife to London',
        membershipRequired: 'free',
        price: 0,
        currency: 'GBP',
        maxAttendees: 150,
        ...
        averageRating: 0,
        totalReviews: 0,
        whatToBring: ['Dancing shoes', 'Energy for samba', 'Valid ID (21+ required)'],
        dresscode: 'Club attire, Brazilian carnival colors welcome',
        ageRestriction: '21+ only - ID required at door',
        skillLevel: 'all',
        accessibility: ['Lift access to club floor', 'Accessible facilities'],
        allowWaitlist: true,
        maxWaitingList: 50,
        requiresApproval: false,
        refundPolicy: 'Free entry - no refunds needed',
        lastBookingTime: '2',
        createdAt: '2025-08-14T12:00:00Z',
        updatedAt: '2025-08-14T12:00:00Z',
        createdBy: 'host-brasil-london',
        isRecurring: true,
        recurringPattern: { frequency: 'monthly', interval: 1, daysOfWeek: [6] },
        views: 234,
        favorites: 45,
      ...
      {
        id: 'event-kizomba-21plus',
        title: 'Kizomba Dance Evening (21+) - Lusophone Cultural Center',
        description: 'Sensual Kizomba dance lessons and social dancing with live music from Angola and Cape Verde. For Portuguese speakers 21+ who love African-Portuguese music.',
        longDescription: 'Uma noite de Kizomba autêntica! Experience the sensual, romantic dance that originated in Angola and spread throughout the Portuguese-speaking world. This sophisticated 21+ evening combines professional Kizomba lessons with social dancing to live music from Angola, Cape Verde, and Portugal.\n\nOur professional instructors Carlos and Marta from Luanda will teach authentic Kizomba technique, from basic steps to advanced moves. No partner required - we rotate partners throughout the lesson to ensure everyone learns and meets new people.\n\nThe evening features live music by "Semba Lisboa," a band specializing in Angolan semba, Cape Verdean coladeira, and modern Kizomba. Between dance sets, enjoy traditional snacks from Portuguese-speaking African countries including pastéis de bacalhau angolanos and Cape Verdean catchupa.\n\nThis intimate evening attracts Portuguese speakers from Angola, Cape Verde, Portugal, Brazil, and Mozambique, creating a truly multicultural celebration of Lusophone culture. The atmosphere is sophisticated and respectful, perfect for meeting like-minded adults who appreciate African-Portuguese musical heritage.\n\nBeginner-friendly with options for experienced dancers. Come alone or with friends - you\'ll leave with new dance skills and meaningful connections.',
        date: '2025-08-24',
        time: '19:00',
        endTime: '23:00',
        location: 'Lusophone Cultural Centre',
        address: '21 Palace Street, Victoria, London SW1E 5HW',
        coordinates: { lat: 51.4991, lng: -0.1395 },
        category: 'Cultural',
        subcategory: 'Dance',
        tags: ['Kizomba', 'Angola', 'Cape Verde', 'dance', '21+', 'African-Lusophone'],
        hostId: 'host-semba-lisboa',
        hostName: 'Semba Lisboa',
        hostImage: getImageWithFallback('semba-lisboa'),
        hostBio: 'Angolan-Lusophone dance instructors and musicians promoting African-Portuguese culture in London',
        membershipRequired: 'free',
        price: 0,
        currency: 'GBP',
        maxAttendees: 40,
        ...
        averageRating: 0,
        totalReviews: 0,
        whatToBring: ['Comfortable dancing shoes', 'Open mind for learning', 'Valid ID (21+ required)'],
        dresscode: 'Comfortable for dancing, semi-smart',
        ageRestriction: '21+ only - respectful mature atmosphere',
        skillLevel: 'all',
        accessibility: ['Ground floor venue', 'Accessible parking available'],
        allowWaitlist: true,
        maxWaitingList: 50,
        requiresApproval: true,
        refundPolicy: 'Full refund 12h+ in advance',
        lastBookingTime: '12',
        createdAt: '2025-08-14T12:00:00Z',
        updatedAt: '2025-08-14T12:00:00Z',
        createdBy: 'host-semba-lisboa',
        isRecurring: true,
        recurringPattern: { frequency: 'monthly', interval: 1, daysOfWeek: [6] },
        views: 189,
        favorites: 31,
      ...
      {
        id: 'event-food-festival-18plus',
        title: 'Lusophone Food Festival Meetup (18+) - Borough Market',
        description: 'Explore Lusophone flavors and culinary traditions with fellow Portuguese speakers 18+. Sample authentic foods and learn about Lusophone gastronomy.',
        longDescription: 'Venha descobrir sabores lusófonos! Join us for a delicious exploration of Lusophone and Lusophone cuisine at London\'s famous Borough Market. This 18+ friendly event welcomes young adults and food enthusiasts to discover the diverse culinary traditions of Portuguese-speaking countries.\n\nWe\'ll meet at Borough Market and explore stalls featuring Lusophone, Brazilian, Angolan, Cape Verdean, and Mozambican specialties. Our foodie guide, Chef Ricardo from Lisbon, will introduce you to authentic ingredients, traditional cooking methods, and hidden gems you might never find on your own.\n\nTasting highlights include Lusophone cheeses and charcuterie, Brazilian tropical fruits, Cape Verdean catchupa ingredients, Angolan spices, and traditional sweets from across the Lusophone world. You\'ll also learn where to find these ingredients in London and get recipe cards to recreate flavors at home.\n\nThis social, educational event is perfect for young Portuguese speakers who want to connect with their culinary traditions while meeting peers in London. Whether you\'re a seasoned cook or just starting to explore Portuguese cuisine, you\'ll discover new flavors and make friends who share your love of good food.\n\nAfter our market tour, we\'ll gather at a nearby café to share our favorite discoveries over Lusophone coffee and pastéis de nata.',
        date: '2025-08-25',
        time: '11:00',
        endTime: '14:00',
        location: 'Borough Market',
        address: '8 Southwark Street, Borough, London SE1 1TL',
        coordinates: { lat: 51.5054, lng: -0.0911 },
        category: 'Food & Drink',
        subcategory: 'Food Tour',
        tags: ['Portuguese food', 'culinary', 'market', '18+', 'cultural', 'educational'],
        hostId: 'host-chef-ricardo',
        hostName: 'Chef Ricardo Silva',
        hostImage: getImageWithFallback('chef-ricardo'),
        hostBio: 'Lusophone chef and food educator introducing London to authentic Lusophone cuisine',
        membershipRequired: 'free',
        price: 0,
        currency: 'GBP',
        maxAttendees: 25,
        ...
        averageRating: 0,
        totalReviews: 0,
        whatToBring: ['Appetite for adventure', 'Small budget for food purchases', 'Valid ID (18+ required)'],
        dresscode: 'Casual, comfortable walking shoes',
        ageRestriction: '18+ - welcoming to young adults',
        skillLevel: 'all',
        accessibility: ['Market has step-free access', 'Public toilets available'],
        allowWaitlist: true,
        maxWaitingList: 50,
        requiresApproval: false,
        refundPolicy: 'Free event - no refunds needed',
      ...
      {
        id: 'event-salsa-bachata-18plus',
        title: 'Salsa & Bachata Social Dancing (18+) - Brixton',
        description: 'Learn Latin rhythms and dance socially with Lusophone and Latin American music. Beginner-friendly for Portuguese speakers 18+ who love to move.',
        longDescription: 'Vamos dançar! Experience the passion of Latin dancing at our weekly social dance event in vibrant Brixton. This 18+ beginner-friendly evening welcomes Portuguese speakers who want to learn salsa and bachata while connecting with the Latin community in London.\n\nOur evening starts with 45 minutes of beginner-friendly salsa lessons followed by 45 minutes of bachata basics. No partner or experience required - our instructors Miguel (from Brazil) and Carmen (from Dominican Republic) will teach you fundamental steps and help you feel confident on the dance floor.\n\nAfter lessons, we open the floor for social dancing to a mix of salsa, bachata, merengue, and Brazilian music including samba and forró. The atmosphere is welcoming and non-intimidating, perfect for young adults who want to try something new in a supportive environment.\n\nDrinks are available at the bar including mojitos, caipirinhas, and Latin American beers. The venue, Brixton Cultural Centre, is at the heart of London\'s Afro-Caribbean community and offers an authentic Latin dance experience.\n\nThis event attracts Portuguese speakers alongside Brazilians, Colombians, Venezuelans, and dance enthusiasts from across London. Come ready to laugh, learn, and make friends who share your love of Latin culture and music.',
        date: '2025-08-26',
        time: '19:30',
        endTime: '23:00',
        location: 'Brixton Cultural Centre',
        address: '15 Acre Lane, Brixton, London SW2 5UR',
        coordinates: { lat: 51.4613, lng: -0.1177 },
        category: 'Dance & Fitness',
        subcategory: 'Social Dance',
        tags: ['salsa', 'bachata', 'Latin dance', '18+', 'beginner-friendly', 'social'],
        hostId: 'host-latin-vibes',
        hostName: 'Latin Vibes London',
        hostImage: getImageWithFallback('latin-vibes'),
        hostBio: 'Latin dance instructors bringing authentic salsa and bachata to London\'s Portuguese-speaking community',
        membershipRequired: 'free',
        price: 0,
        currency: 'GBP',
        maxAttendees: 60,
        ...
        averageRating: 0,
        totalReviews: 0,
        whatToBring: ['Comfortable dancing shoes', 'Water bottle', 'Positive energy for learning'],
        dresscode: 'Comfortable for dancing, Latin style welcome',
        ageRestriction: '18+ - young adult friendly atmosphere',
        skillLevel: 'beginner',
        accessibility: ['Ground floor venue', 'Accessible toilets'],
        allowWaitlist: true,
        maxWaitingList: 50,
        requiresApproval: false,
        refundPolicy: 'Free event - no refunds needed',
      ...
      {
        id: 'event-karaoke-18plus',
        title: 'Lusophone Language Karaoke Night (18+) - Camden',
        description: 'Sing your heart out in Lusophone, English, and Spanish at Camden\'s friendliest karaoke night. Perfect for Portuguese speakers 18+ who love music and fun.',
        longDescription: 'Venha cantar connosco! Join us for the most fun karaoke night in Camden, specifically designed for Portuguese speakers who want to sing songs from home while meeting new friends in London. This 18+ friendly event welcomes singers of all levels - from bathroom singers to aspiring performers!\n\nOur songbook includes thousands of Lusophone, Brazilian, Angolan, Cape Verdean, and Mozambican songs, plus English and Spanish hits. Whether you want to belt out classic Fado, sing Brazilian samba, or perform modern Lusophone pop, we\'ve got your favorites ready to go.\n\nThe evening starts with group sing-alongs to get everyone warmed up, followed by individual and duo performances. Our MC João creates a supportive, encouraging atmosphere where everyone feels comfortable performing, regardless of singing ability.\n\nSpecial features include:\n- Duet challenges with other Portuguese speakers\n- "Songs from Home" round featuring music from your country\n- Group sing-alongs to Lusophone classics everyone knows\n- Prize for most enthusiastic performer (not best voice!)\n\nDrinks include Lusophone beers (Super Bock, Sagres), Brazilian caipirinhas, and soft drinks. Located in Camden\'s cultural heart, this event attracts fun-loving Portuguese speakers who believe singing together creates instant friendships.\n\nNo judgment, all voice levels welcome - it\'s about having fun and celebrating our musical heritage together!',
        date: '2025-08-27',
        time: '20:00',
        endTime: '23:30',
        location: 'Camden Karaoke Box',
        address: '54 Camden High Street, Camden, London NW1 0LT',
        coordinates: { lat: 51.5416, lng: -0.1434 },
        category: 'Music & Entertainment',
        subcategory: 'Karaoke',
        tags: ['karaoke', 'Portuguese music', 'singing', '18+', 'fun', 'social'],
        hostId: 'host-karaoke-joao',
        hostName: 'João Musical Events',
        hostImage: getImageWithFallback('joao-karaoke'),
        hostBio: 'Lusophone MC and music enthusiast creating the best Lusophone karaoke experiences in London',
        membershipRequired: 'free',
        price: 0,
        currency: 'GBP',
        maxAttendees: 45,
        ...
        averageRating: 0,
        totalReviews: 0,
        whatToBring: ['Your favorite songs in mind', 'Courage to sing', 'Voice for cheering others'],
        dresscode: 'Casual, anything that makes you feel confident',
        ageRestriction: '18+ - young adult friendly, no singing experience required',
        skillLevel: 'all',
        accessibility: ['Step-free access to karaoke rooms', 'Accessible facilities'],
        allowWaitlist: true,
        maxWaitingList: 50,
        requiresApproval: false,
        refundPolicy: 'Free event - no refunds needed',
        ...
        createdAt: '2025-08-14T12:00:00Z',
        updatedAt: '2025-08-14T12:00:00Z',
        createdBy: 'host-karaoke-joao',
        isRecurring: true,
        recurringPattern: { frequency: 'weekly', interval: 2, daysOfWeek: [2] },
        views: 176,
        favorites: 28,
        shares: 18,
        communityGuidelines: true,
      ...
      },
      {
        ...
        photos: [
          ...
          { id: 'photo-vibe-2', eventId: 'vibe-coding-workshop-december-2025', url: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=400&h=400&fit=crop&auto=format', caption: 'Workshop participants building their first websites', uploadedBy: 'TechHub Lusophone', uploadedAt: '2025-11-22T16:45:00Z', featured: false }
        ],
        attendees: [
        ...
        reviews: [
          ...
          { id: 'rev-vibe-2', eventId: 'vibe-coding-workshop-december-2025', userId: 'user-vibe-11', reviewerName: 'Mariana L.', rating: 5, comment: 'Perfect introduction to modern web development! The AI tools are game-changers. Ricardo speaks both Lusophone and English fluently, making complex concepts easy to understand. Left feeling confident about building websites.', createdAt: '2025-11-12T20:45:00Z', helpful: 6, membershipTier: 'premium', culturalValue: 3, organizationQuality: 5, venueRating: 4, wouldRecommend: true }
        ],
        averageRating: 4.8,
        totalReviews: 7,
