...
export const urlMappings = {
  ...
  buildUnsplashUrl('1494790108755-2616b612b1ac'): 'sarah-chen',
  buildUnsplashUrl('1580489944761-15a19d654956'): 'maya-patel',
  buildUnsplashUrl('1531746020798-e6953c6e8e04'): 'jessica-williams',
  buildUnsplashUrl('1438761681033-6461ffad8d80'): 'emma-johnson',
  buildUnsplashUrl('1504703395950-b89145a5425b'): 'priya-sharma',
  buildUnsplashUrl('1487412720507-e7ab37603c6f'): 'lisa-thompson',
} as const