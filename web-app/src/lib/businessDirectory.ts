...
export const MOCK_PORTUGUESE_BUSINESSES: PortugueseBusiness[] = [
  {
    ...
    category: 'restaurant',
    description: 'Authentic Portuguese restaurant serving traditional dishes from all regions of Portugal. Family-owned since 1987.',
    descriptionPortuguese: 'Restaurante português autêntico servindo pratos tradicionais de todas as regiões de Portugal. Propriedade familiar desde 1987.',
    ...
    specialOffers: [
      {
        ...
        description: 'Show your LusoTown membership for 10% off your meal',
        discount: '10% off',
