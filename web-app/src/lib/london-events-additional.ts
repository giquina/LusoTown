...
export const additionalLondonEvents = [
  // WOMEN 40+ SOPHISTICATED EXPERIENCES - Elegant experiences for mature Portuguese women
  {
    ...
    hostBio: 'Portuguese art historian and spiritual guide, creating transformative cultural experiences for accomplished Portuguese women in the U.K.',
  ...
  },
  {
    ...
    hostBio: 'Portuguese theatre enthusiast and cultural coordinator, creating sophisticated cultural experiences for accomplished Portuguese women in the U.K.',
    membershipRequired: 'premium',
    price: 145,
    currency: 'GBP',
    maxAttendees: 14,
  ...
  // COMMUNITY EXPERIENCES - Portuguese speakers exploring London together
  {
    ...
    hostBio: 'Portuguese community leader and film enthusiast, organizing magical community experiences that bring Portuguese speakers together in the U.K.',
    ...
    steps: [
      {
        ...
        examples: "People from Portugal, Brazil, Angola, Mozambique living in the U.K."
      },
      {
