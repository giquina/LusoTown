...
export interface CriticalCSSConfig {
  ...
  includeTouchOptimization: boolean;
...
export class CriticalCSSGenerator {
   ...
   */
  public generateCriticalCSS(): CriticalCSSOutput {
  ...
  private generateBaseCSS(): string {
    return `
/* Critical CSS Reset and Base Styles for Portuguese Community */
*,
*::before,
*::after {
...
::-moz-selection {
   ...
   */
  private generatePortugueseColorSystem(): string {
    return `
/* Portuguese Heritage Color System */
:root {
  /* Primary Portuguese Colors */
  --heritage-red: ${BRAND_COLORS.heritage.red};
...
.santos-populares::before {
  ...
  right: 0;
  bottom: 0;
  background-image: radial-gradient(circle at 20% 50%, rgba(255, 255, 255, 0.2) 1px, transparent 1px),
...
.welcome-banner::after {
   ...
   */
  public getCriticalCSSForSSR(): string {
    const { css } = this.generateCriticalCSS();
    return css;
  }
  /**
   ...
   */
  public analyzeCriticalCoverage(): { used: string[], unused: string[], score: number } {
