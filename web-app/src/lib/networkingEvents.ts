...
export const MOCK_NETWORKING_EVENTS: NetworkingEvent[] = [
  {
    ...
    hostImage:
      buildUnsplashUrl('1556761175-5973dc0f32e7'),
    hostBio:
    ...
    speakerLineup: [
      {
        ...
        bioPortuguese:
          "Empreendedora em série com 15 anos de experiência criando empresas de tecnologia entre Londres e Lisboa.",
  ...
  },
  {
    ...
    images: [
      buildUnsplashUrl('1540575467063-178a50c2df87'),
      buildUnsplashUrl('1505373877841-8d25f7d46678'),
    ],
    photos: [],
    attendees: [],
    waitlist: [],
    ...
    specialInstructions:
      "Bring business cards and company brochures for exhibition table",
    weatherPolicy: "Indoor event, unaffected by weather",
    ...
    speakerLineup: [
      {
        ...
        bioPortuguese:
          "Ex-Comissário Europeu e atual Presidente da Câmara de Lisboa, especialista em inovação e transformação digital.",
      ...
      },
      {
        ...
        bioPortuguese:
          "Especialista líder em fintech conectando inovação financeira brasileira e europeia.",
        expertise: ["fintech", "financial_services", "regulatory"],
        country: "Brazil",
        imageUrl:
          buildUnsplashUrl('1580489944761-15a19d654956'),
  ...
  },
  {
    ...
    hostImage:
      buildUnsplashUrl('1573496359142-b8d87734a5a2'),
    hostBio:
    ...
    images: [
      buildUnsplashUrl('1573496359142-b8d87734a5a2'),
      buildUnsplashUrl('1551836022-deb4988cc6c0'),
    ],
    photos: [],
    attendees: [],
    waitlist: [],
    ...
    speakerLineup: [
      {
        ...
        bioPortuguese:
          "Capitalista de risco líder e empresária, co-fundadora de várias startups bem-sucedidas.",
  ...
  },
  {
    ...
    hostImage:
      buildUnsplashUrl('1522202176988-66273c2fd55f'),
    hostBio:
    ...
    images: [
      buildUnsplashUrl('1522202176988-66273c2fd55f'),
      buildUnsplashUrl('1531482615713-2afd69097998'),
    ],
    photos: [],
    attendees: [],
    waitlist: [],
  ...
  },
  {
    ...
    images: [
      buildUnsplashUrl('1460925895917-afdab827c52f'),
      buildUnsplashUrl('1498050108023-c5249f4df085'),
    ],
    photos: [],
    attendees: [],
    waitlist: [],
    ...
    speakerLineup: [
      {
        ...
        bioPortuguese:
          "Desenvolvedora full-stack e proprietária de agência digital bem-sucedida. Construiu mais de 200 websites para empresas portuguesas em toda a Europa.",
        expertise: [
          "web_development",
          "business_strategy",
          "digital_marketing",
        ...
        country: "Portugal",
        imageUrl:
          buildUnsplashUrl('1494790108755-2616b612b632'),
        presentationTopic:
  ...
  },
  {
    ...
    coordinates: { lat: 51.5252, lng: -0.158 },
    ...
    images: [
      buildUnsplashUrl('1552664730-d307ca884978'),
      buildUnsplashUrl('1432888498266-38ffec3eaf0a'),
    ],
    photos: [],
    attendees: [],
    waitlist: [],
    ...
    speakerLineup: [
      {
        ...
        country: "Portugal",
        imageUrl:
          buildUnsplashUrl('1519345182560-3f2917c472ef'),
        presentationTopic:
  ...
  },
  {
    ...
    images: [
      buildUnsplashUrl('1551288049-bebda4e38f71'),
      buildUnsplashUrl('1555255707-c07966088b7b'),
    ],
    photos: [],
    attendees: [],
    waitlist: [],
    ...
    speakerLineup: [
      {
        ...
        bioPortuguese:
          "Doutoramento em Machine Learning, cientista de dados sénior na DeepMind a trabalhar em IA para aplicações empresariais.",
        expertise: ["machine_learning", "ai_strategy", "business_applications"],
        country: "Portugal",
        imageUrl:
          buildUnsplashUrl('1544005313-94ddf0286df2'),
  ...
  },
  {
    ...
    hostImage:
      buildUnsplashUrl('1556742049-0cfed4f6a45d'),
    hostBio:
    ...
    images: [
      buildUnsplashUrl('1556742049-0cfed4f6a45d'),
      buildUnsplashUrl('1563013544-824ae1b704d3'),
    ],
    photos: [],
    attendees: [],
    waitlist: [],
  ...
  },
  {
    ...
    hostImage:
      buildUnsplashUrl('1611974789855-9c2a0a7236a3'),
    hostBio:
    ...
    images: [
      buildUnsplashUrl('1611974789855-9c2a0a7236a3'),
      buildUnsplashUrl('1559526324-4b87b5e36e44'),
    ],
    photos: [],
    attendees: [],
    waitlist: [],
    ...
    speakerLineup: [
      {
        ...
        bioPortuguese:
          "Liderando inovação blockchain na Revolut. Ex-banqueiro de investimento com profunda expertise em criptomoeda e ativos digitais.",
        expertise: ["blockchain", "cryptocurrency", "digital_banking"],
        country: "Portugal",
        imageUrl:
          buildUnsplashUrl('1560250097-0b93528c311a'),
        presentationTopic:
  ...
  },
  {
    ...
    hostImage:
      buildUnsplashUrl('1451187580459-43490279c0fa'),
    hostBio:
    ...
    images: [
      buildUnsplashUrl('1451187580459-43490279c0fa'),
      buildUnsplashUrl('1558494949-ef010cbdcc31'),
    ],
    photos: [],
    attendees: [],
    waitlist: [],
    ...
    speakerLineup: [
      {
        ...
        bioPortuguese:
          "Construiu e escalou uma plataforma SaaS para mais de 10.000 clientes. Especialista em arquitetura cloud e modelos de negócio de subscrição.",
  ...
  },
  {
    ...
    hostImage:
      buildUnsplashUrl('1563986768494-4dee2763ff3f'),
    hostBio:
    ...
    images: [
      buildUnsplashUrl('1563986768494-4dee2763ff3f'),
      buildUnsplashUrl('1550751827-4bd374c3f58b'),
    ],
    photos: [],
    attendees: [],
    waitlist: [],
  ...
  },
  {
    ...
    coordinates: { lat: 51.5016, lng: -0.096 },
    ...
    hostImage:
      buildUnsplashUrl('1497435334941-8c899ee9e8e9'),
    hostBio:
    ...
    images: [
      buildUnsplashUrl('1497435334941-8c899ee9e8e9'),
      buildUnsplashUrl('1473341304170-971dccb5ac1e'),
    ],
    photos: [],
    attendees: [],
    waitlist: [],
    ...
    speakerLineup: [
      {
        ...
        bioPortuguese:
          "Empresária líder em tecnologia verde desenvolvendo soluções de energia renovável. Defensora de práticas empresariais sustentáveis.",
        expertise: [
          "renewable_energy",
...
export class NetworkingEventsService {
  ...
  async searchNetworkingEvents(
    ...
    if (filters.businessFocus && filters.businessFocus.length > 0) {
      filteredEvents = filteredEvents.filter((event) =>
        event.businessFocus.some((focus) =>
          filters.businessFocus!.includes(focus)
        )
      );
    }
    ...
    if (filters.languageOfEvent && filters.languageOfEvent !== "all") {
      filteredEvents = filteredEvents.filter(
        (event) => event.languageOfEvent === filters.languageOfEvent
      );
    }
    ...
    if (filters.pitchSessions !== undefined) {
      filteredEvents = filteredEvents.filter(
        (event) => event.pitchSessions === filters.pitchSessions
      );
    }

    if (filters.mentorshipMatchmaking !== undefined) {
      filteredEvents = filteredEvents.filter(
        (event) => event.mentorshipMatchmaking === filters.mentorshipMatchmaking
      );
    }

    if (filters.investorPresence !== undefined) {
      filteredEvents = filteredEvents.filter(
        (event) => event.investorPresence === filters.investorPresence
      );
    }
  ...
  private applyNetworkingSorting(
    events: NetworkingEvent[],
    sortBy: NetworkingFilters["sortBy"]
  ) {
    switch (sortBy) {
      case "price":
  ...
  async getNetworkingEventById(
    eventId: string
  ): Promise<NetworkingEvent | null> {
    return this.events.find((e) => e.id === eventId) || null;
  }

  async getUpcomingNetworkingEvents(
    limit: number = 10
  ...
  async getFeaturedNetworkingEvents(
    limit: number = 5
  ): Promise<NetworkingEvent[]> {
    return this.events
      .filter((event) => event.featured)
  ...
  async getNetworkingEventsByType(
    type: NetworkingType,
    limit: number = 10
  ): Promise<NetworkingEvent[]> {
    return this.events
  ...
  async getNetworkingStatistics(): Promise<{
    ...
    const totalConnections = this.events.reduce(
      (sum, event) => sum + event.businessConnectionsMade,
      0
    );
    const totalDeals = this.events.reduce(
      (sum, event) => sum + event.dealsGenerated,
      0
    );
    const averageRating =
      this.events.reduce((sum, event) => sum + event.averageRating, 0) /
      totalEvents;
