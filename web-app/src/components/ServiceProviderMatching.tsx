...
const mockServiceProviders: ServiceProvider[] = [
  {
    ...
    specialties: ['Cultural Tours', 'Lusophone History', 'Hidden Gems'],
    culturalFocus: ['Lusophone Heritage', 'Fado Culture', 'Traditional Cuisine'],
    languages: ['Lusophone', 'English', 'Spanish'],
    verified: true,
    matchCompatibility: 95,
    description: 'Authentic Lusophone cultural tours with deep knowledge of London\'s Portuguese-speaking community.',
  ...
  {
    id: 'sp-3',
    name: 'Lusophone Housing Solutions',
    type: 'housing',
    rating: 4.7,
    reviews: 156,
    ...
    priceRange: '£800-2000',
    availability: 'available',
    specialties: ['Lusophone Areas', 'Short-term Rental', 'Community Housing'],
    culturalFocus: ['Lusophone Neighborhoods', 'Cultural Integration', 'Community Support'],
    languages: ['Lusophone', 'English'],
    verified: true,
  ...
  },
  {
    ...
    culturalFocus: ['Traditional Music', 'Lusophone Culture', 'Authentic Experiences'],
    languages: ['Lusophone', 'English'],
    verified: true,
    matchCompatibility: 94,
    description: 'Authentic Lusophone cultural events and entertainment with traditional Fado performances.',
  ...
  {
    id: 'sp-5',
    name: 'Lusophone Business Consultancy',
    ...
    culturalFocus: ['Lusophone Entrepreneurs', 'United Kingdom Business Law', 'Cross-border Trade'],
    languages: ['Lusophone', 'English'],
    verified: true,
    matchCompatibility: 85,
    description: 'Professional business services for Lusophone entrepreneurs and professionals in the United Kingdom.',
