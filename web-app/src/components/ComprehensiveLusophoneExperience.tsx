  ...
  const heritageOptions: HeritageOption[] = [
    {
      ...
      description: t('heritage.portugal.description', 'Birthplace of global Portuguese culture'),
      region: 'Europe'
    },
    {
      code: 'br',
      ...
      description: t('heritage.brazil.description', 'Largest Portuguese-speaking nation'),
    ...
    },
    {
      ...
      description: t('heritage.cape_verde.description', 'Islands of Morna and culture'),
      region: 'Africa (PALOP)'
    },
    {
      code: 'mz',
      ...
      description: t('heritage.mozambique.description', 'Eastern African Portuguese culture'),
      region: 'Africa (PALOP)'
    },
    {
      code: 'gw',
      ...
      description: t('heritage.guinea_bissau.description', 'West African Portuguese heritage'),
      region: 'Africa (PALOP)'
    },
    {
      code: 'st',
      ...
      flag: '🇸🇹',
      color: 'from-green-500 via-yellow-500 to-red-500',
      description: t('heritage.sao_tome.description', 'Island paradise Portuguese culture'),
      region: 'Africa (PALOP)'
    },
    {
      code: 'tl',
      ...
      description: t('heritage.timor_leste.description', 'Newest Portuguese-speaking nation'),
      region: 'Asia'
    }
  ]
          ...
          >
            ...
            >
              <div className="p-3 space-y-2">
                <div className={`w-12 h-12 mx-auto bg-gradient-to-r ${option.color} rounded-full flex items-center justify-center shadow-lg`}>
                ...
                <div className="text-xs text-primary-600 font-medium">{option.region}</div>
            ...
            <Card className="p-6">
              <div className="text-center space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <div className="font-semibold text-primary-600">Market Size</div>
                    <div className="text-gray-700">{markets[activeMarket].value}</div>
                  </div>
                  <div>
                    <div className="font-semibold text-secondary-600">Population</div>
                    <div className="text-gray-700">{markets[activeMarket].opportunity}</div>
                  </div>
                  <div>
                    <div className="font-semibold text-accent-600">Key Sectors</div>
                    <div className="text-gray-700 text-xs">{markets[activeMarket].key_sectors}</div>
                  </div>
                  <div>
                    <div className="font-semibold text-premium-600">UK Trade</div>
                    <div className="text-gray-700">{markets[activeMarket].uk_trade}</div>
                  </div>
                </div>
              </div>
            </Card>
...
export default function ComprehensiveLusophoneExperience() {
  ...
  const sections = [
    ...
    { id: 'community', label: t('sections.community', 'Community'), icon: '👥' },
    { id: 'business', label: t('sections.business', 'Business'), icon: '💼' },
    { id: 'testimonials', label: t('sections.testimonials', 'Stories'), icon: '💬' }
  ]
        ...
        >
          ...
          <div className="space-y-3">
            <GradientText variant="heritage" size="3xl" className="font-bold">
              {t('lusophone.experience.title', 'The Complete Lusophone Experience')}
            </GradientText>
            
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              {t('lusophone.experience.subtitle', 'Connecting Portuguese-speaking communities across Portugal, Brazil, PALOP nations, and the United Kingdom')}
            </p>
