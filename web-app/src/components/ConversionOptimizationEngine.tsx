  ...
  const opportunities: ConversionOpportunity[] = [
    {
      ...
      value: '£25/year - Save £200+ on transport',
      valuePortuguese: '£25/ano - Poupe £200+ em transporte',
    ...
    },
    {
      ...
      value: 'Only £12.50/year (50% off)',
      valuePortuguese: 'Apenas £12.50/ano (50% desconto)',
    ...
    },
    {
      ...
      description: 'New to the UK? Our housing assistance program connects you with Portuguese community members who can help with finding accommodation, understanding contracts, and local area advice.',
      descriptionPortuguese: 'Novo no Reino Unido? O nosso programa de assistência habitacional conecta-o com membros da comunidade portuguesa que podem ajudar a encontrar acomodação, entender contratos e conselhos da área local.',
