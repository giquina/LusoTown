...
export default function ConversionOptimizationEngine({
  ...
  const opportunities: ConversionOpportunity[] = [
    ...
    },
    {
      ...
      type: 'service_upsell',
      priority: 'medium',
      title: 'Get Portuguese-speaking community Housing Help',
      titlePortuguese: 'Obtenha Ajuda Habitacional da Comunidade de Falantes de Português',
      description: 'New to the United Kingdom? Our housing assistance program connects you with Portuguese speakers who can help with finding accommodation, understanding contracts, and local area advice.',
    ...
    },
    {
      ...
      description: 'The Portuguese-speaking community has grown since you were last here! Come back and discover new events, connections, and services with this special offer.',
      descriptionPortuguese: 'A comunidade de falantes de português cresceu desde a sua última visita! Volte e descubra novos eventos, conexões e serviços com esta oferta especial.',
