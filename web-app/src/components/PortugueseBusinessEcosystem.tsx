          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
              {isPortuguese
                ...
                : 'The largest Portuguese business platform in the United Kingdom. Discover authentic services, connect with professionals, and grow your business within the Portuguese-speaking community.'
              }
            </p>
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
              {isPortuguese
                ...
                : 'Join hundreds of Portuguese businesses growing through our platform. Exclusive access to the largest Portuguese-speaking community in the United Kingdom.'
              }
            </p>
