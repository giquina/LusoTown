  ...
  return (
    ...
    >
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        <div
          className={`absolute top-4 left-4 px-3 py-2 rounded-full bg-gradient-to-r ${getConnectionTypeColor(
            match.compatibilityResult.connectionType
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            <div className="text-center">
              <div className="text-2xl mb-1">
                {getSaudadeIntensityEmoji(
                  match.saudadeProfile.saudadeIntensity
                )}
              </div>
              ...
              <div className="text-red-600 font-bold">
                {match.saudadeProfile.saudadeIntensity}/10
              </div>
            </div>
            <div className="text-center">
        ...
        <div className="bg-primary-50 rounded-lg p-3">
          ...
          <div className="text-sm text-primary-700">
            {match.saudadeProfile.regionalIdentity.region === "porto_norte" &&
              (language === "pt"
                ? "Porto/Norte - Orgulho Nortista"
                : "Porto/North - Northern Pride")}
            {match.saudadeProfile.regionalIdentity.region === "lisboa_area" &&
              (language === "pt"
                ? "Lisboa - Energia da Capital"
                : "Lisbon - Capital Energy")}
            {match.saudadeProfile.regionalIdentity.region === "acores_island" &&
              (language === "pt"
                ? "Açores - Identidade Insular"
                : "Azores - Island Identity")}
      ...
      <div className="p-6 pt-0">
        ...
        <div className="mt-4 p-3 bg-gradient-to-r from-red-50 to-pink-50 rounded-lg border border-red-100">
          <div className="text-xs font-medium text-red-800 mb-1">
            {language === "pt"
              ? "Iniciador de Conversa Cultural:"
