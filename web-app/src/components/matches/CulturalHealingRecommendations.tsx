...
const culturalActivities: CulturalActivity[] = [
  {
    ...
    descriptionEn:
      "Join intimate fado sessions designed for emotional release and saudade healing through authentic Portuguese music",
    descriptionPt:
      "Participe em sessões íntimas de fado desenhadas para libertação emocional e cura da saudade através de música portuguesa autêntica",
    type: "community",
    category: "music",
    saudadeLevel: "high",
    ...
    duration: "2 hours",
    location: "Lusophone Cultural Centre, Stockwell",
  ...
  },
  {
    ...
    descriptionEn:
      "Learn and share traditional family recipes while connecting with others who understand the emotional power of Lusophone comfort food",
    descriptionPt:
      "Aprenda e partilhe receitas tradicionais familiares enquanto se conecta com outros que compreendem o poder emocional da comida portuguesa",
    type: "community",
    category: "food",
    saudadeLevel: "medium",
    ...
    duration: "3 hours",
    location: "Borough Market Lusophone Kitchen",
  ...
  },
  {
    ...
    descriptionEn:
      "Safe space for Portuguese speakers to share their saudade experiences and find emotional support from those who truly understand",
    descriptionPt:
      "Espaço seguro para falantes de português partilharem as suas experiências de saudade e encontrarem apoio emocional de quem realmente compreende",
    type: "community",
    category: "spiritual",
    saudadeLevel: "high",
  ...
  },
  {
    ...
    descriptionEn:
      "Immersive virtual reality experience of Lusophone landscapes, villages, and familiar places to ease homesickness",
    descriptionPt:
      "Experiência imersiva de realidade virtual de paisagens portuguesas, aldeias e lugares familiares para aliviar as saudades de casa",
    type: "solo",
    category: "nature",
    saudadeLevel: "high",
  ...
  },
  {
    ...
    titleEn: "Lusophone Poetry & Literature Evening",
    titlePt: "Noite de Poesia e Literatura Portuguesa",
    descriptionEn:
      "Evening of Lusophone poetry reading, discussion, and emotional expression through the beauty of Portuguese language",
    descriptionPt:
      "Noite de leitura de poesia portuguesa, discussão e expressão emocional através da beleza da língua portuguesa",
    type: "community",
  ...
  },
  {
    ...
    descriptionEn:
      "Collaborate in organizing Santos Populares celebrations in London, recreating the joy and community spirit of Lusophone festivities",
    descriptionPt:
      "Colabore na organização das celebrações dos Santos Populares em Londres, recriando a alegria e espírito comunitário das festividades portuguesas",
    type: "community",
    category: "social",
    saudadeLevel: "medium",
  ...
  },
  {
    ...
    descriptionEn:
      "Structured video calls with family back home, with tips for meaningful conversations that help maintain emotional bonds",
    descriptionPt:
      "Chamadas de vídeo estruturadas com família em casa, com dicas para conversas significativas que ajudam a manter laços emocionais",
    type: "family",
    category: "social",
    saudadeLevel: "high",
  ...
  },
  {
    ...
    descriptionEn:
      "Connect with or become a cultural mentor to help preserve Portuguese heritage and support those struggling with cultural identity",
    descriptionPt:
      "Conecte-se ou torne-se mentor cultural para ajudar a preservar a herança portuguesa e apoiar quem luta com identidade cultural",
    type: "community",
    category: "educational",
    saudadeLevel: "any",
  ...
  },
  {
    ...
    titleEn: "Lusophone-Style Nature Walk & Reflection",
    titlePt: "Caminhada na Natureza e Reflexão ao Estilo Português",
    descriptionEn:
      "Guided walks in London parks designed to evoke Lusophone countryside memories, with group reflection and mindfulness",
    descriptionPt:
      "Caminhadas guiadas em parques de Londres desenhadas para evocar memórias do campo português, com reflexão em grupo e atenção plena",
    type: "community",
    category: "nature",
    saudadeLevel: "medium",
  ...
  },
  {
    ...
    descriptionEn:
      "Specialized therapy for Lusophone couples to understand and support each other's saudade experiences and cultural needs",
    descriptionPt:
      "Terapia especializada para casais portugueses compreenderem e apoiarem as experiências de saudade e necessidades culturais um do outro",
    type: "couple",
    category: "spiritual",
    saudadeLevel: "high",
    ...
    duration: "90 minutes",
    location: "Lusophone Counseling Services",
...
export default function CulturalHealingRecommendations({
  ...
  useEffect(() => {
    const generateRecommendations = () => {
      ...
      const scoredActivities = culturalActivities.map((activity) => {
        ...
        else if (activity.saudadeLevel === "high" && currentSaudadeLevel >= 7)
          score += 10;
        else if (
          activity.saudadeLevel === "medium" &&
          currentSaudadeLevel >= 4 &&
          currentSaudadeLevel <= 7
        )
          score += 10;
        else if (activity.saudadeLevel === "low" && currentSaudadeLevel <= 4)
          score += 10;

        // Trigger alignment
        const triggerMatches = activity.triggers.filter((trigger) =>
          userTriggers.includes(trigger)
        );
        score += triggerMatches.length * 3;

        // Coping mechanism alignment
        const copingMatches = activity.copingMechanisms.filter((coping) =>
          userCoping.includes(coping)
        );
        score += copingMatches.length * 4;

        // Cultural depth alignment
        if (
          userProfile.overallCulturalDepth >= 8 &&
          activity.culturalConnection >= 8
        )
          score += 5;
        ...
        if (
          userSaudade.culturalSupport === "high" &&
          activity.type === "community"
        )
          score += 6;
        if (
          userSaudade.culturalSupport === "independent" &&
          activity.type === "solo"
        )
          score += 6;
        ...
        // Suggest timing
        const suggestedTiming = generateSuggestedTiming(
          activity,
          userSaudade,
          language
        );
        ...
        return {
          ...
          personalizedMessage,
          suggestedTiming,
          potentialPartners: matchProfile
            ? [matchProfile.saudadeProfile.emotionalCompatibilityType]
            : undefined,
        };
      });
  ...
  const generatePersonalizedMessage = (
    ...
    const messages = {
      en: {
        high_saudade_fado:
          "Your deep saudade suggests this fado therapy could provide the emotional release you're seeking.",
        cooking_comfort:
          "Since you find comfort in Lusophone cooking, this workshop could deepen your culinary healing practice.",
        community_support:
          "Your need for cultural community makes this group activity particularly beneficial for you.",
        heritage_preservation:
          "Your strong heritage values align perfectly with this cultural preservation activity.",
        family_connection:
          "This activity directly addresses your family connection needs and homesickness patterns.",
        solo_healing:
          "This individual activity respects your independent approach to cultural healing.",
        couple_bonding:
          "Perfect for strengthening your cultural bond and mutual saudade understanding.",
      },
      pt: {
        high_saudade_fado:
          "A sua saudade profunda sugere que esta terapia de fado pode proporcionar a libertação emocional que procura.",
        cooking_comfort:
          "Como encontra conforto na culinária portuguesa, este workshop pode aprofundar a sua prática culinária de cura.",
        community_support:
          "A sua necessidade de comunidade cultural torna esta atividade em grupo particularmente benéfica.",
        heritage_preservation:
          "Os seus valores fortes de herança alinham-se perfeitamente com esta atividade de preservação cultural.",
        family_connection:
          "Esta atividade aborda diretamente as suas necessidades de conexão familiar e padrões de saudades de casa.",
        solo_healing:
          "Esta atividade individual respeita a sua abordagem independente à cura cultural.",
        couple_bonding:
          "Perfeito para fortalecer a sua ligação cultural e compreensão mútua da saudade.",
      },
    };
    ...
    if (
      activity.id.includes("recipe") &&
      saudadeProfile.copingMechanisms.includes("cook_portuguese")
    ) {
      return messages[lang].cooking_comfort;
    }
    if (
      activity.type === "community" &&
      saudadeProfile.culturalSupport === "high"
    ) {
      return messages[lang].community_support;
    }
    if (
      activity.culturalConnection >= 8 &&
      saudadeProfile.heritagePreservation >= 8
    ) {
  ...
  const categories = [
    {
      ...
      labelPt: "Todas as Atividades",
      icon: SparklesIcon,
    },
    {
      id: "music",
      labelEn: "Music & Fado",
      labelPt: "Música e Fado",
      icon: MusicalNoteIcon,
    },
    {
      id: "food",
      labelEn: "Food & Cooking",
      labelPt: "Comida e Culinária",
      icon: CakeIcon,
    },
    {
      id: "social",
      labelEn: "Community & Social",
      labelPt: "Comunidade e Social",
      icon: UserGroupIcon,
    },
    {
      id: "spiritual",
      labelEn: "Emotional Support",
      labelPt: "Apoio Emocional",
      icon: HandHeartIcon,
    },
    {
      id: "educational",
      labelEn: "Learning & Culture",
      labelPt: "Aprendizagem e Cultura",
      icon: BookOpenIcon,
    },
    {
      id: "nature",
      labelEn: "Nature & Reflection",
      labelPt: "Natureza e Reflexão",
      icon: MapPinIcon,
    },
  ];
  ...
  const filteredRecommendations =
    selectedCategory === "all"
      ...
      : recommendations.filter(
          (rec) => rec.activity.category === selectedCategory
        );
      ...
      <div className="text-center">
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <h2 className="text-2xl font-bold text-primary-900">
            {language === "pt"
              ? "Recomendações de Cura Cultural"
              : "Cultural Healing Recommendations"}
          </h2>
        </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-start gap-4 mb-4">
                <div
                  className={`p-3 rounded-xl bg-gradient-to-r ${activity.color}`}
                >
