...
const culturalActivities: CulturalActivity[] = [
  ...
  },
  {
    ...
    descriptionEn: 'Learn and share traditional family recipes while connecting with others who understand the emotional power of Lusophone comfort food',
  ...
  },
  {
    ...
    descriptionEn: 'Immersive virtual reality experience of Lusophone landscapes, villages, and familiar places to ease homesickness',
  ...
  },
  {
    ...
    descriptionEn: 'Evening of Lusophone poetry reading, discussion, and emotional expression through the beauty of Portuguese language',
  ...
  },
  {
    ...
    descriptionEn: 'Collaborate in organizing Santos Populares celebrations in London, recreating the joy and community spirit of Lusophone festivities',
  ...
  },
  {
    ...
    descriptionEn: 'Guided walks in London parks designed to evoke Lusophone countryside memories, with group reflection and mindfulness',
  ...
  },
  {
    ...
    descriptionEn: 'Specialized therapy for Lusophone couples to understand and support each other\'s saudade experiences and cultural needs',
  ...
  const generatePersonalizedMessage = (
    ...
    const messages = {
      en: {
        ...
        cooking_comfort: "Since you find comfort in Lusophone cooking, this workshop could deepen your culinary healing practice.",
