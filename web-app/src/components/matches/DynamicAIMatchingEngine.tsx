...
const AIEnhancedMatchingEngine = lazy(() =>
  import("@/components/matches/AIEnhancedMatchingEngine")
    .then((module) => ({
        ...
        default: () => (
          <div className="p-6 text-center">
            ...
            <p className="text-red-700">
              The Portuguese cultural compatibility system is currently
              unavailable.
            </p>
          </div>
        ),
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    className="h-2 bg-gradient-to-r from-pink-300 to-purple-300 rounded-full animate-pulse"
                    style={{ width: `${60 + i * 10}%` }}
                  ></div>
                </div>
              </div>
    ...
    <div className={`relative ${className}`}>
        ...
        {metrics && (
          <>
            ...
            >
              ...
              {metrics.culturalAccuracy.toFixed(0)}%
            </div>
          </>
        )}
      </div>
      ...
      <Suspense fallback={<AIMatchingLoader />}>
        <ErrorBoundary
          ...
          fallback={
            <AIMatchingError
              error={new Error("Matching component crashed")}
              retry={handleRetry}
            />
          }
        >
          <AIEnhancedMatchingEngine maxMatches={maxMatches} filters={filters} />
        </ErrorBoundary>
      </Suspense>
        ...
        <div className="mt-4 p-3 bg-gradient-to-r from-primary-50 to-secondary-50 rounded-lg border border-primary-200">
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex items-center gap-2 text-primary-700">
              ...
              <span>
                {metrics.culturalAccuracy.toFixed(1)}%{" "}
