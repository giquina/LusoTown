...
export default function EventEnhancedMatchCard({
  ...
  const getMembershipBadge = (type: string) => {
    switch (type) {
      ...
      case "Community":
        return { icon: "⭐", color: "text-blue-600", bg: "bg-blue-100", label: "Community Member" };
      case "Free":
        return { icon: "🌟", color: "text-gray-600", bg: "bg-gray-100", label: "Free Member" };
      default:
        return { icon: "👤", color: "text-gray-600", bg: "bg-gray-100", label: "Member" };
    }
  };
      ...
      <div className="p-6">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 bg-gray-100 text-gray-700 py-3 rounded-xl font-semibold hover:bg-gray-200 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
      ...
      {showConversationModal && selectedEventForConversation && (
        <EventConversationStarters
          ...
          onConversationStart={(starterId, text) => {
            console.log('Starting conversation:', { starterId, text, matchId: matchProfile.id, eventId: selectedEventForConversation.id });
