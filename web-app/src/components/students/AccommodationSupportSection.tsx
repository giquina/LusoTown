...
const ACCOMMODATION_LISTINGS: AccommodationListing[] = [
  ...
  },
  {
    ...
    title: 'Modern Studio near Portuguese-speaking community',
    titlePortuguese: 'Estúdio Moderno perto da Comunidade de Falantes de Português',
    type: 'private_studio',
    ...
    portugueseOwner: true,
    description: 'Self-contained studio apartment in Stockwell, heart of London\'s Portuguese-speaking community. Perfect for independent students who want privacy but close to Portuguese culture.',
    descriptionPortuguese: 'Apartamento estúdio independente em Stockwell, coração da comunidade de falantes de português de Londres. Perfeito para estudantes independentes que querem privacidade mas perto da cultura portuguesa.',
