    ...
    achievements: [
      {
        id: "startup-founded",
        title: {
          en: "Tech Startup Founded",
          pt: "Startup Tecnológica Fundada",
        },
        description: {
          en: "£5M Series A funding raised",
          pt: "£5M financiamento Série A levantado",
        },
        icon: "🚀",
        color: "text-blue-600",
      },
      {
        ...
        description: {
          en: "25-person diverse tech team",
          pt: "Equipa tecnológica diversa de 25 pessoas",
        },
        icon: "👥",
      ...
      },
      {
        ...
        description: {
          en: "UK-Portugal tech partnerships",
          pt: "Parcerias tecnológicas Reino Unido-Portugal",
        },
        icon: "🌉",
      ...
      },
      {
        ...
        description: {
          en: "Tech Entrepreneur of the Year 2023",
          pt: "Empresária Tecnológica do Ano 2023",
        },
        icon: "🏆",
    ...
    achievements: [
      {
        ...
        description: {
          en: "Youngest Senior Analyst in department",
          pt: "Analista Sénior mais jovem do departamento",
        },
        icon: "💼",
        color: "text-blue-600",
      },
      {
        ...
        description: {
          en: "£100k fund for Brazilian students",
          pt: "Fundo de £100k para estudantes brasileiros",
        },
        icon: "🎓",
        color: "text-green-600",
      },
      {
        id: "cultural-finance",
        title: {
          en: "Cultural Finance Bridge",
          pt: "Ponte Financeira Cultural",
        },
        description: {
          en: "Brazil-UK investment initiatives",
          pt: "Iniciativas de investimento Brasil-Reino Unido",
        },
        icon: "🌎",
      ...
      },
      {
        ...
        description: {
          en: "Social impact investing focus",
          pt: "Foco em investimento de impacto social",
        },
        icon: "❤️",
        color: "text-red-600",
      },
    ...
    achievements: [
      {
        id: "studio-founded",
        title: {
          en: "Creative Studio Founded",
          pt: "Estúdio Criativo Fundado",
        },
        description: {
          en: "Morabeza Creative Studio - 15 employees",
          pt: "Estúdio Criativo Morabeza - 15 funcionários",
        },
        icon: "🎨",
        color: "text-purple-600",
      },
      {
        ...
        title: {
          en: "Global Brand Partnerships",
          pt: "Parcerias de Marcas Globais",
        },
        description: {
          en: "Nike, Adidas, British Museum campaigns",
          pt: "Campanhas Nike, Adidas, Museu Britânico",
        },
        icon: "🤝",
        color: "text-blue-600",
      },
      {
        ...
        description: {
          en: "Tate Modern Cape Verdean showcase",
          pt: "Mostra cabo-verdiana Tate Modern",
        },
        icon: "🖼️",
        color: "text-green-600",
      },
      {
        ...
        description: {
          en: "London Design Festival winner 2022",
          pt: "Vencedora Festival de Design de Londres 2022",
        },
        icon: "🏅",
        color: "text-yellow-600",
      },
    ...
    achievements: [
      {
        ...
        title: {
          en: "Research Breakthrough",
          pt: "Descoberta de Investigação",
        },
        description: {
          en: "Malaria treatment published in Nature",
          pt: "Tratamento de malária publicado na Nature",
        },
        icon: "🔬",
        color: "text-green-600",
      },
      {
        id: "health-program",
        title: {
          en: "Health Program Launch",
          pt: "Lançamento Programa de Saúde",
        },
        description: {
          en: "Angola-Cambridge medical partnership",
          pt: "Parceria médica Angola-Cambridge",
        },
        icon: "🏥",
        color: "text-blue-600",
      },
      {
        id: "student-training",
        title: {
          en: "Student Training Program",
          pt: "Programa de Formação de Estudantes",
        },
        description: {
          en: "200+ African medical students trained",
          pt: "200+ estudantes de medicina africanos formados",
        },
        icon: "👨‍⚕️",
        color: "text-purple-600",
      },
      {
        ...
        description: {
          en: "WHO Young Scientist Award 2023",
          pt: "Prémio Jovem Cientista OMS 2023",
        },
        icon: "🌍",
        color: "text-orange-600",
      },
    ...
    achievements: [
      {
        ...
        description: {
          en: "Senior Consultant at 29 years old",
          pt: "Consultora Sénior aos 29 anos",
        },
        icon: "🌐",
        color: "text-blue-600",
      },
      {
        id: "climate-policy",
        title: {
          en: "Climate Policy Development",
          pt: "Desenvolvimento de Política Climática",
        },
        description: {
          en: "African climate adaptation strategies",
          pt: "Estratégias de adaptação climática africana",
        },
        icon: "🌱",
        color: "text-green-600",
      },
      {
        ...
        description: {
          en: "15+ peer-reviewed environmental papers",
          pt: "15+ artigos ambientais revistos por pares",
        },
        icon: "📚",
        color: "text-purple-600",
      },
      {
        ...
        description: {
          en: "COP28 keynote presentation",
          pt: "Apresentação principal COP28",
        },
        icon: "🎤",
        color: "text-orange-600",
      },
  ...
  ({
    ...
    useEffect(() => {
      ...
      const interval = setInterval(() => {
        setCurrentIndex(
          (prevIndex) => (prevIndex + 1) % SUCCESS_STORIES.length
        );
      }, autoplayInterval);
    ...
    const goToPrevious = useCallback(() => {
      setCurrentIndex(
        (prevIndex) =>
          (prevIndex - 1 + SUCCESS_STORIES.length) % SUCCESS_STORIES.length
      );
      setIsPlaying(false);
    }, []);
        ...
        <div className="container-width">
          ...
          <div className="relative">
            ...
            <button
              ...
              aria-label={
                language === "pt" ? "História anterior" : "Previous story"
              }
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 lg:p-12">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                      {Object.entries(currentStory.keyMetrics).map(
                        ([key, value]) => (
                          <div
                            key={key}
          ...
          <div className="flex justify-center space-x-2 mt-8">
            {SUCCESS_STORIES.map((_, index) => (
              ...
              `}
                aria-label={`${
                  language === "pt" ? "Ver história" : "View story"
                } ${index + 1}`}
              />
            ))}
          </div>
