...
interface AcademicConnection {
  id: string
  name: string
  role: 'student' | 'professor' | 'researcher' | 'phd_candidate' | 'postdoc' | 'mentor'
  university: string
  subject: string
  specialization: string[]
  yearOfStudy?: string
  researchInterests: string[]
  availableFor: ('study_groups' | 'research_collaboration' | 'mentorship' | 'language_exchange' | 'career_advice')[]
  location: string
  rating: number
  connections: number
  isOnline: boolean
...
interface StudyGroup {
  ...
  subject: string
  university: string
  type: 'exam_prep' | 'assignment_help' | 'research_group' | 'language_practice' | 'thesis_support'
  members: number
  maxMembers: number
...
interface ResearchProject {
  ...
  type: 'undergraduate_research' | 'masters_thesis' | 'phd_research' | 'group_project'
...
const ACADEMIC_CONNECTIONS: AcademicConnection[] = [
  {
    ...
    specialization: ['Contemporary Portuguese Poetry', 'Digital Humanities', 'Cultural Studies'],
    researchInterests: ['Fernando Pessoa', 'Modern Portuguese Poetry', 'Portuguese Identity in Literature'],
  ...
  },
  {
    ...
    researchInterests: ['Natural Language Processing', 'Portuguese Language Models', 'Computational Linguistics'],
    availableFor: ['study_groups', 'research_collaboration', 'language_exchange'],
    location: 'London',
    rating: 4.7,
    connections: 42,
    isOnline: false,
  ...
  },
  {
    ...
    specialization: ['Portuguese History', 'Colonial Studies', 'Atlantic World'],
    researchInterests: ['Portuguese Empire', 'Brazil-Portugal Relations', 'Portuguese Colonial History'],
  ...
  },
  {
    ...
    specialization: ['Portuguese Language', 'Translation Studies', 'Comparative Literature'],
    yearOfStudy: '2nd Year',
    researchInterests: ['Portuguese Translation', 'Literary Translation', 'Cross-Cultural Communication'],
  ...
  },
  {
    ...
    subject: 'Economics',
    specialization: ['Development Economics', 'Portuguese Economy', 'European Integration'],
    researchInterests: ['Portugal EU Integration', 'Economic Development', 'Portuguese Business'],
    availableFor: ['mentorship', 'research_collaboration', 'career_advice'],
    location: 'Cambridge',
    rating: 4.9,
    connections: 98,
  ...
  },
  {
    ...
    specialization: ['EU Politics', 'Portuguese Foreign Policy', 'International Law'],
    yearOfStudy: 'Masters',
    researchInterests: ['EU-Africa Relations', 'Portuguese Diplomacy', 'International Development'],
...
const STUDY_GROUPS: StudyGroup[] = [
  {
    ...
    description: 'Weekly discussions on contemporary Portuguese literature, poetry analysis, and research collaboration on Portuguese cultural studies.',
    descriptionPortuguese: 'Discussões semanais sobre literatura portuguesa contemporânea, análise de poesia e colaboração em investigação sobre estudos culturais portugueses.',
    coordinator: 'Ana Silva (PhD Candidate)',
    requirements: ['Intermediate Portuguese reading level', 'Portuguese Studies student or interest'],
    isActive: true,
    success_rate: 94
  },
  {
    ...
    namePortuguese: 'Estudantes de Informática Portugueses - Grupo de Estudo de Algoritmos',
    subject: 'Computer Science',
    university: 'Imperial College London',
    type: 'exam_prep',
    members: 15,
    ...
    description: 'Collaborative study sessions for algorithm design, data structures, and coding interview preparation. Conducted in Portuguese and English.',
    descriptionPortuguese: 'Sessões de estudo colaborativas para design de algoritmos, estruturas de dados e preparação para entrevistas de programação. Conduzidas em português e inglês.',
    coordinator: 'Miguel Costa (3rd Year)',
    requirements: ['Computer Science student', 'Basic programming knowledge', 'Portuguese speaker'],
    isActive: true,
    success_rate: 89
  },
  {
    ...
    description: 'Support group for Portuguese students writing dissertations and theses. Peer review, writing workshops, and academic guidance.',
    descriptionPortuguese: 'Grupo de apoio para estudantes portugueses a escrever dissertações e teses. Revisão por pares, workshops de escrita e orientação académica.',
    coordinator: 'Prof. João Fernandes',
    requirements: ['Masters or PhD student', 'Currently writing thesis', 'Portuguese connection to research'],
    isActive: true,
    success_rate: 96
  },
  {
    ...
    description: 'Academic language exchange focusing on presentation skills, academic writing, and scholarly discussion in Portuguese and English.',
    descriptionPortuguese: 'Intercâmbio de língua académica focado em competências de apresentação, escrita académica e discussão académica em português e inglês.',
    coordinator: 'Maria Santos (2nd Year)',
    requirements: ['Fluent in Portuguese or English', 'Academic focus', 'Regular attendance'],
    isActive: true,
    success_rate: 92
  }
]
...
const RESEARCH_PROJECTS: ResearchProject[] = [
  {
    ...
    titlePortuguese: 'Diáspora Portuguesa Digital: Identidade e Comunidade Online',
    university: 'University College London',
    ...
    status: 'recruiting',
    duration: '18 months',
    requirements: ['Digital humanities interest', 'Portuguese language skills', 'Research experience'],
    skills: ['Data analysis', 'Social media research', 'Portuguese culture knowledge'],
    description: 'Research into how Portuguese communities maintain cultural identity through digital platforms and social media.',
    descriptionPortuguese: 'Investigação sobre como as comunidades portuguesas mantêm a identidade cultural através de plataformas digitais e redes sociais.',
    funding: true,
    publications: true,
    deadline: '2024-10-15'
  },
  {
    ...
    status: 'recruiting',
    duration: '12 months',
    requirements: ['Computer Science student', 'Python programming', 'Portuguese native speaker'],
    skills: ['Machine learning', 'Natural language processing', 'Python/TensorFlow'],
    description: 'Developing AI models specifically trained on Portuguese language data for improved text analysis and translation.',
    descriptionPortuguese: 'Desenvolvimento de modelos de IA especificamente treinados em dados da língua portuguesa para melhor análise de texto e tradução.',
    funding: false,
    publications: true,
    deadline: '2024-09-30'
  },
  {
    ...
    titlePortuguese: 'Relações Portugal-Reino Unido Pós-Brexit: Impacto Económico e Social',
    university: 'London School of Economics',
    ...
    status: 'active',
    duration: '9 months',
    requirements: ['International Relations or Economics student', 'EU studies knowledge', 'Portuguese context understanding'],
    skills: ['Economic analysis', 'Policy research', 'Statistical analysis'],
    description: 'Comprehensive analysis of how Brexit has affected Portugal-UK relations across economic, social, and political dimensions.',
    descriptionPortuguese: 'Análise abrangente de como o Brexit afetou as relações Portugal-Reino Unido nas dimensões económica, social e política.',
    funding: true,
    publications: true,
    deadline: '2025-01-31'
  }
...
export default function AcademicNetworkingSection() {
  ...
  const [activeTab, setActiveTab] = useState<'connections' | 'study_groups' | 'research'>('connections')
  ...
  const tabs = [
    { 
      ...
      icon: UsersIcon,
      description: { en: 'Connect with Portuguese students, researchers, and professors', pt: 'Conecte-se com estudantes, investigadores e professores portugueses' }
    },
    { 
      id: 'study_groups', 
      label: { en: 'Study Groups', pt: 'Grupos de Estudo' },
      icon: BookOpenIcon,
      description: { en: 'Join Portuguese study groups and academic circles', pt: 'Junte-se a grupos de estudo e círculos académicos portugueses' }
    },
    { 
      id: 'research', 
      label: { en: 'Research Projects', pt: 'Projetos de Investigação' },
      icon: PresentationChartLineIcon,
      description: { en: 'Collaborate on Portuguese-focused research projects', pt: 'Colabore em projetos de investigação focados no português' }
    }
  ]
  ...
  const roleFilters = [
    ...
    { value: 'phd_candidate', label: { en: 'PhD Candidates', pt: 'Candidatos a Doutoramento' } },
  ...
  const subjectFilters = [
    ...
    { value: 'Portuguese Studies', label: { en: 'Portuguese Studies', pt: 'Estudos Portugueses' } },
    { value: 'Computer Science', label: { en: 'Computer Science', pt: 'Ciência da Computação' } },
    { value: 'International Relations', label: { en: 'International Relations', pt: 'Relações Internacionais' } },
    { value: 'Economics', label: { en: 'Economics', pt: 'Economia' } },
    { value: 'Modern Languages', label: { en: 'Modern Languages', pt: 'Línguas Modernas' } }
  ]

  const filteredConnections = ACADEMIC_CONNECTIONS.filter(connection => {
    const roleMatch = selectedRole === 'all' || connection.role === selectedRole
    const subjectMatch = selectedSubject === 'all' || connection.subject === selectedSubject
    return roleMatch && subjectMatch
  })

  const getRoleColor = (role: string) => {
    switch (role) {
      case 'professor': return 'bg-primary-100 text-primary-700'
      case 'phd_candidate': return 'bg-secondary-100 text-secondary-700'
      case 'researcher': return 'bg-accent-100 text-accent-700'
      case 'student': return 'bg-premium-100 text-premium-700'
      case 'postdoc': return 'bg-coral-100 text-coral-700'
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      case 'exam_prep': return 'bg-red-100 text-red-700'
      case 'research_group': return 'bg-blue-100 text-blue-700'
      case 'thesis_support': return 'bg-green-100 text-green-700'
      case 'language_practice': return 'bg-purple-100 text-purple-700'
      case 'assignment_help': return 'bg-yellow-100 text-yellow-700'
      default: return 'bg-gray-100 text-gray-700'
    }
  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredConnections.map((connection, index) => (
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <span className={`text-xs px-2 py-1 rounded-full ${getRoleColor(connection.role)}`}>
                          {getRoleLabel(connection.role)}
                        </span>
                      </div>
                    </div>
                    <div className="flex items-center">
                      <div className={`w-3 h-3 rounded-full ${connection.isOnline ? 'bg-green-500' : 'bg-gray-300'}`}></div>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    <h4 className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">
                      {language === 'pt' ? 'Disponível para:' : 'Available for:'}
                    </h4>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-sm text-gray-600">
                      {connection.connections} {language === 'pt' ? 'conexões' : 'connections'}
                    </div>
                    {connection.publications && (
                      <div className="text-sm text-gray-600">
                        {connection.publications} {language === 'pt' ? 'publicações' : 'publications'}
                      </div>
                    )}
                  </div>
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="text-right">
                    <div className="text-sm font-medium text-gray-900">
                      {group.success_rate}% {language === 'pt' ? 'sucesso' : 'success'}
                    </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center text-sm text-gray-600">
                    ...
                    {language === 'pt' ? 'Próxima reunião:' : 'Next meeting:'} {new Date(group.nextMeeting).toLocaleDateString()}
                  </div>
                </div>

                <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                  {language === 'pt' ? group.descriptionPortuguese : group.description}
                </p>
                ...
                <div className="mb-4">
                  ...
                  <div className="text-sm text-gray-900">{group.coordinator}</div>
                </div>
                ...
                >
                  {group.members >= group.maxMembers 
                    ? (language === 'pt' ? 'Grupo Cheio' : 'Group Full')
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center text-sm text-gray-600 mb-1">
                    ...
                    {language === 'pt' ? 'Líder:' : 'Lead:'} {project.leadResearcher}
                  </div>
                  <div className="flex items-center text-sm text-gray-600">
                    <ClockIcon className="w-4 h-4 mr-2" />
                    {language === 'pt' ? 'Duração:' : 'Duration:'} {project.duration}
                  </div>
                </div>
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-between text-sm text-gray-600 mb-2">
                    <span>{language === 'pt' ? 'Colaboradores:' : 'Collaborators:'}</span>
                ...
                <div className="mb-4 text-sm text-gray-600">
                  <strong>{language === 'pt' ? 'Prazo de candidatura:' : 'Application deadline:'}</strong> {new Date(project.deadline).toLocaleDateString()}
                </div>

                {/* Action Button */}
                <button 
                  className={`w-full font-medium py-3 px-4 rounded-lg transition-all duration-200 ${
                    project.collaborators >= project.maxCollaborators || project.status === 'completed'
                      ? 'bg-gray-100 text-gray-400 cursor-not-allowed'
                      : 'bg-gradient-to-r from-primary-500 to-secondary-500 text-white hover:from-primary-600 hover:to-secondary-600'
                  }`}
                  disabled={project.collaborators >= project.maxCollaborators || project.status === 'completed'}
                >
                  {project.collaborators >= project.maxCollaborators 
                    ? (language === 'pt' ? 'Projeto Cheio' : 'Project Full')
                    : project.status === 'completed'
                    ? (language === 'pt' ? 'Projeto Concluído' : 'Project Completed')
                    : (language === 'pt' ? 'Candidatar-se' : 'Apply')
                  }
                </button>
              </motion.div>
            ))}
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-primary-600 font-bold px-8 py-3 rounded-xl hover:bg-gray-100 transition-colors">
              {language === 'pt' ? 'Criar Perfil Académico' : 'Create Academic Profile'}
            </button>
