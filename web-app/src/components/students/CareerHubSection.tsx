...
const CAREER_OPPORTUNITIES: CareerOpportunity[] = [
  {
    ...
    description: 'Work on products and services specifically for Portuguese-speaking markets. Collaborate with Google teams in Portugal and Brazil while based in the U.K..',
  ...
  },
  {
    ...
    description: 'Help expand fintech services to Portuguese small businesses in the U.K.. Create Portuguese-language content and manage community engagement.',
    ...
    isPartnership: false,
    portugueseConnection: 'Serves Portuguese business community in the U.K.',
...
const CAREER_EVENTS: CareerEvent[] = [
  {
    ...
    description: 'Largest Portuguese career fair in the U.K.. Meet top employers specifically looking for Portuguese talent.',
  ...
  },
  {
    ...
    description: 'Exclusive networking event with Portuguese finance professionals in the U.K.\'s financial district.',
