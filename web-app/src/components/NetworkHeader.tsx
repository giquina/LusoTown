...
export default function NetworkHeader({
  ...
  return (
    <div className={`bg-white border-b border-gray-200 ${className}`}>
      ...
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span>🔍</span>
              {language === 'pt' ? 'Procurar Pessoas' : 'Find People'}
            </button>
            <button
              className="px-4 py-2 text-white rounded-lg hover:shadow-lg transition-all duration-200 flex items-center gap-2"
              style={{ backgroundColor: brandColors.primary }}
            >
              <span>➕</span>
              {language === 'pt' ? 'Nova Conexão' : 'New Connection'}
            </button>
          </div>
        </div>
      ...
      {stats.newMatches > 0 && (
        <div 
          className="mx-6 mb-4 p-3 rounded-lg flex items-center justify-between"
        ...
        >
          ...
          <button 
            className="px-4 py-2 text-white rounded-lg hover:shadow-md transition-all duration-200"
