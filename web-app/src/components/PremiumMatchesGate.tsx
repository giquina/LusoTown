  ...
  const tiers = [
    {
      ...
      tier: "free" as const,
      features: [
        t.freeFeatures.matches,
        t.freeFeatures.messages,
        t.freeFeatures.viewing,
        t.freeFeatures.search,
      ],
    },
    {
    ...
    },
    {
      ...
      features: [
        t.features.unlimited,
        t.features.events,
        t.features.ambassador_priority,
        t.features.ambassador_coordination,
        t.features.ambassador_support,
        t.features.ambassador_streaming,
      ],
    },
  ];
