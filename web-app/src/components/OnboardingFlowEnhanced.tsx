...
export default function OnboardingFlowEnhanced({ 
  ...
  const steps: OnboardingStep[] = [
    ...
    },
    {
      ...
      description: 'Tell us about yourself so we can connect you with the right people and opportunities in the Portuguese community.',
      descriptionPortuguese: 'Conte-nos sobre si para que possamos conectá-lo com as pessoas e oportunidades certas na comunidade portuguesa.',
      icon: UserGroupIcon,
      color: 'secondary',
      fields: [
        {
