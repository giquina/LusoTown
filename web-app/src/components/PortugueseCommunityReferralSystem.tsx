...
export default function PortugueseCommunityReferralSystem({
  ...
  const referralRewards: ReferralReward[] = [
    ...
    },
    {
      ...
      value: 'Heritage tour package',
      valuePortuguese: 'Pacote de tour do património',
      description: 'Free Portuguese heritage tour of London + dinner for you and a friend',
      descriptionPortuguese: 'Tour gratuito do património português de Londres + jantar para si e um amigo',
      requirements: {
        referralsNeeded: 8,
        timeframe: '120 days',
