    ...
    const contents = {
      ...
      after_match: {
        en: {
          ...
          description: 'You found a connection! With Premium, discover unlimited matches and access exclusive Portuguese community events.',
          icon: Sparkles,
          color: 'secondary',
          urgency: 'low'
        },
        pt: {
          ...
          description: 'Encontrou uma conexão! Com Premium, descubra matches ilimitados e acesse eventos exclusivos da comunidade portuguesa.',
          icon: Sparkles,
          color: 'secondary',
          urgency: 'low'
        }
      ...
      premium_event: {
        en: {
          ...
          description: 'This event is for Premium members only. Upgrade to access cultural workshops, business networking, and community gatherings.',
          icon: Calendar,
          color: 'premium',
          urgency: 'medium'
        },
        pt: {
          ...
          description: 'Este evento é só para membros Premium. Faça upgrade para aceder a workshops culturais, networking empresarial e encontros comunitários.',
          icon: Calendar,
          color: 'premium',
          urgency: 'medium'
        }
      ...
      general: {
        en: {
          ...
          description: 'Discover unlimited matches, exclusive events, and connect with Portuguese speakers across London.',
          icon: Crown,
          color: 'primary',
          urgency: 'low'
        },
        pt: {
          ...
          description: 'Descubra matches ilimitados, eventos exclusivos e conecte-se com falantes de português em Londres.',
          icon: Crown,
          color: 'primary',
          urgency: 'low'
        }
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          {/* Header */}
          <div className={`relative bg-gradient-to-br from-${content.color}-500 to-${content.color}-600 text-white p-6 rounded-t-2xl`}>
            <button
              onClick={onClose}
            ...
            {content.urgency === 'high' && (
              <div className="mt-4 flex items-center gap-2 text-orange-200">
                ...
                <span className="text-sm font-medium">
                  {language === 'pt' ? 'Recarrega à meia-noite' : 'Resets at midnight'}
                </span>
              </div>
            )}
          </div>
          ...
          <div className="p-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="text-center mb-4">
                  ...
                  <p className="text-sm text-neutral-600 mt-1">
                    {pricing.community.yearlyPrice} • {pricing.community.savings}
                  </p>
                </div>
                ...
                >
                  {isProcessing && <div className="animate-spin rounded-full h-4 w-4 border-2 border-white border-t-transparent"></div>}
                  {pricing.trial}
                </button>
              </motion.div>
              ...
              >
                <div className="text-center mb-4">
                  ...
                  <p className="text-sm text-neutral-600 mt-1">
                    {pricing.ambassador.yearlyPrice} • {pricing.ambassador.savings}
                  </p>
                </div>
            ...
            >
              ...
              <div className="flex items-center gap-4 text-sm text-neutral-600">
                <div className="flex items-center gap-1">
                  ...
                  {language === 'pt' ? '2,500+ membros ativos' : '2,500+ active members'}
                </div>
                <div className="flex items-center gap-1">
                  <Calendar className="h-4 w-4 text-coral-500" />
                  {language === 'pt' ? '50+ eventos mensais' : '50+ monthly events'}
                </div>
                <div className="flex items-center gap-1">
                  <Heart className="h-4 w-4 text-coral-500" />
                  {language === 'pt' ? 'Foco cultural português' : 'Portuguese cultural focus'}
                </div>
              </div>
            </motion.div>
            ...
            <div className="mt-6 text-center">
              ...
              >
                {language === 'pt' ? 'Continuar com conta gratuita' : 'Continue with free account'}
              </button>
            </div>
          </div>
        </motion.div>
