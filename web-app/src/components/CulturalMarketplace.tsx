          ...
          <div className="container-width">
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-12">
              ...
              <div className="bg-gradient-to-br from-accent-500 to-accent-600 rounded-2xl p-6">
                ...
                <p className="text-accent-100 text-sm">8% {isPortuguese ? 'comissão média' : 'average commission'}</p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {featuredProducts.map((product, index) => (
              <motion.div
                ...
                className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-secondary-100"
              >
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute top-4 right-4 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-lg hover:bg-secondary-50 transition-colors"
                  >
