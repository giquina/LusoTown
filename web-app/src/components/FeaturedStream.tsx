      ...
      <div className="bg-gradient-to-br from-secondary-50 via-accent-50 to-coral-50 rounded-2xl p-8 shadow-lg border border-secondary-200">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-secondary-600 mb-6">{t('featured_stream.description', 'Join us for an exclusive live performance by the queen of Fado, Mariza. A night of soulful music and Portuguese culture, streamed directly to you.')}</p>
            <div className="flex items-center space-x-4 mb-6 text-sm text-secondary-700">
