...
const HERITAGE_PROJECTS: HeritageProject[] = [
  {
    ...
    description: 'Recording life stories and traditional knowledge from Portuguese community elders across London, preserving immigration narratives, cultural wisdom, and family histories for future generations.',
    descriptionPortuguese: 'Registando histórias de vida e conhecimento tradicional dos anciãos da comunidade portuguesa em Londres, preservando narrativas de imigração, sabedoria cultural e histórias familiares para as futuras gerações.',
  ...
  },
  {
    ...
    description: 'Comprehensive digital collection of Portuguese community artifacts, photographs, documents, and cultural materials from London\'s Portuguese history spanning 60+ years.',
    descriptionPortuguese: 'Coleção digital abrangente de artefatos da comunidade portuguesa, fotografias, documentos e materiais culturais da história portuguesa de Londres que abrange 60+ anos.',
    ...
    outcomes: [
      'Digitized 1,800 historic photographs of Portuguese community events',
    ...
    outcomesPortuguese: [
      'Digitalizadas 1.800 fotografias históricas de eventos da comunidade portuguesa',
  ...
  },
  {
    ...
    description: 'Multi-generational program documenting Portuguese language variations, regional dialects, and linguistic evolution within the U.K.\'s diverse Portuguese-speaking communities.',
    ...
    yearStarted: '2023',
    impact: 'Documented linguistic variations across 8 Portuguese-speaking countries represented in the U.K., creating valuable resource for linguistic research and community education.',
  ...
  },
  {
    ...
    description: 'Video documentary project capturing Portuguese traditional festivals, religious celebrations, and cultural practices as they evolve within the U.K.\'s multicultural environment.',
    ...
    status: 'active',
    participants: 75,
    location: 'Portuguese Community Centers & Churches',
    yearStarted: '2023',
    impact: 'Documented 12 major Portuguese festivals and celebrations, preserving traditional practices while showing cultural adaptation in the U.K. context.',
    ...
    outcomes: [
      ...
      'Captured Fado performance traditions in the U.K.',
