...
export default function DiverseSuccessStories() {
  ...
  const successStories = [
    ...
    },
    {
      ...
      story: 'Growing up multicultural in London, I struggled to connect with my Portuguese roots. This community helped me embrace my multicultural identity and now I help preserve Portuguese cultural stories in London museums.',
