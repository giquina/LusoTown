...
const sampleGroupEvents: GroupEventData[] = [
  {
    ...
    description: 'Explore the Tower of London with Portuguese-speaking women 30+ and discover fascinating historical connections between Portugal and England. Guided tour includes Crown Jewels and Beefeater stories.',
    date: '2025-08-18',
    time: '10:00 AM',
    ...
    hostImage: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?auto=format&fit=crop&w=150&q=80',
    hostVerified: true,
    rating: 4.9,
    reviewCount: 47,
    isPopular: true,
  ...
  },
  {
    ...
    description: 'Relaxing evening cruise along the Thames with traditional afternoon tea. Perfect for Portuguese women 30+ looking to unwind and connect while enjoying London\'s skyline at golden hour.',
    date: '2025-08-20',
    time: '5:30 PM',
    ...
    currency: '£',
    category: 'Women 30+',
    image: 'https://images.unsplash.com/photo-1544133503-59b3a20b4ac1?auto=format&fit=crop&w=800&q=80',
    spotsLeft: 3,
    maxAttendees: 12,
  ...
  },
  {
    ...
    description: 'Sophisticated cultural walk through the City of London, exploring architectural marvels including St. Paul\'s Cathedral. Designed for Portuguese women 40+ who appreciate history and beautiful design.',
    date: '2025-08-22',
    time: '2:00 PM',
    ...
    currency: '£',
    category: 'Women 40+',
    image: 'https://images.unsplash.com/photo-1541430508537-825b4ee376a5?auto=format&fit=crop&w=800&q=80',
    spotsLeft: 12,
    maxAttendees: 18,
  ...
  },
  {
    ...
    description: 'Discover the best Portuguese and international foods at Borough Market. Join other Portuguese-speaking women 30+ for tastings, shopping, and cultural food discussions.',
    date: '2025-08-25',
    time: '10:30 AM',
    ...
    hostImage: 'https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?auto=format&fit=crop&w=150&q=80',
    hostVerified: true,
    rating: 4.8,
    reviewCount: 52,
    hasPhotos: true,
...
export default function GroupEventsSection({ 
  ...
  const filteredEvents = selectedCategory === 'all' 
    ...
    : sampleGroupEvents.filter(event => event.category === selectedCategory).slice(0, maxEvents)
  ...
  if (variant === 'homepage') {
    return (
      <section className={`py-24 bg-gradient-to-br from-white via-primary-50/20 to-secondary-50/30 relative overflow-hidden ${className}`}>
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 left-20 w-24 h-24 bg-gradient-to-tr from-premium-200/40 via-action-100/30 to-coral-100/30 rounded-full opacity-50 animate-bounce" style={{ animationDuration: '8s' }} />
            ...
            <div className="text-center mb-16">
              ...
              <div className="flex items-center justify-center gap-6 text-sm text-gray-600">
                <div className="flex items-center gap-2">
                  ...
                  <span>{isPortuguese ? '50% Mulheres 30+' : '50% Women 30+'}</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 bg-premium-400 rounded-full"></div>
                  <span>{isPortuguese ? '25% Mulheres 40+' : '25% Women 40+'}</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div className="bg-gradient-to-r from-white/80 via-coral-50/60 to-secondary-50/60 backdrop-blur-lg border border-white/40 rounded-3xl p-8 mb-12 shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="text-center p-6 bg-white/60 rounded-2xl border border-white/30">
                  ...
                  <h4 className="font-semibold text-gray-900 mb-2">
                    {isPortuguese ? 'Experiências de Qualidade' : 'Quality Experiences'}
                  </h4>
                  <p className="text-sm text-gray-600">
                    {isPortuguese 
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  >
                    ...
                    <span className="relative z-10 flex items-center justify-center gap-3">
                      {isPortuguese ? 'Ver Todos os Eventos de Grupo' : 'View All Group Events'}
                  ...
                  >
                    {isPortuguese ? 'Criar Evento de Grupo' : 'Create Group Event'}
                  </a>
                </div>
              </div>
            </div>
  ...
  // Full-page variant
  return (
    <div className={`min-h-screen py-24 bg-gradient-to-br from-white via-primary-50/20 to-secondary-50/30 ${className}`}>
