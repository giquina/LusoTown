...
export default function StreamReplayLibrary({
  ...
  selectedCategory,
  language,
}: StreamReplayLibraryProps) {
  const { t } = useLanguage();
  const [searchQuery, setSearchQuery] = useState("");
  const [sortBy, setSortBy] = useState("recent"); // recent, popular, duration
  const [showFilters, setShowFilters] = useState(false);
  const [selectedReplay, setSelectedReplay] = useState<StreamReplay | null>(
    null
  );
  ...
  const replays: StreamReplay[] = [
    {
      ...
      title:
        language === "pt"
          ? "Noite de Fado Especial - Dezembro 2024"
          : "Special Fado Night - December 2024",
      description:
        language === "pt"
          ? "Uma noite inesquecível de fado tradicional com artistas de Lisboa e Porto"
      ...
      keyMoments: [
        {
          time: 15,
          title:
            language === "pt" ? "Abertura Tradicional" : "Traditional Opening",
          description:
            language === "pt"
              ? "Fado tradicional de Lisboa"
              : "Traditional Lisbon fado",
        },
        {
          time: 45,
          title: language === "pt" ? "Momento Especial" : "Special Moment",
          description:
            language === "pt" ? "Dueto emocionante" : "Emotional duet",
        },
        {
          time: 72,
          title: language === "pt" ? "Grande Final" : "Grand Finale",
          description:
            language === "pt"
              ? "Todos os artistas juntos"
    ...
    },
    {
      ...
      title:
        language === "pt"
          ? "Workshop de IA para Negócios - Janeiro 2025"
          : "AI for Business Workshop - January 2025",
      description:
        language === "pt"
          ? "Como implementar inteligência artificial no seu negócio português"
          : "How to implement artificial intelligence in your Portuguese business",
      ...
      keyMoments: [
        {
          time: 10,
          title: language === "pt" ? "Introdução à IA" : "Introduction to AI",
          description:
            language === "pt" ? "Conceitos básicos" : "Basic concepts",
        },
        {
          time: 35,
          title: language === "pt" ? "Casos de Uso" : "Use Cases",
          description:
            language === "pt"
    ...
    },
    {
      ...
      title:
        language === "pt"
          ? "Histórias da Comunidade - Novembro 2024"
          : "Community Stories - November 2024",
      description:
        language === "pt"
      ...
      keyMoments: [
        ...
        },
        {
          time: 25,
          title:
            language === "pt" ? "Experiência do Miguel" : "Miguel's Experience",
          description:
            language === "pt"
        ...
        },
        {
          time: 45,
          title:
            language === "pt" ? "Conselhos da Comunidade" : "Community Advice",
          description:
            language === "pt"
              ? "Dicas para novos chegados"
              : "Tips for newcomers",
        },
      ],
    },
    {
      ...
      title:
        language === "pt"
          ? "Guia de Carreiras para Estudantes - Janeiro 2025"
          : "Student Career Guide - January 2025",
      description:
        language === "pt"
      ...
      keyMoments: [
        ...
        {
          time: 40,
          title: language === "pt" ? "CV e Entrevistas" : "CV and Interviews",
          description: language === "pt" ? "Dicas práticas" : "Practical tips",
        },
        {
          time: 65,
          title:
            language === "pt" ? "Networking Estudantil" : "Student Networking",
          description:
            language === "pt"
    ...
    },
    {
      ...
      title:
        language === "pt"
          ? "Mesa Redonda VIP - Dezembro 2024"
          : "VIP Roundtable - December 2024",
      description:
        language === "pt"
      ...
      keyMoments: [
        {
          time: 20,
          title: language === "pt" ? "Impacto do Brexit" : "Brexit Impact",
          description:
        ...
        },
        {
          time: 95,
          title:
            language === "pt" ? "Futuro dos Negócios" : "Future of Business",
          description:
            language === "pt"
  ...
  const sortedReplays = [...filteredReplays].sort((a, b) => {
    switch (sortBy) {
      ...
      default:
        return (
          new Date(b.originalStreamDate).getTime() -
          new Date(a.originalStreamDate).getTime()
        );
    }
  });
    ...
    >
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <span>
            {sortedReplays.length}{" "}
            {language === "pt" ? "replays disponíveis" : "replays available"}
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        <div className="flex-1 relative">
          ...
          <input
            type="text"
            placeholder={
              language === "pt" ? "Pesquisar replays..." : "Search replays..."
            }
            value={searchQuery}
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            <option value="popular">
              {language === "pt" ? "Mais Populares" : "Most Popular"}
            </option>
            <option value="duration">
              {language === "pt" ? "Mais Longos" : "Longest"}
            </option>
          </select>
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between text-xs text-gray-500 mb-3">
                    ...
                    <span>
                      {language === "pt" ? "Com" : "With"} {replay.host}
                    </span>
                  </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t">
                  <div className="flex items-center gap-4 text-sm text-gray-500">
                    ...
                    <span>
                      ...
                      {language === "pt" ? "visualizações" : "views"}
                    </span>
                  </div>
                  <button
                    onClick={() => setSelectedReplay(null)}
