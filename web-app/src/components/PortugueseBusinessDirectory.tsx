...
const portugueseBusinesses: PortugueseBusiness[] = [
  ...
  },
  {
    ...
    category: 'cultural',
    description: 'Official Portuguese cultural institution offering language classes, cultural events, community services, and preserving Portuguese heritage in London.',
    descriptionPortuguese: 'Instituição cultural portuguesa oficial oferecendo aulas de língua, eventos culturais, serviços comunitários e preservando o património português em Londres.',
