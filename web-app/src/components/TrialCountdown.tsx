...
export default function TrialCountdown({
  ...
  const translations = {
    en: {
      ...
      upgradeToKeep:
        "Upgrade to keep unlimited access to Portuguese community features",
      features: {
    ...
    pt: {
      ...
      upgradeToKeep:
        "Faça upgrade para manter acesso ilimitado às funcionalidades da comunidade portuguesa",
      features: {
        ...
        >
          ...
          >
            <div className="text-center">
              ...
              <p className="text-neutral-600 mb-6">{t.trialEndingSoon}</p>
              ...
              <div className="space-y-3">
                ...
                >
                  {t.ambassadorUpgrade} {formatPrice(plans.ambassador.monthly)}
                  /mês
                </button>
