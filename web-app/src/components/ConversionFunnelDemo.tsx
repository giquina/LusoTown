...
export default function ConversionFunnelDemo() {
  ...
  const { showPrompt, hidePrompt, isVisible, activePrompt } =
    useUpgradePrompt();
  ...
  const translations = {
    ...
    pt: {
      ...
      features: {
        contextual:
          "Prompts de upgrade contextuais baseados no comportamento do utilizador",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <p className="text-sm text-neutral-600">
              {language === "pt"
                ? "3 matches/dia, 10 msgs/mês"
                : "3 matches/day, 10 msgs/month"}
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className="font-semibold mb-2">
              {language === "pt"
                ? `Comunidade ${formatPrice(plans.community.monthly)}`
                : `Community ${formatPrice(plans.community.monthly)}`}
            </h4>
            <p className="text-sm text-neutral-600">
          ...
          <div className="text-center">
            ...
            <h4 className="font-semibold mb-2">
              {language === "pt"
                ? `Embaixador ${formatPrice(plans.ambassador.monthly)}`
                : `Ambassador ${formatPrice(plans.ambassador.monthly)}`}
            </h4>
            <p className="text-sm text-neutral-600">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          {(
            ...
            <button
              key={key}
              onClick={() =>
                showPrompt(key, Math.floor(Math.random() * 3), { demo: true })
              }
            ...
            >
              ...
              <div className="text-sm font-medium">{t.prompts[key]}</div>
            </button>
          ))}
        </div>
      </div>
      ...
      {activePrompt && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
          ...
          <p className="text-yellow-700">
            ...
            - {language === "pt" ? "Demonstração" : "Demo Mode"}
          </p>
        </div>
      )}
    </div>
        ...
        <div className="text-center bg-neutral-50 rounded-xl p-8">
          ...
          <button
            ...
            onClick={() =>
              alert(
                language === "pt"
                  ? "Funcionalidade de demo - integraria com o sistema de teste"
                  : "Demo functionality - would integrate with trial system"
              )
            }
          >
            {t.start_trial}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 p-4 bg-neutral-50 rounded-lg">
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm">
                {language === "pt" ? "Criar Match:" : "Create Match:"}
              </span>
              <InlineUsageCheck feature="matches" />
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm">
                {language === "pt" ? "Evento Premium:" : "Premium Event:"}
              </span>
          ...
          {[
            {
              type: "welcome",
              title:
                language === "pt" ? "Email de Boas-vindas" : "Welcome Email",
              description:
                language === "pt"
                  ? "Enviado imediatamente após registo"
            ...
            },
            {
              ...
              description:
                language === "pt"
                  ? "Oferta de desconto especial"
                  : "Special discount offer",
              delay:
                language === "pt"
                  ? "2 horas após expirar"
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          {
            title:
              language === "pt" ? "Upgrades Este Mês" : "Upgrades This Month",
            value: "89",
            change: "+28.4%",
            color: "green",
          },
  ...
  const renderContent = () => {
    switch (activeDemo) {
      ...
      case "upgrade_prompts":
        return renderUpgradePrompts();
      case "trial_system":
        return renderTrialSystem();
      case "usage_limits":
        return renderUsageLimits();
      case "email_sequences":
        return renderEmailSequences();
      case "analytics":
