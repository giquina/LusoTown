...
const culturalExperiences: CulturalExperience[] = [
  ...
  },
  {
    ...
    category: 'discovery',
    description: 'Educational tours exploring Portuguese maritime history and global discoveries in London.',
    descriptionPortuguese: 'Tours educativos explorando a história marítima portuguesa e descobertas globais em Londres.',
    icon: Compass,
    color: 'primary',
    featured: false,
    popularity: 85,
