...
export default function SubscriptionGate({ 
  ...
  const getGateContent = () => {
    switch (mode) {
      ...
      case 'transport':
        return {
          title: isPortuguese ? 'Subscrição Necessária para Reservas de Transporte' : 'Subscription Required for Transport Bookings',
          description: isPortuguese 
          ...
          icon: CreditCardIcon,
          buttonText: isPortuguese ? 'Ativar Subscrição' : 'Activate Subscription'
        }
      
      default:
        return {
          title: title || (isPortuguese ? 'Subscrição LusoTown Necessária' : 'LusoTown Subscription Required'),
          description: description || (isPortuguese 
