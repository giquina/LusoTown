...
export default function MobilePerformanceValidator({
  ...
  const shouldRender =
    enabled || showInProduction || process.env.NODE_ENV !== "production";
  ...
  useEffect(() => {
    ...
    const collectPerformanceMetrics = () => {
      ...
      if (fcpEntries.length > 0) {
        ...
        const fcp = (fcpEntry && (fcpEntry as any).startTime) as
          | number
          | undefined;
      ...
      if ("PerformanceObserver" in window) {
        ...
        new PerformanceObserver((entryList) => {
          ...
          if (!lastEntry || typeof lastEntry.startTime !== "number") return;
    ...
    const validateTouchTargets = () => {
      ...
      interactiveElements.forEach((element, index) => {
        ...
        const hasSpacing =
          parseInt(style.marginTop) >= 8 || parseInt(style.marginBottom) >= 8;
        const isAccessible =
    ...
    const validateResponsive = () => {
      ...
      const safeAreaSupport = CSS.supports(
        "padding",
  ...
  const touchTargetScore =
    totalTouchTargets > 0
      ? Math.round((validTouchTargets / totalTouchTargets) * 100)
      : 0;
          ...
          <div className="mb-4">
            ...
            {performanceMetrics.map((metric, index) => (
              ...
              >
                ...
                <span
                  className={`text-xs font-medium px-2 py-1 rounded ${getStatusColor(metric.status)}`}
                >
                  {metric.value}
                  {metric.unit}
                </span>
            ...
            <div className="mb-4">
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center p-2 rounded">
                  ...
                  <span
                    className={`text-xs font-medium px-2 py-1 rounded ${
                      portugueseTextChecks.overflowElements === 0
                        ? getStatusColor("good")
                        : getStatusColor("warning")
                    }`}
                  >
                ...
                <div className="flex justify-between items-center p-2 rounded">
                  ...
                  <span
                    className={`text-xs font-medium px-2 py-1 rounded ${
                      portugueseTextChecks.longTexts < 5
                        ? getStatusColor("good")
                        : getStatusColor("warning")
                    }`}
                  >
