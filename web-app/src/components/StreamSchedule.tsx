  ...
  const scheduledStreams: ScheduledStream[] = useMemo(() => [
    {
      ...
      title:
        language === "pt"
          ? "Masterclass de Fado com Amália Costa"
          : "Fado Masterclass with Amália Costa",
      description:
        language === "pt"
          ? "Aprenda técnicas tradicionais de fado com uma das melhores fadistas de Londres"
    ...
    },
    {
      ...
      title:
        language === "pt"
          ? "Café Comunitário - Conhece a Tua Comunidade"
          : "Community Coffee - Meet Your Community",
      description:
        language === "pt"
    ...
    },
    {
      ...
      description:
        language === "pt"
          ...
          : "Exclusive discussion with successful CEOs and entrepreneurs",
      ...
      <div className="flex items-center justify-between mb-4 sm:mb-6">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <span>
            ...
            {language === "pt" ? "streams agendados" : "scheduled streams"}
          </span>
        </div>
      </div>
        ...
        <div className="space-y-4">
          {filteredStreams.map((stream, index) => {
            ...
            const isAlmostFull =
              ...
              stream.registeredCount >= stream.viewerCapacity * 0.8;
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-3 text-xs text-gray-500 mb-3">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span>
                          {language === "pt" ? "Com" : "With"} {stream.host}
                        </span>
                      </div>
                      {stream.viewerCapacity && (
                        <div
                          className={`flex items-center gap-1 ${
                            isAlmostFull ? "text-action-600" : ""
                          }`}
                        >
                          <Users className="w-3 h-3" />
                          <span>
                            {stream.registeredCount}/{stream.viewerCapacity}
                          </span>
                          {isAlmostFull && (
                            <Star className="w-3 h-3 text-action-500" />
                          )}
                        </div>
                      )}
                    </div>
