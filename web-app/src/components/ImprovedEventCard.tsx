...
const ImprovedEventCard = ({ event }: { event: Event }) => {
          ...
          <div className="border-t border-gray-100 pt-4">
            <div className="flex gap-3">
              ...
              <a
                ...
                className="flex-1 bg-gradient-to-r from-primary-500 to-secondary-500 text-white font-semibold py-3 px-4 rounded-lg hover:from-primary-600 hover:to-secondary-600 hover:shadow-lg transition-all duration-200 text-center shadow-md"
              >
