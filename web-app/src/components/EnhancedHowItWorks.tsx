...
export default function EnhancedHowItWorks() {
  ...
  statEn: `${communityStats.members} Portuguese speakers in the United Kingdom`,
    ...
    },
    {
      ...
      statEn: `${communityStats.events} monthly events across the United Kingdom`,
      preview: {
        type: "event",
        data: {
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-br from-white via-primary-50/30 to-secondary-50/30 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-32 right-16 w-24 h-24 bg-gradient-to-br from-action-200/30 to-coral-200/20 rounded-full animate-bounce opacity-50"
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${feature.hoverGradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl`}
                ></div>

                <div className="relative z-10 flex flex-col h-full">
                  {/* Icon */}
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center mb-6 group-hover:rotate-12 group-hover:scale-110 transition-transform duration-500 shadow-lg`}
                  >
