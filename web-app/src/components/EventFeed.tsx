...
const generateEventFeedPosts = (): EventFeedPost[] => [
  {
    ...
    type: 'event_created',
    eventId: 'event-pt-1',
    eventTitle: 'Noite de Fado & Vinho Verde - Authentic Lusophone Night',
  ...
  },
  {
    ...
    type: 'event_photo',
    eventId: 'event-pt-4',
    eventTitle: 'Lusophone Language Exchange & Cocktails',
  ...
  },
  {
    ...
    type: 'event_reminder',
    eventId: 'event-pt-5',
    eventTitle: 'Festa de São João Londrina - Lusophone Mid-Summer Festival',
    eventDate: '2025-08-23',
    eventTime: '18:00',
    eventLocation: 'Lusophone Club of London, Bayswater',
  ...
  },
  {
    ...
    type: 'event_review',
    eventId: 'event-pt-6',
    eventTitle: 'Lusophone Business Networking Breakfast',
