...
export default function MatchHowItWorks() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Our intelligent algorithm connects you with Portuguese speakers based on cultural compatibility, shared traditions, and common interests.',
      descriptionPt: 'O nosso algoritmo inteligente conecta-o com falantes de português baseado em compatibilidade cultural, tradições partilhadas e interesses comuns.',
      icon: HeartIcon,
