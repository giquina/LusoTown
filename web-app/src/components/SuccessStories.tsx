...
const successStories: SuccessStory[] = [
  {
    ...
    profileImage: getImageWithFallback('carlos-silva'),
    friendImage: getImageWithFallback('ana-ferreira'),
  ...
  },
  {
    ...
    profileImage: getImageWithFallback('miguel-santos'),
    friendImage: getImageWithFallback('joana-silva'),
    friendName: 'Beatriz Rodrigues',
    story: 'From Luanda to London, carrying semba rhythms in my heart and entrepreneurial fire in my soul. Beatriz and I met at Portuguese Cultural Centre in South Lambeth, both feeling the weight of representing nossa África Portuguesa in the U.K.\'s business world. Over canja de galinha and stories of our grandmothers\' strength, we birthed "Herança & Hustle" - celebrating Angolan-Portuguese business heritage. Now 200+ CPLP entrepreneurs strong, we meet monthly at Elephant & Castle\'s Portuguese Heart restaurant, raising £2M while keeping our ancestors\' entrepreneurial spirit alive.',
  ...
  },
  {
    ...
    profileImage: getImageWithFallback('pedro-costa'),
    friendImage: getImageWithFallback('teresa-rodrigues'),
  ...
  },
  {
    ...
    profileImage: getImageWithFallback('ricardo-oliveira'),
    friendImage: getImageWithFallback('fernanda-santos'),
  ...
  },
  {
    ...
    profileImage: getImageWithFallback('antonio-pereira'),
    friendImage: getImageWithFallback('fernanda-oliveira'),
