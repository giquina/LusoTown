            ...
            <div className="grid lg:grid-cols-2 gap-8 items-start">
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      {language === "pt"
                        ? activeCase.category.pt
                        : activeCase.category.en}
                    </p>
                  </div>
                </div>
                <p className="text-white/90 leading-relaxed">
                  {language === "pt"
                    ? activeCase.scenario.pt
                    : activeCase.scenario.en}
                </p>
              </div>
              ...
              <div className="bg-white/10 rounded-xl p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold">
                      {activeCase.metrics.satisfaction}
                    </div>
                    <div className="text-sm text-white/80">
          ...
          <div className="p-8">
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {(language === "pt"
                    ? activeCase.challenges.pt
                    : activeCase.challenges.en
                  ).map((challenge, index) => (
              ...
              <div>
                <h4 className="text-xl font-bold text-neutral-900 mb-4 flex items-center">
                  ...
                  {t(
                    "framework.cases.application",
                    "7 Ps Framework Application"
                  )}
                </h4>
                <ul className="space-y-3">
                  {(language === "pt"
                    ? activeCase.framework_application.pt
                    : activeCase.framework_application.en
            ...
            <div className="mt-8 p-6 bg-secondary-50 rounded-xl">
              ...
              <p className="text-neutral-700 leading-relaxed">
                {language === "pt"
                  ? activeCase.outcome.pt
                  : activeCase.outcome.en}
              </p>
            </div>
          </div>
        </motion.div>
