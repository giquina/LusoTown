...
export default function UnifiedPremiumExperience({
      ...
      features: [
        {
          ...
          items: [
            isPortuguese
              ? "10% desconto em todos os transportes"
              : "10% discount on all transport",
      ...
      features: [
        {
          ...
          items: [
            isPortuguese
              ? "15% desconto em todos os transportes"
              : "15% discount on all transport",
            isPortuguese
            ...
            isPortuguese
              ? "Transporte privado com desconto"
              : "Discounted private transport",
          ],
        },
        {
          category: "community",
      ...
      features: [
        {
          ...
          items: [
            isPortuguese
              ? "20% desconto em todos os transportes"
              : "20% discount on all transport",
            isPortuguese
              ? "Acesso a veículos premium"
              : "Premium vehicle access",
            isPortuguese ? "Serviço de concierge" : "Concierge service",
            isPortuguese
              ? "Reservas last-minute sem taxa"
              : "Fee-free last-minute bookings",
          ],
        },
        {
          category: "community",
          items: [
            ...
            isPortuguese
              ? "Matchmaking profissional"
              : "Professional matchmaking",
            isPortuguese
              ? "Acesso a parcerias de negócios"
      ...
      features: [
        {
          ...
          items: [
            isPortuguese
              ? "25% desconto em todos os transportes"
              : "25% discount on all transport",
            isPortuguese
              ? "Transporte VIP ilimitado"
              : "Unlimited VIP transport",
            isPortuguese
              ? "Motorista pessoal dedicado"
              : "Dedicated personal driver",
            isPortuguese
              ? "Segurança pessoal incluída"
              : "Personal security included",
          ],
        },
        {
          category: "community",
          items: [
            isPortuguese
              ...
              : "VIP exclusive event access",
            isPortuguese
              ? "Introduções pessoais high-level"
              : "High-level personal introductions",
            isPortuguese
              ? "Assessoria cultural personalizada"
              : "Personalized cultural advisory",
  ...
  const selectedTierDetails = premiumTiers.find(
  ...
  const handleUpgrade = async () => {
    ...
    try {
      ...
      if (sessionId) {
        updateJourneyProgress("premium_upgrade_initiated", {
          tier: selectedTier,
          from: currentService,
        });
        onUpgradeClick?.();
  ...
  const getServiceSpecificBenefits = () => {
    switch (currentService) {
      case "transport":
        return {
          title: isPortuguese
            ? "Benefícios de Transporte Premium"
            : "Premium Transport Benefits",
          benefits: [
            {
              ...
              description: isPortuguese
                ? `${serviceDiscount}% desconto em todos os transportes`
                : `${serviceDiscount}% discount on all transport`,
            },
            {
              icon: UserGroupIcon,
              title: isPortuguese ? "Reservas de Grupo" : "Group Bookings",
              description: isPortuguese
                ? "Organize transporte com suas conexões"
                : "Organize transport with your connections",
            },
            {
              icon: ShieldCheckIcon,
              title: isPortuguese ? "Proteção Premium" : "Premium Protection",
              description: isPortuguese
                ? "Cobertura completa e suporte 24/7"
                : "Full coverage and 24/7 support",
            },
          ],
        };
      ...
      case "events":
        return {
          title: isPortuguese
            ? "Benefícios de Eventos Premium"
            : "Premium Event Benefits",
          benefits: [
            {
              icon: CalendarDaysIcon,
              title: isPortuguese ? "Acesso Prioritário" : "Priority Access",
              description: isPortuguese
                ? "Reserve os melhores eventos antes de todos"
                : "Book the best events before everyone",
            },
            {
              icon: TruckIcon,
              title: isPortuguese
                ...
                : "Transport Included",
              description: isPortuguese
                ? "Transporte premium para eventos selecionados"
                : "Premium transport to selected events",
            },
            {
              icon: UserGroupIcon,
              title: isPortuguese ? "Networking VIP" : "VIP Networking",
              description: isPortuguese
                ? "Encontros exclusivos com outros membros premium"
                : "Exclusive meetups with other premium members",
            },
          ],
        };
      ...
      case "networking":
        return {
          title: isPortuguese
            ? "Benefícios de Networking Premium"
            : "Premium Networking Benefits",
          benefits: [
            {
              icon: Users,
              title: isPortuguese ? "Matches Ilimitados" : "Unlimited Matches",
              description: isPortuguese
                ? "Conecte-se com quantos portugueses quiser"
                : "Connect with as many Portuguese speakers as you want",
            },
            {
              icon: SparklesIcon,
              title: isPortuguese ? "Eventos Exclusivos" : "Exclusive Events",
              description: isPortuguese
                ? "Networking events apenas para membros premium"
                : "Networking events only for premium members",
            },
            {
              icon: Crown,
              title: isPortuguese ? "Perfil Destacado" : "Featured Profile",
              description: isPortuguese
                ? "Sua perfil aparece primeiro nas buscas"
      ...
      default:
        return {
          title: isPortuguese
            ? "Benefícios da Plataforma Premium"
          ...
          benefits: [
            {
              ...
              title: isPortuguese
                ...
                : "Complete Experience",
              description: isPortuguese
                ? "Acesso a todos os serviços premium"
            ...
            },
            {
              ...
              description: isPortuguese
                ? "Mais benefícios adicionados mensalmente"
            ...
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-xl font-bold mb-2">
                  {isPortuguese ? "Membro Ativo" : "Active Member"} -{" "}
                  {membershipTier.charAt(0).toUpperCase() +
                    membershipTier.slice(1)}
                </h3>
                ...
                <p className="text-sm opacity-75 mt-1">
                  {isPortuguese
                    ? `Economia anual estimada: £${calculateAnnualSavings(
                        membershipBenefits.transportDiscount
                      )}`
                    : `Estimated annual savings: £${calculateAnnualSavings(
                        membershipBenefits.transportDiscount
                      )}`}
                </p>
              </div>
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <div className="text-sm text-secondary-600 mt-2">
                    {isPortuguese
                      ? `Economia anual estimada: £${calculateAnnualSavings(
                          selectedTierDetails.transportDiscount
                        )}`
                      : `Estimated annual savings: £${calculateAnnualSavings(
                          selectedTierDetails.transportDiscount
                        )}`}
                ...
                <div className="text-center">
                  ...
                  >
                    {isUpgrading ? (
                      ...
                      <>
                        {isPortuguese ? "Tornar-se Membro" : "Become Member"}{" "}
                        {selectedTierDetails.name}
