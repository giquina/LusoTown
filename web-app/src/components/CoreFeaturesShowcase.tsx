      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl sm:text-2xl lg:text-3xl text-gray-700 mb-8 font-medium max-w-5xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12 max-w-4xl mx-auto">
              <div className="flex items-center gap-4">
                ...
                <span className="text-lg font-semibold text-gray-800">{t('core_features.audience.title')}</span>
              </div>
            ...
            <div className="relative">
                  ...
                  <div className="grid lg:grid-cols-2 gap-12 items-center h-full">
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <button className="inline-flex items-center justify-center gap-3 text-lg font-semibold px-8 py-4 bg-white/80 backdrop-blur-sm text-gray-800 border-2 border-gray-200/60 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-white/90">
              ...
              <div className="flex items-center justify-between mt-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    {isAutoPlaying ? (
                      <PauseIcon className="w-5 h-5 text-gray-600 group-hover:text-gray-800" />
                    ) : (
                      <PlayIcon className="w-5 h-5 text-gray-600 group-hover:text-gray-800" />
                    )}
                  </button>
                  <button
                    onClick={() => {
                    ...
                    className="flex items-center justify-center w-12 h-12 bg-white/90 backdrop-blur-sm border border-gray-200/60 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-white group"
                  >
                    <ArrowRightIcon className="w-5 h-5 text-gray-600 group-hover:text-gray-800" />
                  </button>
                </div>
              </div>
            </div>
