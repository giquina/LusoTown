...
const mockRegionalData: Record<PortugueseCountry, LocalizedRegion> = {
  ...
  'australia': {
    ...
    culturalCenters: ['Portuguese Cultural Association Sydney', 'Portuguese Community Centre Melbourne'],
  ...
  'luxembourg': {
    ...
    dialect: 'european-portuguese',
    culturalFeatures: ['Portuguese community', 'Cultural association', 'Heritage events'],
