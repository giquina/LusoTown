        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 text-white font-semibold mb-8 border border-white/30">
              ...
              {t('components.CTA.portuguese_community_in_the_uk')}
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 max-w-4xl mx-auto mb-8 border border-white/20">
              <p className="text-2xl sm:text-3xl text-white font-bold mb-4 leading-tight">
                {t('components.CTA.connect_with_portuguese_speakers_across_the_united')}
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto mb-12">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 text-center">
                <h3 className="text-white font-bold text-xl mb-2">{t('components.CTA.uk_community_member')}</h3>
                <p className="text-white/90 text-2xl font-bold">{formatPrice(plans.community.monthly)}/month</p>
                <p className="text-white/80 text-sm mt-3 leading-relaxed">
                  {t('components.CTA.connect_with_portuguese_speakers_across_england_sc')}
                </p>
              </div>
              <div className="bg-white/15 backdrop-blur-sm rounded-2xl p-6 border border-white/30 text-center relative overflow-hidden">
                <div className="absolute -top-2 -right-2 bg-coral-500 text-white text-xs font-bold px-3 py-1 rounded-full">
                  {t('components.CTA.most_popular')}
                </div>
                <h3 className="text-white font-bold text-xl mb-2">{t('components.CTA.cultural_ambassador')}</h3>
                <p className="text-white/90 text-2xl font-bold">{formatPrice(plans.ambassador.monthly)}/month</p>
                <p className="text-white/80 text-sm mt-3 leading-relaxed">
                  {t('components.CTA.premium_access_priority_visibility_across_all_uk_p')}
                </p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="flex flex-col items-center space-y-6">
              ...
              <div className="w-full max-w-md">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <span className="text-white/80 font-medium">{t('components.CTA.or_continue_with')}</span>
                  <div className="flex-1 h-px bg-white/30"></div>
                </div>
                ...
                <p className="text-white/70 text-center mt-4 text-sm">
                  {t('components.CTA.or_continue_with_email')}
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-white font-bold text-xl mb-2">
                {t('components.CTA.23_portuguese_speakers_from_across_the_uk_joined_t')}
              </p>
              <p className="text-white/80 text-lg">
                {t('components.CTA.connect_with_your_portuguese_community_nationwide_')}
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 text-center">
              <div>
                ...
                <div className="text-white/80 text-sm">{t('components.CTA.verified_profiles')}</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white mb-2">24/7</div>
                <div className="text-white/80 text-sm">{t('components.CTA.community_support')}</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white mb-2">{t('components.CTA.30day')}</div>
                <div className="text-white/80 text-sm">{t('components.CTA.money_back_guarantee')}</div>
              </div>
            </div>
          </motion.div>
        </div>
