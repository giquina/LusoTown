...
('business_networking_portuguese', 'Portuguese Business Networking', 'business', 'Professional networking events for Portuguese entrepreneurs and professionals',
 ...
 '{"formal": {"title": "Portuguese Professional Networking Event", "message": "Connect with successful Portuguese entrepreneurs and business leaders in London.", "title_pt": "Evento de Networking Profissional Português", "message_pt": "Conecta-te com empresários e líderes empresariais portugueses de sucesso em Londres."}, "casual": {"title": "Portuguese Business Mixer 🤝", "message": "Network with your Portuguese business community over authentic conversation and opportunities.", "title_pt": "Encontro de Negócios Português 🤝", "message_pt": "Networking com a tua comunidade empresarial portuguesa com conversas autênticas e oportunidades."}, "friendly": {"title": "Growing Together - Portuguese Style! 🚀", "message": "Join fellow Portuguese professionals building successful businesses in the United Kingdom.", "title_pt": "Crescer Juntos - À Portuguesa! 🚀", "message_pt": "Junta-te a outros profissionais portugueses que constroem negócios de sucesso no Reino Unido."}}',
